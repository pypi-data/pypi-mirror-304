...
class CZConnectContext(object):
    def __init__(self, host: str, instance: str, user: str, workspace: str, schema: str, vc: str, maxRowSize: int,
                 priority: str = "", configs: dict = None):
        self.host = host
        ...
        self.schema = schema
        self.vc = vc
        self.maxRowSize = maxRowSize or 0
