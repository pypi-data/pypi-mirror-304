...
class CO2Info(Tk):
    ...
    def __init__(self, sensor='B203'):
        ...
        self.button['text'] = '{}, {}: Verbinde mit IoT...'.format(
    ...
    def _init_mqtt(self):
        ...
        try:
            ...
            messagebox.showerror(
                title='Fehler.',
                message= 'Verbindungsfehler: ' + repr(e)
            )
        else:
            self.button['text'] = '{}, {}: Warte auf Daten...'.format(
            self.timestamp_short(),
            self.sensor) 
    ...
    # Sensoren des smart.campus Projekts
    ...
    def timestamp_short(self):
        lc = localtime()
        pattern = '{:02}:{:02}'
        return(pattern.format(lc.tm_hour,
                              lc.tm_min))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config',
                        ...
                        required=False,
                        default='./.config',
                        help='Name der Config Datei. Default: ./.config')
    ...
    try:
        ...
        print(e)
        print('Nutze Default Sensorliste.')
    co2_info.mainloop()
