...
if __name__ == '__main__':
    ...
    def on_paused(breakpoint_id, *args, **kwargs):
        ...
        print(rt)
        breakpoint_id_list.append(breakpoint_id)
        kwargs_list.append(kwargs)
    ...
    while not breakpoint_id_list:
        page.wait(1)

    x = page.debug.remove_breakpoint(breakpoint_id_list[-1])
    print()
