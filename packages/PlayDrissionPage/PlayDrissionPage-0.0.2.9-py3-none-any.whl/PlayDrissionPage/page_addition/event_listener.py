...
class DebugEventListener(BaseEventListener):
    ...
    def set_breakpoint_by_url(self, line_number,
        ...
        set_break_info = self.page.run_cdp(
            "Debugger.setBreakpointByUrl",
            **set_breakpoint_rq)
        breakpoint_id = set_break_info['breakpointId']
        ...
        set_break_info['set_breakpoint_rq'] = set_breakpoint_rq
        self._debug_patterns_dict[breakpoint_id] = set_break_info
    ...
    def _debug_event_fun(self, **kwargs):
        ...
        for breakpoint_id, func in self._debug_fun_dict.items():
            if breakpoint_id in breakpoint_id_list:
                func(breakpoint_id, **kwargs)
