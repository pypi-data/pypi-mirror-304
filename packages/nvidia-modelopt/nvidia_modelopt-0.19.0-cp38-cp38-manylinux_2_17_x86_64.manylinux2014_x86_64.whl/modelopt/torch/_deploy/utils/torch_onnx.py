...
def get_onnx_bytes_and_metadata(
    ...
    onnx_graph = onnx.load(onnx_save_path, load_external_data=False)
    ...
    if check_model_uses_external_data(onnx_opt_graph):
        tensors_paths = _get_onnx_external_data_tensors(onnx_opt_graph)
        onnx.save_model(
            onnx_opt_graph,
            onnx_save_path,
