...
from modelopt.onnx.quantization.graph_utils import expand_node_names_from_patterns
    ...
    **kwargs: Any,
    ...
    for act, wa_pack_idx_list in tqdm(
        ...
        for alpha in alpha_values:
            loss = 0.0
            # awq_scale = get_scale(x_m, w_m, alpha, False)  # TODO: look up the purpose of last arg
...
def quantize(
    ...
    calibration_eps: List[str] = ["cuda:0", "cpu"],
