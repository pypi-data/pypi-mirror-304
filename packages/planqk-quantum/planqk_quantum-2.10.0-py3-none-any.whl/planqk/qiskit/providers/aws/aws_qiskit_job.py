...
class PlanqkAwsQiskitJob(PlanqkQiskitJob):
    ...
    def _create_experiment_result(self, provider_result: dict) -> ExperimentResult:
        ...
        Adapted from AWS Braket SDK.

        Original source: https://github.com/qiskit-community/qiskit-braket-provider/blob/main/qiskit_braket_provider/providers/braket_quantum_task.py
        """
