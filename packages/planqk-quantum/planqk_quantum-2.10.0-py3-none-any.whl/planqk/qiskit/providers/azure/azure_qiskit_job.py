...
class PlanqkAzureQiskitJob(PlanqkQiskitJob):
    ...
    def _create_experiment_result(self, provider_result: dict) -> ExperimentResult:
        ...
        Adapted from Azure Quantum Qiskit SDK.

        Original source: https://github.com/microsoft/azure-quantum-python/blob/main/azure-quantum/azure/quantum/qiskit/job.py
        """
