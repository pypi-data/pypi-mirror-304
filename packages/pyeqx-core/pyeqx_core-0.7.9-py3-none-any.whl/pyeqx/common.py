...
class FunctionExecuteResultBase(Generic[TResultData]):
    def __init__(self, data: TResultData = None, is_success: bool = False, error: Exception = None):
...
class FunctionExecuteResult(FunctionExecuteResultBase[TResultData]):
    def __init__(self, data: TResultData | None = None, error: Optional[Exception] = None):
        if error is None:
