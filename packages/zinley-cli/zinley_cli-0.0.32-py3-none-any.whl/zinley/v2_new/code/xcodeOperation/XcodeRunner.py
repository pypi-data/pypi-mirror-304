...
class XcodeRunner:
    def __init__(self, role, directory_path, api_key, endpoint, deployment_id, max_tokens):
        ...
        self.self_healing = SelfHealingAgent(role, directory_path, api_key, endpoint, deployment_id, max_tokens)
        self.bugExplainer = BugExplainer(role, directory_path, api_key, endpoint, deployment_id, max_tokens)
        self.xcode_operations = XcodeProjectManager(directory_path)
...
# Usage
async def main():
    project_path = "/Users/hoangnm/Documents/workspace/projects/zinley/fsd_v2_universal/v2/projects"
