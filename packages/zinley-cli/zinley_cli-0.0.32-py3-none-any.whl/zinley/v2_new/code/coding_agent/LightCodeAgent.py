...
class LightCodeAgent:
    ...
    def initial_setup(self):
        ...
        """
        prompt = (
            f"You are a senior {self.role} and coder agent.\n"
            "\n"
            "# Exclusions\n"
    ...
    async def get_working(self, session, file, prompt):
        """
        ...
        if file_content:
            ...
            user_prompt = (
                ...
                f"Now work on this file: {file_content}\n"
            )
    ...
    async def get_workings(self, files):
        """
        ...
        async with aiohttp.ClientSession() as session:
            for item in files:
                ...
                code = await self.get_working(session, file_path, prompt)
                if code:
