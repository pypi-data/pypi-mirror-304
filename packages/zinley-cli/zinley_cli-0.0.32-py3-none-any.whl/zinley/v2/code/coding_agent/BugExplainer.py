...
class BugExplainer:
    ...
    def initial_setup(self, role):
        ...
        prompt = (
            ...
            "(2) file_name must include only single file name that need to be work on without any path. \n"
            "(3) list_related_file_name must have list only all the possible files name that may cause damage to this working file, otherwise just return empty. \n"
            "(4) is_new is for if this file need to be newly created. Sometime file is missing or maybe deleted accidentally, try to restore file as best as possible with provided context, and mark is_new is True, otherwise is_new must be False. \n"
            "(5) new_file_location is for the location of file if this file need to be newly created. Describe any relative path and folder where the new file will be created if needed. \n"
