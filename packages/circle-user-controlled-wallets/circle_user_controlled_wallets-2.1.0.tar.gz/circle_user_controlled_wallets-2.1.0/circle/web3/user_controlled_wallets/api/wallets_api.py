...
class WalletsApi(object):
    ...
    @auto_fill
    @validate_arguments
    def get_wallet(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier (UUID v4) of the resource.")], x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], **kwargs) -> WalletResponse:  # noqa: E501
    ...
    @auto_fill
    @validate_arguments
    def get_wallet_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier (UUID v4) of the resource.")], x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a wallet  # noqa: E501
    ...
    @auto_fill
    @validate_arguments
    def update_wallet_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier (UUID v4) of the resource.")], x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], update_wallet_request : Annotated[UpdateWalletRequest, Field(..., description="Schema for the request payload to update an existing wallet.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update a wallet  # noqa: E501
