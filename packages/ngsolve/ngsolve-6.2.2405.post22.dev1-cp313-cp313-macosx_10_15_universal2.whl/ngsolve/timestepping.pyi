...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_args', 'dt', 'gfu_old', 'c', 'time', '_lin_solver_cls', 'bfmstar')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_args', 'dt', 'gfv_old', 'gfu_old', 'time', 'bfmstar', 'c', '_lin_solver_cls', 'gfa_old')
