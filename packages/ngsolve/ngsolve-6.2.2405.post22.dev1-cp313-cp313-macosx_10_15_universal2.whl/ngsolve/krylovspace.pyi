...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('ress', 'plt', 'printrates', '_final_residual', 'fig', 'clear_output', 'sol', 'ax', 'residuals', 'display', 'its', 'pre', 'mat', 'atol', 'callback', 'iterations', 'callback_sol', 'maxiter', 'tol', 'plotrates')
