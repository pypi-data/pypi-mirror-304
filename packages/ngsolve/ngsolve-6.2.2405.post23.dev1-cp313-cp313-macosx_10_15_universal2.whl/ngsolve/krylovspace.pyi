...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('clear_output', 'tol', 'ax', 'iterations', 'residuals', '_final_residual', 'maxiter', 'callback_sol', 'sol', 'plt', 'callback', 'printrates', 'its', 'plotrates', 'display', 'fig', 'atol', 'ress', 'pre', 'mat')
