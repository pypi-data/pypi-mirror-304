...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('gfu_old', 'time', 'c', 'dt', 'bfmstar', '_lin_solver_args', '_lin_solver_cls')
...
class ImplicitEuler:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('gfu_old', 'time', 'c', 'bfmstar', 'dt', '_lin_solver_args', '_lin_solver_cls')
    def Integrate(self, u_start: ngsolve.comp.GridFunction, end_time: float, start_time: typing.Optional[float] = None, newton_args: typing.Optional[dict] = None, callback: typing.Optional[typing.Callable] = None):
        ...
    def Step(self, u: ngsolve.comp.GridFunction, dt: typing.Optional[float] = None, newton_args: typing.Optional[dict] = None):
        ...
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('gfu_old', 'time', 'c', 'dt', 'bfmstar', 'gfa_old', 'gfv_old', '_lin_solver_args', '_lin_solver_cls')
