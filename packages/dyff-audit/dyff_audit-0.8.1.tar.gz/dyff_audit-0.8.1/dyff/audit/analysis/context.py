...
class _Scores(DyffSchemaBaseModel):
    ...
    def Score(
        ...
        *,
        ...
        if output:
            ...
            try:
                scores_data: _Scores = _Scores.parse_file(meta_dir / "scores.json")
        ...
        if display:
            kwargs = dict(quantity=quantity, text=text)
