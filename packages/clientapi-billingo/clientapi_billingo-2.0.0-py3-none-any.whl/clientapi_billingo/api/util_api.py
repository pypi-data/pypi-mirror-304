...
class UtilApi:
    ...
    def check_tax_number(
        self,
        tax_number: Annotated[str, Field(strict=True)],
        ...
        _param = self._check_tax_number_serialize(
    ...
    @validate_call
    def check_tax_number_with_http_info(
        self,
        tax_number: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def check_tax_number_without_preload_content(
        self,
        tax_number: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _check_tax_number_serialize(
        self,
        tax_number,
        _request_auth,
        _content_type,
        ...
        if tax_number is not None:
            _path_params['tax_number'] = tax_number
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/utils/check-tax-number/{tax_number}',
