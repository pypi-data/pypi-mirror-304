...
class ResBlock(nn.Module):
    def __init__(self, channel_list, H, W):
        ...
        # 增加通道数
        self.channel_list = [max(ch, 96) for ch in channel_list]  # 例如，提高到128
...
class Neural_receiver(nn.Module):
    def __init__(self, subcarriers, timesymbols, streams, num_bits_per_symbol, num_blocks=28, channel_list=[96, 96, 96]):  # 增加残差块的数量和通道数
