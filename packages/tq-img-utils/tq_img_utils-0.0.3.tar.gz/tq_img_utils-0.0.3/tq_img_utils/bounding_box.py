...
class BoundingBox:
    ...
    def __init__(self, x: int, y: int, width: int, height: int, constraint: Tuple[int, int] = None):
        ...
        :raises ValueError: if the area of the bounding box must be positive.
        """
        if x >= (x + width) or y >= (y + height):
            raise ValueError("The area of the bounding must be positive.")
        self.x = x
        self.y = y
        self.width = width
        self.height = height
    ...
    @staticmethod
    def get_from_min_max_format(region: Tuple[int, int, int, int], constraint: Tuple[int, int] = None) -> 'BoundingBox':
        """
        ...
        return BoundingBox(x_min, y_min, x_max - x_min, y_max - y_min, constraint)

    @staticmethod
    def get_from_two_points_format(region: Tuple[int, int, int, int],
                                   constraint: Tuple[int, int] = None) -> 'BoundingBox':
        """
        ...
        return BoundingBox.get_from_min_max_format((x_min, x_max, y_min, y_max), constraint)
