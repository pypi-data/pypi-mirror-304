...
class LakeHouseLogger:
    ...
    def print_schema(self):
        return self.__create_data_frame({}).printSchema()

    def __create_data_frame(self, parameters) -> DataFrame:
        return self.spark.createDataFrame([parameters], self.logger_struct_data)
    ...
    def __log_to_lakehouse__(self, level: str, status: str, message: str, parent_notebook_run_uuid: str | None):
        ...
        df_logging_row = self.__create_data_frame(parameters) 
