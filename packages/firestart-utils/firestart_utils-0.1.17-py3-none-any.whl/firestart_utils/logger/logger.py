...
class LakeHouseLogger:
    ...
    def __init__(self, environment: str, location: str, spark_structure):
        self.environment = environment
        self.location = location
        self.logger_constructor = spark_structure
    ...
    def __log_to_lakehouse__(self, level: str, status: str, message: str, parent_notebook_run_uuid: str | None):
        ...
        df_logging_row = spark.createDataFrame([parameters], self.logger_constructor)
