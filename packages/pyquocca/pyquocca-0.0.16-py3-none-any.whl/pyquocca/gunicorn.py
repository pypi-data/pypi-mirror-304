...
reload_extra_files = ["./templates", "./src", "./app"]
if reload and os.getenv("PYQUOCCA_RELOAD_EXTRA_FILES", "") != "":
    files = os.getenv("PYQUOCCA_RELOAD_EXTRA_FILES", "").split(",")
    reload_extra_files.extend(files)
