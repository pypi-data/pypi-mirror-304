...
class InputMediaPhoto:
    def __init__(self, media: str, caption: str = None):
        '''
        Создает объект InputMediaPhoto для отправки фотографии через Telegram Bot API

        :param media: Файл для отправки (может быть ID файла или URL)
        :param caption: Подпись к фотографии (опционально)
        '''
        self.type = 'photo'
        self.media = media
    ...
    def to_dict(self) -> dict:
        '''
        Создает объект InputMediaPhoto из словаря, предоставленного Telegram API
        '''
...
class InputMediaAnimation:
    def __init__(self, media: str, caption: str = None, duration: int = None, 
        ...
        :param media: Файл для отправки (ID файла или URL)
        :param caption: Подпись к анимации (опционально)
        :param duration: Длительность анимации в секундах (опционально)
        :param width: Ширина анимации (опционально)
        :param height: Высота анимации (опционально)
        '''
        self.type = 'animation'
        self.media = media
        self.caption = caption
    ...
    def to_dict(self) -> dict:
        '''
        Создает объект InputMediaAnimation из словаря, предоставленного Telegram API
        '''
...
class InputMediaVideo:
    def __init__(self, media: str, caption: str = None, duration: int = None, 
                 width: int = None, height: int = None, supports_streaming: bool = False):
        '''
        Создает объект InputMediaVideo для отправки видео через Telegram Bot API

        :param media: Файл для отправки (ID файла или URL)
        :param caption: Подпись к видео (опционально)
        :param duration: Длительность видео в секундах (опционально)
        :param width: Ширина видео (опционально)
        :param height: Высота видео (опционально)
        :param supports_streaming: Поддержка стриминга видео (опционально, по умолчанию False)
        '''
        self.type = 'video'
        self.media = media
        self.caption = caption
    ...
    def to_dict(self) -> dict:
        '''
        Создает объект InputMediaVideo из словаря, предоставленного Telegram API
        '''
        payload = {'type': self.type, 'media': self.media}
        if self.caption:
            payload['caption'] = self.caption
...
class Bot:
    ...
    def forward_message(self, chat_id: Union[int, str], from_chat_id: Union[int, str], message_id: int, disable_notification: bool = None) -> Optional['Message']:
    ...
    def forward_messages(self, chat_id: Union[int, str], from_chat_id: Union[int, str], message_ids: Union[int, list], disable_notification: bool = None) -> Optional['Message']:
    ...
    def copy_message(self, chat_id: Union[int, str], from_chat_id: Union[int, str], message_id: int, caption: str = None, disable_notification: bool = None, mode: str = "Markdown", reply_markup: dict = None) -> Optional['Message']:
        '''Копирует сообщение'''
        method = 'copyMessage'
        if not chat_id:
            raise ValueError("chat_id не должен быть None")
    ...
    def copy_messages(self, chat_id: Union[int, str], from_chat_id: Union[int, str], message_ids: Union[int, list], disable_notification: bool = None) -> Optional['Message']:
    ...
    def delete_message(self, chat_id: Union[int, str], message_id: int) -> Optional['Message']:
        '''Удаляет сообщение'''
    ...
    def delete_messages(self, chat_id: Union[int, str], message_ids: Union[int, list]) -> Optional['Message']:
...
#Редакт чего-то
    ...
    def edit_message_media(self, chat_id: Union[int, str], message_id: int, media: Union[str, bytes, InputMediaPhoto, InputMediaAnimation, InputMediaVideo], inline_message_id: str = None, reply_markup: dict = None) -> bool:
        ...
        if isinstance(media, InputMediaPhoto):
            ...
            raise ValueError('media должно быть экземпляром str, InputMediaPhoto, InputMediaAnimation или InputMediaVideo')
