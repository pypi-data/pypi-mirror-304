...
class TonicTextualParse:
    ...
    def create_s3_pipeline(self, pipeline_name: str, credentials: Optional[PipelineAwsCredential] = None, aws_credentials_source: Optional[str]='user_provided', synthesize_files: Optional[bool] = False) -> Pipeline:
    ...
    def create_azure_pipeline(self, pipeline_name: str, credentials: PipelineAzureCredential, synthesize_files: Optional[bool] = False) -> Pipeline:
    ...
    def create_local_pipeline(self, pipeline_name: str, synthesize_files: Optional[bool] = False) -> Pipeline:
