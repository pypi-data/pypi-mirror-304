...
class OpenTelemetryConfigurator:
    ...
    def __init__(
        self, host_name, endpoint, service_name, service_version, deployment_environment
    ):
        """
        ...
        :param host_name: 主机名，用于标识运行服务的服务器或容器。
        :param endpoint: OpenTelemetry数据导出器的端点URL。
        """
        self.service_name = "XMZAPI"
        self.service_version = "1.0.0"
        self.deployment_environment = "prod"
        self.host_name = host_name
        self.endpoint = "http://tracing-analysis-dc-sh.aliyuncs.com/adapt_i8ucd7m6kr@c81a1d4e5cb019a_i8ucd7m6kr@53df7ad2afe8301/api/otlp/traces"
