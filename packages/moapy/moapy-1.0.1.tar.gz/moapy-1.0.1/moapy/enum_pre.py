...
def get_section_names_from_api(codes, types):
    # https://moa.rpm.kr-st-midasit.com/backend/function-executor/python-execute/
    api_url = f"https://moa.rpm.kr-st-midasit.com/backend/wgsd/dbase/sections/codes/{codes}/types/{types}/names"
