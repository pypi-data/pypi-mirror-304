...
def report_ec4_composited_beam(steel: SteelMember_EC, shearconn: ShearConnector_EC, slab: SlabSection, leng: GirderLength, load: UnitLoads) -> ResultBytes:
    dll = load_dll()
...
def calc_ec4_composited_beam(steel: SteelMember_EC, shearconn: ShearConnector_EC, slab: SlabSection, leng: GirderLength, load: UnitLoads) -> dict:
    dll = load_dll()
...
if __name__ == "__main__":
    res = report_ec4_composited_beam(SteelMember_EC(), ShearConnector_EC(), SlabSection(), GirderLength(), UnitLoads())
