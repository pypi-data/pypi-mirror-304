...
class ApiTrail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["groundSpeed", "heading", "altitude", "verticalRate", "latitude", "longitude", "squawkCode", "source", "timestamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiTrail from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiTrail from a dict"""
        if obj is None:
            return None
