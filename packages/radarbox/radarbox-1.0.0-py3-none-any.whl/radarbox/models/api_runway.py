...
class ApiRunway(BaseModel):
    ...
    ils_course: Optional[StrictStr] = Field(default=None, alias="ilsCourse")
    __properties: ClassVar[List[str]] = ["name", "course", "length", "elevation", "coordinates", "ilsCourse"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiRunway from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiRunway from a dict"""
        if obj is None:
            return None
