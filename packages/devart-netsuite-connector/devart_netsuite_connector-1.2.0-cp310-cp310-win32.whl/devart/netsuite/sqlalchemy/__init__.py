...
registry.register('devart.netsuite', 'devart.netsuite.sqlalchemy', 'DevartNetSuiteDialect')

class DevartNetSuiteDialect(SQLiteDialect):
    driver = "devart"
    name = "netsuite"
    ...
    def import_dbapi(cls):
        ...
        netsuite_package = devart.netsuite
        setattr(netsuite_package, "sqlite_version_info", (3, 39, 2))
        return netsuite_package
