...
def get_version(dist: str = "mkdocstrings-csharp") -> str:
...
def get_debug_info() -> Environment:
    ...
    packages = ["mkdocstrings-csharp"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("MKDOCSTRINGS_CSHARP")]]
    return Environment(
