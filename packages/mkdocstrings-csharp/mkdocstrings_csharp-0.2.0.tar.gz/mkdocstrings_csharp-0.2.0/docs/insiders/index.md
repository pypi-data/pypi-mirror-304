...
*mkdocstrings-csharp* follows the **sponsorware** release strategy, which means
...
*mkdocstrings-csharp Insiders* is a private fork of *mkdocstrings-csharp*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *mkdocstrings-csharp*.
...
*mkdocstrings-csharp* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *mkdocstrings-csharp*,
...
<small>
  ...
  your profile and avatar to show your support for *mkdocstrings-csharp*.
...
to use *mkdocstrings-csharp* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *mkdocstrings-csharp*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *mkdocstrings-csharp
Insiders* precisely under the same terms as *mkdocstrings-csharp*, which are given
