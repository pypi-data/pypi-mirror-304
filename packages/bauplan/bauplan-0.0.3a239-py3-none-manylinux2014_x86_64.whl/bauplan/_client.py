...
from .schema import APIResponse, Branch, Namespace, Ref, Table, TableMetadata
    ...
    **Handling Exceptions**
    ...
    def query_to_parquet_file(
        ...
        **kwargs: Any,
        ...
        :param filename: The name or path of the file parquet to write the results to.
        :param query: The Bauplan query to execute.
        :param ref: The ref or branch name to read data from.
        :param max_rows: The maximum number of rows to return; default: ``None`` (no limit).
        :param cache: Whether to enable or disable caching for the query.
    ...
    def query_to_csv_file(
        ...
        **kwargs: Any,
        ...
        :param filename: The name or path of the file csv to write the results to.
        :param query: The Bauplan query to execute.
        :param ref: The ref or branch name to read data from.
        :param max_rows: The maximum number of rows to return; default: ``None`` (no limit).
        :param cache: Whether to enable or disable caching for the query.
    ...
    def query_to_json_file(
        ...
        :param filename: The name or path of the file json to write the results to.
        :param query: The Bauplan query to execute.
    ...
    def create_table(
        ...
        # The namespace has not been resolved by the commander, let's resolve it here
        if len(table_create_plan.ctx.table_name.split('.')) == 1:
            return Table(
                name=f'{table_create_plan.ctx.namespace}.{table_create_plan.ctx.table_name}',
            )
    ...
    def create_namespace(
        ...
        :param into_branch: The name of the branch to create the namespace on.

        :return: The created namespace.
        """
        namespace_name = _get_namespace_name('namespace', namespace)
        branch_name = _get_branch_name('into_branch', into_branch)
    ...
    def delete_namespace(
        ...
        """
        namespace_name = _get_namespace_name('namespace', namespace)
        branch_name = _get_branch_name('form_branch', form_branch)
    ...
    def get_table(
        ...
        :param branch: The branch to get the table from.
        ...
        branch_name = _get_branch_name('branch', branch)
        table_name = _get_table_name('table', table)
        path = _get_quoted_url('v0', 'refs', branch_name, 'tables', table_name)
        params = {'raw': 1 if include_raw else 0}
        out: APIResponse = self._make_catalog_api_call('get', path, params=params)

        metadata = TableMetadata.model_validate(out.data)
        return Table(name=table_name, kind='TABLE', metadata=metadata)
    ...
    def table_exists(
        ...
        """
        try:
            self.get_table(table=table, branch=branch)
            return True
        except exceptions.ResourceNotFoundError:
            return False
