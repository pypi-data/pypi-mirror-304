...
class PatchCodeParameters(Assist.BaseJavaClass):
    ...
    def getExtraBarcodeText(self) -> str:
        """!
            ...
            """
        return str(self.getJavaClass().getExtraBarcodeText())
...
class CodabarParameters(Assist.BaseJavaClass):
    ...
    def getCodabarStartSymbol(self) -> int:
        """!
            Start symbol (character) of Codabar symbology.
            Default value: CodabarSymbol.A
            """
        return int(self.getJavaClass().getCodabarStartSymbol())

    def setCodabarStartSymbol(self, value: int) -> None:
        """!
            Start symbol (character) of Codabar symbology.
            Default value: CodabarSymbol.A
            """
    ...
    def getCodabarStopSymbol(self) -> int:
        """!
            Stop symbol (character) of Codabar symbology.
            Default value: CodabarSymbol.A
            """
        return int(self.getJavaClass().getCodabarStopSymbol())

    def setCodabarStopSymbol(self, value: int) -> None:
        """!
            Stop symbol (character) of Codabar symbology.
            Default value: CodabarSymbol.A
            """
