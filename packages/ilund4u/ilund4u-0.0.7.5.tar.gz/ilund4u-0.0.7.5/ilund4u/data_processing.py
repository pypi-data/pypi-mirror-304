        ...
        for island in self.islands:
            ...
            for db_name in db_names:
                ...
                for r_type in r_types:
                    self.island_annotation[f"{db_name}_{r_type}"] = \
                        self.island_annotation[f"{db_name}_{r_type}"].astype(object)
        ...
        try:
            ...
            for h_com, hotspot_ids in self.hotspots.communities.items():
                ...
                for hotspot in hotspots:
                    ...
                    db_stat = hotspot.calculate_database_hits_stats(self.proteomes, self.prms)
                    for r_type in r_types:
                        hotspot_com_groups[r_type].update(hotspot_groups[r_type])
                    for db_name in self.prms.args["database_names"]:
                        for r_type in r_types:
