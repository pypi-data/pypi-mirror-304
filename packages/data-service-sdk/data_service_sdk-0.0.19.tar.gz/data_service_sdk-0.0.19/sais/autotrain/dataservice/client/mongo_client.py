...
def query_nwp_mongo_biz(src: str, start_time: str, ndays: int, hours: int, coords: list[Coordinate], vars: list[str], workers: int):
    ...
    print(f'start_time: {start_time}, real_start_time: {real_start_time}')
    period_interval = 24
    period = ndays
    start_hour = calculate_hours_between(real_start_time, start_time)
    end_hour = start_hour + hours
    forecast_interval = 1
    print(f'start_time: {start_time}, real_start_time: {real_start_time}, start_hour: {start_hour}, end_hour: {end_hour},'
          f' forecast_interval: {forecast_interval}, vars: {vars}, period_interval: {period_interval},'
          f'period: {period}, workers: {workers}')
