class DeviceFailureRecord:
    def __init__(self, dfem_code, display_name, dfem_bjlx, dfem_sxmsbh, description, dfem_bjs, dfem_bjdj, dfem_zt, dfem_gjz, dfem_zzbjsj, dfem_zxbjsj, device_code, fm_code, fm_name):
    ...
    def __repr__(self):
        return (f"DeviceFailureRecord(dfem_code={self.dfem_code}, "
                ...
                f"fm_code={self.fm_code}, "
                f"fm_name={self.fm_name})")
