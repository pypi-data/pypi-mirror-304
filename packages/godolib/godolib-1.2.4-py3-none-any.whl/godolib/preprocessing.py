...
class VolatilityCalculator (BaseEstimator, TransformerMixin):
    def __init__ (self, window=20, method='standard', min_periods=1, fit_mode='all_positive', transform_mode='returns', exception=True, returns_period=1, stationarity_threshold=0.05):
        """
