...
def plot_embeddings_with_search(
    ...
    Args:
        ...
        model (SentenceTransformer): A SentenceTransformer model used to generate the embedding vector for the search query.
    ...
    with time_block(block_name="Cleaning and Getting Embeddings."):
        ...
        search_embedding = model.encode(sentences=clean_search).tolist()
