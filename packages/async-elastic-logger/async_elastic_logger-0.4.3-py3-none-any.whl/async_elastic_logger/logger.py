...
class ElasticsearchHandler(logging.Handler):
    ...
    def emit(self, record):
        # Retrieve extra attributes passed to the logger (e.g., context, body)
        ...
        log_entry = {
            ...
            'context': context,  # Add context to the log entry
            'body': body          # Add body to the log entry
        }
...
class AsyncLogger:
    ...
    async def log(self, level: int, msg: Any, context: Optional[Dict[str, Any]] = None, body: Optional[Any] = None) -> None:
        extra = {'context': context, 'body': body}  # Pass context and body through the `extra` parameter
