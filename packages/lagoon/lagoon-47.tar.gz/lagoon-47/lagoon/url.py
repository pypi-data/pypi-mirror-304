...
class URL:
    ...
    def call(self, args, kwargs):
        ...
        with urlopen(Request(urlunsplit([self.url.scheme, self.url.netloc, _joinpath(self.url.path, args, '/'), '&'.join(query), self.url.fragment]), method = kwargs.get('method'))) as f:
            return xform(f.read())
