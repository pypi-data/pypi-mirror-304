...
from ethrpc_keys.utils.address import (
    public_key_bytes_to_address,
)
from ethrpc_keys.utils.numeric import (
    int_to_byte,
)
from ethrpc_keys.utils.padding import (
    pad32,
)
...
if TYPE_CHECKING:
    from ethrpc_keys.backends.base import BaseECCBackend  # noqa: F401
...
class LazyBackend:
    def __init__(self,
        ...
        from ethrpc_keys.backends.base import (  # noqa: F811
            BaseECCBackend,
        )
        ...
        if backend is None:
            ...
            raise ValueError(
                ...
                "subclass of `ethrpc_keys.backends.BaseECCBackend` or a string of "
    ...
    def get_backend(cls, *args: Any, **kwargs: Any) -> 'BaseECCBackend':
        from ethrpc_keys.backends import get_backend
