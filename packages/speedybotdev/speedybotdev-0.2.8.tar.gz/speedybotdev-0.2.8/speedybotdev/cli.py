...
def main():
    ...
    reset_parser = subparsers.add_parser('reset', help='Reset devices associated with the token')
    reset_parser.add_argument('--token', required=True, help='API token for resetting devices')
