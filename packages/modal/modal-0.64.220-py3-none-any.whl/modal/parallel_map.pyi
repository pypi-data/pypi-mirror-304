...
def _map_sync(
    self, *inputs: typing.Iterable[typing.Any], kwargs={}, order_outputs: bool = True, return_exceptions: bool = False
) -> modal._utils.async_utils.AsyncOrSyncIterable: ...
def _map_async(
    self, *inputs, kwargs={}, order_outputs: bool = True, return_exceptions: bool = False
