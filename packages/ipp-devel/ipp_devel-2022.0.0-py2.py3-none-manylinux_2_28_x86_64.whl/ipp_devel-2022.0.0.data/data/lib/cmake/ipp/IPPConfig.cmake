...
function (add_components list_of_components tl_path tl_suffix ipp_libraries_variable)
    if (WIN32)
        ...
        if (APPLE)
            ...
            # Shared library suffix (`.<major_version>` is added on Linux because PIP packages don't support symbolic links)
            set(_ipp_shared_library_suffix "${tl_suffix}.so.${IPP_VERSION_MAJOR}")
        endif ()
