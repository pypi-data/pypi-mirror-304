...
class ContextQASignature(dspy.Signature):
    ...
    __doc__ =open(path.abspath(path.join(path.dirname(__file__), "..", "prompts","contract_review.txt"))).read()
...
class ExtractLegalClauseSignature(dspy.Signature):
    ...
    __doc__ =open(path.abspath(path.join(path.dirname(__file__), "..", "prompts","extract_legal_clause.txt"))).read()
...
class ReviewLegalClauseSignature(dspy.Signature):
    ...
    __doc__ =open(path.abspath(path.join(path.dirname(__file__), "..", "prompts","review_legal_clause.txt"))).read()
