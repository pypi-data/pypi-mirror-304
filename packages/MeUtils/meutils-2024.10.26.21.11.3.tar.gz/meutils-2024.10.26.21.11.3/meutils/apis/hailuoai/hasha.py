...
# 原始URL字符串
original_url = "/v1/api/files/policy_callback?device_platform=web&app_id=3001&version_code=22201&uuid=6bb61318-195c-4987-af91-c5d4740450cd&device_id=306156985518694526&os_name=Windows&browser_name=chrome&device_memory=8&cpu_core_num=20&browser_language=zh-CN&browser_platform=Win32&screen_width=2560&screen_height=1440&unix=1729861725000"
original_url = original_url.replace("/", "%2F")
payload = json.dumps({}, ensure_ascii=False)
# 使用quote函数进行编码
encoded_url = quote(original_url)

# print(encoded_url)
# yy_info = "{}_{}{}ooui".format(original_url, payload, get_js_sha("1729861725000"))
# print(yy_info)
# get_js_sha(yy_info)
