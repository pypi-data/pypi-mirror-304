...
def copy_volume_file_v2(source: VolumePathRef, dest: VolumePathRef):
    ...
    if t2t == (constant.VOLUME_TYPE_LOCAL, constant.VOLUME_TYPE_SV):
        return _copy_volume_file_local_to_remote(
            source_path=source.local_path,
            dest_volume_id=dest.sv_id,
            dest_path=dest.sv_path,
        )
    elif t2t == (constant.VOLUME_TYPE_SV, constant.VOLUME_TYPE_LOCAL):
        return _copy_volume_file_remote_to_local(
            source_volume_id=source.sv_id,
            source_path=source.sv_path,
            dest_path=dest.local_path,
        )
    elif t2t == (constant.VOLUME_TYPE_SV, constant.VOLUME_TYPE_SV):
        return _copy_volume_file_remote_to_remote(
            source_volume_id=source.sv_id,
            source_path=source.sv_path,
            dest_volume_id=dest.sv_id,
    ...
    elif t2t == (constant.VOLUME_TYPE_VOLUME, constant.VOLUME_TYPE_LOCAL):
        _volume_v2_download(
