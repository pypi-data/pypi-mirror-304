...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2255, _2258
...
class MASTAGUI(_0.APIBase):
    ...
    @property
    def active_design(self: "Self") -> "_2255.Design":
    ...
    @enforce_parameter_types
    def active_design(self: "Self", value: "_2255.Design") -> None:
    ...
    @property
    def open_designs(self: "Self") -> "List[_2255.Design]":
    ...
    @property
    def selected_design_entity(self: "Self") -> "_2258.DesignEntity":
    ...
    @enforce_parameter_types
    def selected_design_entity(self: "Self", value: "_2258.DesignEntity") -> None:
    ...
    @enforce_parameter_types
    def open_design_in_new_tab(self: "Self", design: "_2255.Design") -> None:
        """Method does not return.
