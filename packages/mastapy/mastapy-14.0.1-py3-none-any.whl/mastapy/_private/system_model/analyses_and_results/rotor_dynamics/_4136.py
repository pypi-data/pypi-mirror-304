...
from mastapy._private.system_model.analyses_and_results.rotor_dynamics import _4134
...
class _Cast_ShaftModalComplexShape:
    ...
    @property
    def shaft_complex_shape(self: "CastSelf") -> "_4134.ShaftComplexShape":
        return self.__parent__._cast(_4134.ShaftComplexShape)

    @property
    def shaft_modal_complex_shape_at_speeds(
        self: "CastSelf",
    ) -> "_4137.ShaftModalComplexShapeAtSpeeds":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4137,
        )

        return self.__parent__._cast(_4137.ShaftModalComplexShapeAtSpeeds)

    @property
    def shaft_modal_complex_shape_at_stiffness(
        self: "CastSelf",
    ) -> "_4138.ShaftModalComplexShapeAtStiffness":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4138,
        )

        return self.__parent__._cast(_4138.ShaftModalComplexShapeAtStiffness)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftModalComplexShape(_4134.ShaftComplexShape[_1738.Number, _1738.Number]):
    """ShaftModalComplexShape
