...
class _Cast_RigidlyConnectedComponentGroupSystemDeflection:
    ...
    def design_entity_group_analysis(
        self: "CastSelf",
    ) -> "_2739.DesignEntityGroupAnalysis":
        return self.__parent__._cast(_2739.DesignEntityGroupAnalysis)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RigidlyConnectedComponentGroupSystemDeflection(_2739.DesignEntityGroupAnalysis):
    """RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def components(self: "Self") -> "List[_2802.ComponentSystemDeflection]":
