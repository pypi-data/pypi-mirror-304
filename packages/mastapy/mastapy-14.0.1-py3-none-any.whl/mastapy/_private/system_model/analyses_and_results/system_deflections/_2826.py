...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshSystemDeflection(_2846.GearMeshSystemDeflection):
    """CylindricalGearMeshSystemDeflection
    ...
    @property
    def gear_a(self: "Self") -> "_2832.CylindricalGearSystemDeflection":
    ...
    @property
    def gear_b(self: "Self") -> "_2832.CylindricalGearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4187.CylindricalGearMeshPowerFlow":
    ...
    def mesh_deflections_left_flank(
        self: "Self",
    ) -> "List[_2934.MeshDeflectionResults]":
    ...
    @property
    def gear_set(self: "Self") -> "_2829.CylindricalGearSetSystemDeflection":
