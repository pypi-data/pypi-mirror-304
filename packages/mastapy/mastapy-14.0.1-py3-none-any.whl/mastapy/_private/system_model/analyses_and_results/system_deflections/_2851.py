...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetSystemDeflection(_2777.AGMAGleasonConicalGearSetSystemDeflection):
    """HypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4206.HypoidGearSetPowerFlow":
    ...
    def agma_gleason_conical_gears_system_deflection(
        self: "Self",
    ) -> "List[_2852.HypoidGearSystemDeflection]":
    ...
    def agma_gleason_conical_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2850.HypoidGearMeshSystemDeflection]":
