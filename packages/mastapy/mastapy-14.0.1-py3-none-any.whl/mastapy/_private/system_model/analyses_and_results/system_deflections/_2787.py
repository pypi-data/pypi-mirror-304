...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BeltDriveSystemDeflection(_2895.SpecialisedAssemblySystemDeflection):
    """BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4149.BeltDrivePowerFlow":
    ...
    @property
    def belts(self: "Self") -> "List[_2786.BeltConnectionSystemDeflection]":
