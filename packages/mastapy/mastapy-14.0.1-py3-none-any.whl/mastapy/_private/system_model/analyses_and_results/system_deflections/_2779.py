...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AssemblySystemDeflection(_2772.AbstractAssemblySystemDeflection):
    """AssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4146.AssemblyPowerFlow":
    ...
    @property
    def bearings(self: "Self") -> "List[_2785.BearingSystemDeflection]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_2787.BeltDriveSystemDeflection]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_2796.BoltedJointSystemDeflection]":
    ...
    @property
    def bolts(self: "Self") -> "List[_2797.BoltSystemDeflection]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_2821.CVTSystemDeflection]":
    ...
    @property
    def clutches(self: "Self") -> "List[_2800.ClutchSystemDeflection]":
    ...
    @property
    def component_details(self: "Self") -> "List[_2802.ComponentSystemDeflection]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_2808.ConceptGearSetSystemDeflection]":
    ...
    @property
    def connection_details(self: "Self") -> "List[_2814.ConnectionSystemDeflection]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_2825.CycloidalDiscSystemDeflection]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_2844.FEPartSystemDeflection]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_2842.FaceGearSetSystemDeflection]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_2851.HypoidGearSetSystemDeflection]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_2866.MassDiscSystemDeflection]":
    ...
    @property
    def microphones(self: "Self") -> "List[_2870.MicrophoneSystemDeflection]":
    ...
    def mountable_component_details(
        self: "Self",
    ) -> "List[_2871.MountableComponentSystemDeflection]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_2873.OilSealSystemDeflection]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_2879.PlanetCarrierSystemDeflection]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_2880.PointLoadSystemDeflection]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_2881.PowerLoadSystemDeflection]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_2883.RingPinsSystemDeflection]":
    ...
    @property
    def rolling_bearings(self: "Self") -> "List[_2785.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
    ...
    @property
    def shafts(self: "Self") -> "List[_2893.ShaftSystemDeflection]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_2901.SpringDamperSystemDeflection]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_2913.SynchroniserSystemDeflection]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_2923.UnbalancedMassSystemDeflection]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_2926.WormGearSetSystemDeflection]":
