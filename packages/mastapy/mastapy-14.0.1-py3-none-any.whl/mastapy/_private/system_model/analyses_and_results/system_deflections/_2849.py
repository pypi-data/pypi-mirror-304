...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GuideDxfModelSystemDeflection(_2802.ComponentSystemDeflection):
    """GuideDxfModelSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_7047.GuideDxfModelLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4203.GuideDxfModelPowerFlow":
