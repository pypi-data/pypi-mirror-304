...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CycloidalAssemblySystemDeflection(_2895.SpecialisedAssemblySystemDeflection):
    """CycloidalAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4182.CycloidalAssemblyPowerFlow":
    ...
    def ring_pins_to_disc_connections(
        self: "Self",
    ) -> "List[_2884.RingPinsToDiscConnectionSystemDeflection]":
