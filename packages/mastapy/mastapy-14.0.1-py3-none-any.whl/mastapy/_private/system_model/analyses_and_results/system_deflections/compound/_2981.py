...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTCompoundSystemDeflection(_2950.BeltDriveCompoundSystemDeflection):
    """CVTCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2821.CVTSystemDeflection]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_2821.CVTSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.CVTSystemDeflection]
