...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FlexiblePinAssemblySystemDeflection(_2895.SpecialisedAssemblySystemDeflection):
    """FlexiblePinAssemblySystemDeflection
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7039.FlexiblePinAssemblyLoadCase":
    ...
    @property
    def flexible_pin_shaft_details(self: "Self") -> "_2893.ShaftSystemDeflection":
    ...
    @property
    def pin_analysis(self: "Self") -> "_2893.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4199.FlexiblePinAssemblyPowerFlow":
    ...
    @property
    def spindle_analyses(self: "Self") -> "_2893.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def bearing_static_analyses(self: "Self") -> "List[_2785.BearingSystemDeflection]":
    ...
    def flexible_pin_fit_details(
        self: "Self",
    ) -> "List[_2890.ShaftHubConnectionSystemDeflection]":
    ...
    def load_sharing_factor_reporters(
        self: "Self",
    ) -> "List[_2865.LoadSharingFactorReporter]":
    ...
    def observed_pin_stiffness_reporters(
        self: "Self",
    ) -> "List[_2872.ObservedPinStiffnessReporter]":
    ...
    def planet_gear_system_deflections(
        self: "Self",
    ) -> "List[_2832.CylindricalGearSystemDeflection]":
