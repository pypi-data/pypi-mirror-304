...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpringDamperConnectionSystemDeflection(_2816.CouplingConnectionSystemDeflection):
    """SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4248.SpringDamperConnectionPowerFlow":
