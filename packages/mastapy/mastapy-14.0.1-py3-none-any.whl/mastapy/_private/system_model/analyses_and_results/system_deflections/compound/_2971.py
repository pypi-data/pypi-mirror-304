...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetCompoundSystemDeflection(_3001.GearSetCompoundSystemDeflection):
    """ConceptGearSetCompoundSystemDeflection
    ...
    def concept_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_2969.ConceptGearCompoundSystemDeflection]":
    ...
    def concept_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_2970.ConceptGearMeshCompoundSystemDeflection]":
