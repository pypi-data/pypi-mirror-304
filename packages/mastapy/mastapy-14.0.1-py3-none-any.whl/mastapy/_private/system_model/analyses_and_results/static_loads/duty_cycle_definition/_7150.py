...
class PointLoadInputOptions(_1900.ColumnInputOptions):
    ...
    @property
    def conversion_to_load_case(self: "Self") -> "_7141.AdditionalForcesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads.duty_cycle_definition._7141",
    ...
    def conversion_to_load_case(
        self: "Self", value: "_7141.AdditionalForcesObtainedFrom"
    ) -> None:
