...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BearingLoadCase(_7001.ConnectorLoadCase):
    """BearingLoadCase
    ...
    def bearing_element_orbit_model(
        self: "Self",
        value: "Union[_5512.BearingElementOrbitModel, Tuple[_5512.BearingElementOrbitModel, bool]]",
    ) -> None:
    ...
    @property
    def bearing_stiffness_model(self: "Self") -> "_5514.BearingStiffnessModel":
