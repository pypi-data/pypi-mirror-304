...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AGMAGleasonConicalGearSetLoadCase(_6999.ConicalGearSetLoadCase):
    """AGMAGleasonConicalGearSetLoadCase
    ...
    def conical_gears_load_case(
        self: "Self",
    ) -> "List[_6964.AGMAGleasonConicalGearLoadCase]":
    ...
    def conical_meshes_load_case(
        self: "Self",
    ) -> "List[_6965.AGMAGleasonConicalGearMeshLoadCase]":
