...
from mastapy._private.system_model.analyses_and_results.static_loads import _7130, _7134
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoadLoadCase(_7134.VirtualComponentLoadCase):
    """PowerLoadLoadCase
    ...
    @enforce_parameter_types
    def system_deflection_torque_method(
        self: "Self", value: "_7130.TorqueSpecificationForSystemDeflection"
    ) -> None:
    ...
    @property
    def wheel_slip_model(self: "Self") -> "_5647.WheelSlipType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5647",
            "WheelSlipType",
        )(value)

    @wheel_slip_model.setter
    @enforce_parameter_types
    def wheel_slip_model(self: "Self", value: "_5647.WheelSlipType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.WheelSlipType",
        )
