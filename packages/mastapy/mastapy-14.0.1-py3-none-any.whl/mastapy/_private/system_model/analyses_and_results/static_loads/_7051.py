...
from mastapy._private.system_model.analyses_and_results.static_loads import _7030, _7049
...
class HarmonicLoadDataFluxImport(
    _7049.HarmonicLoadDataCSVImport[_7030.ElectricMachineHarmonicLoadFluxImportOptions]
):
    """HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self: "Self") -> "_7061.InnerDiameterReference":
    ...
    def inner_diameter_reference(
        self: "Self", value: "_7061.InnerDiameterReference"
    ) -> None:
