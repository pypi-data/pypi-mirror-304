...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSetLoadCase(_6980.BevelGearSetLoadCase):
    """SpiralBevelGearSetLoadCase
    ...
    @property
    def bevel_gears_load_case(self: "Self") -> "List[_7106.SpiralBevelGearLoadCase]":
    ...
    def spiral_bevel_gears_load_case(
        self: "Self",
    ) -> "List[_7106.SpiralBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.SpiralBevelGearLoadCase]
    ...
    def bevel_meshes_load_case(
        self: "Self",
    ) -> "List[_7107.SpiralBevelGearMeshLoadCase]":
