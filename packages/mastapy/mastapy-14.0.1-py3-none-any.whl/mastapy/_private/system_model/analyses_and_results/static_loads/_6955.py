...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StaticLoadCase(_6954.LoadCase):
    """StaticLoadCase
    ...
    @property
    def system_deflection(self: "Self") -> "_2733.SystemDeflectionAnalysis":
    ...
    @property
    def power_flow(self: "Self") -> "_2728.PowerFlowAnalysis":
    ...
    @property
    def harmonic_analysis(self: "Self") -> "_2719.HarmonicAnalysis":
    ...
    @property
    def parametric_study_tool(self: "Self") -> "_2727.ParametricStudyToolAnalysis":
    ...
    @property
    def modal_analysis(self: "Self") -> "_2722.ModalAnalysis":
    ...
    @property
    def critical_speed_analysis(self: "Self") -> "_2712.CriticalSpeedAnalysis":
    ...
    @property
    def stability_analysis(self: "Self") -> "_2729.StabilityAnalysis":
    ...
    def harmonic_analysis_options_for_atsam(
        self: "Self",
    ) -> "_7225.HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation":
    ...
    def te_set_up_for_dynamic_analyses_options(
        self: "Self",
    ) -> "_2770.TESetUpForDynamicAnalysisOptions":
    ...
    @property
    def clutch_engagements(self: "Self") -> "List[_5795.ClutchEngagementStatus]":
    ...
    def concept_clutch_engagements(
        self: "Self",
    ) -> "List[_5796.ConceptSynchroGearEngagementStatus]":
    ...
    @property
    def design_state_load_case_group(self: "Self") -> "_5797.DesignState":
    ...
    @enforce_parameter_types
    def duplicate(
        self: "Self", new_design_state_group: "_5797.DesignState", name: "str" = "None"
    ) -> "StaticLoadCase":
