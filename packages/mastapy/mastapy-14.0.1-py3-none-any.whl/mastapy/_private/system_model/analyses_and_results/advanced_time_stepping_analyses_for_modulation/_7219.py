...
class FEPartAdvancedTimeSteppingAnalysisForModulation(
    _7160.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation,
    _2741.IHaveFEPartHarmonicAnalysisResults,
):
    """FEPartAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def export(self: "Self") -> "_5898.HarmonicAnalysisFEExportOptions":
    ...
    @property
    def results(self: "Self") -> "_5993.FEPartHarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2844.FEPartSystemDeflection":
