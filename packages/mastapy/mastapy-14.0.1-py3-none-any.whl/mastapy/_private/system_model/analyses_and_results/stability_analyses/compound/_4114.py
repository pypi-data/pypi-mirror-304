...
class StraightBevelGearSetCompoundStabilityAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3982.StraightBevelGearSetStabilityAnalysis]":
    ...
    def straight_bevel_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4112.StraightBevelGearCompoundStabilityAnalysis]":
    ...
    def straight_bevel_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4113.StraightBevelGearMeshCompoundStabilityAnalysis]":
