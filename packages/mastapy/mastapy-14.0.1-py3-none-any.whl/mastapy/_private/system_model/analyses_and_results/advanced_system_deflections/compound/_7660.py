...
class _Cast_RootAssemblyCompoundAdvancedSystemDeflection:
    ...
    def assembly_compound_advanced_system_deflection(
        self: "CastSelf",
    ) -> "_7571.AssemblyCompoundAdvancedSystemDeflection":
        return self.__parent__._cast(_7571.AssemblyCompoundAdvancedSystemDeflection)
...
class RootAssemblyCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7528.RootAssemblyAdvancedSystemDeflection]":
