...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6545
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MassDiscDynamicAnalysis(_6545.VirtualComponentDynamicAnalysis):
    """MassDiscDynamicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7072.MassDiscLoadCase":
