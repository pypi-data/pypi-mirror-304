...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetDynamicAnalysis(_6425.AGMAGleasonConicalGearSetDynamicAnalysis):
    """HypoidGearSetDynamicAnalysis
    ...
    def agma_gleason_conical_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6483.HypoidGearDynamicAnalysis]":
    ...
    def agma_gleason_conical_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6484.HypoidGearMeshDynamicAnalysis]":
