...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6521
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetDynamicAnalysis(_6521.SpecialisedAssemblyDynamicAnalysis):
    """GearSetDynamicAnalysis
    ...
    @property
    def gears_dynamic_analysis(self: "Self") -> "List[_6479.GearDynamicAnalysis]":
    ...
    @property
    def meshes_dynamic_analysis(self: "Self") -> "List[_6480.GearMeshDynamicAnalysis]":
