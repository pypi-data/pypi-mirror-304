...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DesignState(_5792.AbstractDesignStateLoadCaseGroup):
    """DesignState
    ...
    @property
    def clutches(self: "Self") -> "List[_5795.ClutchEngagementStatus]":
    ...
    ) -> "_5796.ConceptSynchroGearEngagementStatus":
