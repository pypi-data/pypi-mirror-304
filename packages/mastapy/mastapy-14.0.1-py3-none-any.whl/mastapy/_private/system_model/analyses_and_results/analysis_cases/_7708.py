...
T = TypeVar("T", bound="_6954.LoadCase")
...
class _Cast_AbstractAnalysisOptions:
    ...
    @property
    def system_deflection_options(self: "CastSelf") -> "_2916.SystemDeflectionOptions":
        from mastapy._private.system_model.analyses_and_results.system_deflections import (
            _2916,
        )

        return self.__parent__._cast(_2916.SystemDeflectionOptions)

    @property
    def frequency_response_analysis_options(
        self: "CastSelf",
    ) -> "_4749.FrequencyResponseAnalysisOptions":
        from mastapy._private.system_model.analyses_and_results.modal_analyses import (
            _4749,
        )

        return self.__parent__._cast(_4749.FrequencyResponseAnalysisOptions)

    @property
    def mbd_run_up_analysis_options(
        self: "CastSelf",
    ) -> "_5590.MBDRunUpAnalysisOptions":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses import (
            _5590,
        )

        return self.__parent__._cast(_5590.MBDRunUpAnalysisOptions)
    ...
    def frequency_options_for_harmonic_analysis_results(
        ...
        return self.__parent__._cast(_5886.FrequencyOptionsForHarmonicAnalysisResults)
    ...
    def speed_options_for_harmonic_analysis_results(
        ...
        return self.__parent__._cast(_5947.SpeedOptionsForHarmonicAnalysisResults)

    @property
    def stiffness_options_for_harmonic_analysis(
        self: "CastSelf",
    ) -> "_5954.StiffnessOptionsForHarmonicAnalysis":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5954,
        )

        return self.__parent__._cast(_5954.StiffnessOptionsForHarmonicAnalysis)
