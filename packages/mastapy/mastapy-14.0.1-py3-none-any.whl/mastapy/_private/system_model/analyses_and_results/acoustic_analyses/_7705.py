...
from mastapy._private.system_model.analyses_and_results.acoustic_analyses import _7704
...
class _Cast_SingleHarmonicExcitationAnalysisDetail:
    ...
    @property
    def single_excitation_details(self: "CastSelf") -> "_7704.SingleExcitationDetails":
        return self.__parent__._cast(_7704.SingleExcitationDetails)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SingleHarmonicExcitationAnalysisDetail(_7704.SingleExcitationDetails):
    """SingleHarmonicExcitationAnalysisDetail
