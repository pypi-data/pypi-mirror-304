...
class HarmonicAcousticAnalysis(_0.APIBase):
    ...
    @property
    def analysis_run_type(self: "Self") -> "_7695.AcousticAnalysisRunType":
    ...
    def analysis_run_type(self: "Self", value: "_7695.AcousticAnalysisRunType") -> None:
    ...
    def excitation_details_to_run(
        self: "Self",
    ) -> "List[_7704.SingleExcitationDetails]":
