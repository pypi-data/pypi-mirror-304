...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetCriticalSpeedAnalysis(_6752.GearSetCriticalSpeedAnalysis):
    """FaceGearSetCriticalSpeedAnalysis
    ...
    def gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6745.FaceGearCriticalSpeedAnalysis]":
    ...
    def meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6746.FaceGearMeshCriticalSpeedAnalysis]":
