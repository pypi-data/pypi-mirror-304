...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTPulleyCompoundPowerFlow(_4366.PulleyCompoundPowerFlow):
    """CVTPulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4181.CVTPulleyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CVTPulleyPowerFlow]
