...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AssemblyPowerFlow(_4139.AbstractAssemblyPowerFlow):
    """AssemblyPowerFlow
    ...
    @property
    def bearings(self: "Self") -> "List[_4147.BearingPowerFlow]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_4149.BeltDrivePowerFlow]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_4158.BoltedJointPowerFlow]":
    ...
    @property
    def bolts(self: "Self") -> "List[_4159.BoltPowerFlow]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_4180.CVTPowerFlow]":
    ...
    @property
    def clutches(self: "Self") -> "List[_4162.ClutchPowerFlow]":
    ...
    @property
    def concept_couplings(self: "Self") -> "List[_4167.ConceptCouplingPowerFlow]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_4170.ConceptGearSetPowerFlow]":
    ...
    @property
    def cycloidal_assemblies(self: "Self") -> "List[_4182.CycloidalAssemblyPowerFlow]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_4185.CycloidalDiscPowerFlow]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_4198.FEPartPowerFlow]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_4195.FaceGearSetPowerFlow]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_4206.HypoidGearSetPowerFlow]":
    ...
    @property
    def loaded_gear_sets(self: "Self") -> "List[_4202.GearSetPowerFlow]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_4217.MassDiscPowerFlow]":
    ...
    @property
    def microphones(self: "Self") -> "List[_4220.MicrophonePowerFlow]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_4222.OilSealPowerFlow]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_4229.PlanetCarrierPowerFlow]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_4230.PointLoadPowerFlow]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_4233.PowerLoadPowerFlow]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_4235.RingPinsPowerFlow]":
    ...
    @property
    def shafts(self: "Self") -> "List[_4242.ShaftPowerFlow]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_4250.SpringDamperPowerFlow]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_4261.SynchroniserPowerFlow]":
    ...
    @property
    def torque_converters(self: "Self") -> "List[_4265.TorqueConverterPowerFlow]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_4268.UnbalancedMassPowerFlow]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_4272.WormGearSetPowerFlow]":
    ...
    @property
    def zerol_bevel_gear_sets(self: "Self") -> "List[_4275.ZerolBevelGearSetPowerFlow]":
