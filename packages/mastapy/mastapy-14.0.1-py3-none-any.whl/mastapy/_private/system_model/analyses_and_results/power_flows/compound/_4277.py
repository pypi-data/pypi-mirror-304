...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AbstractShaftCompoundPowerFlow(_4278.AbstractShaftOrHousingCompoundPowerFlow):
    """AbstractShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4141.AbstractShaftPowerFlow]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4141.AbstractShaftPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.AbstractShaftPowerFlow]
