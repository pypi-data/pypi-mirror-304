...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserCompoundPowerFlow(_4376.SpecialisedAssemblyCompoundPowerFlow):
    """SynchroniserCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4261.SynchroniserPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4261.SynchroniserPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SynchroniserPowerFlow]
