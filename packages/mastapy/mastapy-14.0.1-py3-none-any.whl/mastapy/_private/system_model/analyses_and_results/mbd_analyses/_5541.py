...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalGearSetMultibodyDynamicsAnalysis(_5568.GearSetMultibodyDynamicsAnalysis):
    """ConicalGearSetMultibodyDynamicsAnalysis
    ...
    def gears_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5540.ConicalGearMultibodyDynamicsAnalysis]":
    ...
    def meshes_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5539.ConicalGearMeshMultibodyDynamicsAnalysis]":
