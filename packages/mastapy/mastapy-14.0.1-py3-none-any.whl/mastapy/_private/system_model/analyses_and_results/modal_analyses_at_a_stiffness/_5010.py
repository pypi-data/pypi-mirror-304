...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalGearSetModalAnalysisAtAStiffness(_5037.GearSetModalAnalysisAtAStiffness):
    """ConicalGearSetModalAnalysisAtAStiffness
    ...
    def gears_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_5009.ConicalGearModalAnalysisAtAStiffness]":
    ...
    def meshes_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_5008.ConicalGearMeshModalAnalysisAtAStiffness]":
