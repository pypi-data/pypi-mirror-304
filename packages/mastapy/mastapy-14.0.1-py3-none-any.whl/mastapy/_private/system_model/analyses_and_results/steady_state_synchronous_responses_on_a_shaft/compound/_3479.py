...
class _Cast_AssemblyCompoundSteadyStateSynchronousResponseOnAShaft:
    ...
    def root_assembly_compound_steady_state_synchronous_response_on_a_shaft(
        self: "CastSelf",
    ) -> "_3568.RootAssemblyCompoundSteadyStateSynchronousResponseOnAShaft":
        from mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import (
            _3568,
        )
...
class AssemblyCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3347.AssemblySteadyStateSynchronousResponseOnAShaft]":
    ...
    def bearings(
        self: "Self",
    ) -> "List[_3480.BearingCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def belt_drives(
        self: "Self",
    ) -> "List[_3482.BeltDriveCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_3485.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_3492.BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def bolts(
        self: "Self",
    ) -> "List[_3491.BoltCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cv_ts(
        self: "Self",
    ) -> "List[_3513.CVTCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def clutches(
        self: "Self",
    ) -> "List[_3493.ClutchCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_3498.ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_3503.ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_3515.CycloidalAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_3517.CycloidalDiscCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_3521.CylindricalGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def fe_parts(
        self: "Self",
    ) -> "List[_3528.FEPartCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_3527.FaceGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def flexible_pin_assemblies(
        ...
        "List[_3529.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]"
    ):
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3536.HypoidGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3543.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3546.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def mass_discs(
        self: "Self",
    ) -> "List[_3547.MassDiscCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def measurement_components(
        ...
        "List[_3548.MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft]"
    ):
    ...
    def microphones(
        self: "Self",
    ) -> "List[_3550.MicrophoneCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def oil_seals(
        self: "Self",
    ) -> "List[_3552.OilSealCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_3554.PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_3559.PlanetCarrierCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_3560.PointLoadCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_3561.PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def ring_pins(
        self: "Self",
    ) -> "List[_3563.RingPinsCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def rolling_ring_assemblies(
        ...
        "List[_3565.RollingRingAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]"
    ):
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_3570.ShaftHubConnectionCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def shafts(
        self: "Self",
    ) -> "List[_3569.ShaftCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3575.SpiralBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_3576.SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_3581.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def straight_bevel_gear_sets(
        ...
        "List[_3584.StraightBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]"
    ):
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_3587.SynchroniserCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_3591.TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_3595.UnbalancedMassCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_3599.WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3602.ZerolBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]":
