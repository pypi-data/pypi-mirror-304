...
class _Cast_SingleExcitationResultsModalAnalysis:
    ...
    def design_entity_modal_analysis_group_results(
        self: "CastSelf",
    ) -> "_4836.DesignEntityModalAnalysisGroupResults":
        return self.__parent__._cast(_4836.DesignEntityModalAnalysisGroupResults)
...
class SingleExcitationResultsModalAnalysis(_4836.DesignEntityModalAnalysisGroupResults):
    ...
    def all_rigidly_connected_groups(
        ...
        "List[_4839.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]"
    ):
