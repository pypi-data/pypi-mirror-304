...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSetCompoundModalAnalysis(_4863.BevelGearSetCompoundModalAnalysis):
    """SpiralBevelGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4802.SpiralBevelGearSetModalAnalysis]":
    ...
    def spiral_bevel_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4946.SpiralBevelGearCompoundModalAnalysis]":
    ...
    def spiral_bevel_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4947.SpiralBevelGearMeshCompoundModalAnalysis]":
