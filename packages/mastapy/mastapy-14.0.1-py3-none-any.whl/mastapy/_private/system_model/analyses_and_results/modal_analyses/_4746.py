...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetModalAnalysis(_4752.GearSetModalAnalysis):
    """FaceGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2842.FaceGearSetSystemDeflection":
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4745.FaceGearModalAnalysis]":
    ...
    @property
    def face_gears_modal_analysis(self: "Self") -> "List[_4745.FaceGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearModalAnalysis]
    ...
    @property
    def meshes_modal_analysis(self: "Self") -> "List[_4744.FaceGearMeshModalAnalysis]":
    ...
    def face_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4744.FaceGearMeshModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearMeshModalAnalysis]
