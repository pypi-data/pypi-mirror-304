...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCompoundModalAnalysis(_4870.ComponentCompoundModalAnalysis):
    """DatumCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4739.DatumModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.DatumModalAnalysis]
