...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetCompoundModalAnalysis(_4905.GearSetCompoundModalAnalysis):
    """CylindricalGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4737.CylindricalGearSetModalAnalysis]":
    ...
    def cylindrical_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4892.CylindricalGearCompoundModalAnalysis]":
    ...
    def cylindrical_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4893.CylindricalGearMeshCompoundModalAnalysis]":
