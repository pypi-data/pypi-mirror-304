...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetCompoundModalAnalysis(_4945.SpecialisedAssemblyCompoundModalAnalysis):
    """GearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4752.GearSetModalAnalysis]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4752.GearSetModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.GearSetModalAnalysis]
