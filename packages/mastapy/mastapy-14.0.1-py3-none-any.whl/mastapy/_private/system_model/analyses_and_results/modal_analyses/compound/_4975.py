...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSetCompoundModalAnalysis(_4863.BevelGearSetCompoundModalAnalysis):
    """ZerolBevelGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4832.ZerolBevelGearSetModalAnalysis]":
    ...
    def zerol_bevel_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4973.ZerolBevelGearCompoundModalAnalysis]":
    ...
    def zerol_bevel_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4974.ZerolBevelGearMeshCompoundModalAnalysis]":
