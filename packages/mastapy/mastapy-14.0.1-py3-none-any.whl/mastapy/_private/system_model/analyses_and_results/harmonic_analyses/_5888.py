...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearMeshExcitationDetail(_5813.AbstractPeriodicExcitationDetail):
    """GearMeshExcitationDetail
    ...
    @property
    def uncoupled_modal_analysis(self: "Self") -> "_4771.ModalAnalysis":
    ...
    @property
    def gear_mesh(self: "Self") -> "_2846.GearMeshSystemDeflection":
    ...
    def get_compliance_and_force_data(self: "Self") -> "_5838.ComplianceAndForceData":
