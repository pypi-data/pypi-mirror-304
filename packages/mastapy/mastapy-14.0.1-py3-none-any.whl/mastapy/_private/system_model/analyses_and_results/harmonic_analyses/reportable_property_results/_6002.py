...
class _Cast_ResultsForMultipleOrders:
    ...
    def results_for_multiple_orders_for_fe_surface(
        self: "CastSelf",
    ) -> "_6003.ResultsForMultipleOrdersForFESurface":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _6003,
        )

        return self.__parent__._cast(_6003.ResultsForMultipleOrdersForFESurface)

    @property
    def results_for_multiple_orders_for_groups(
        self: "CastSelf",
    ) -> "_6004.ResultsForMultipleOrdersForGroups":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _6004,
        )

        return self.__parent__._cast(_6004.ResultsForMultipleOrdersForGroups)
