...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltHarmonicAnalysis(_5839.ComponentHarmonicAnalysis):
    """BoltHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_6982.BoltLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2797.BoltSystemDeflection":
