...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelDifferentialGearSetHarmonicAnalysis(_5831.BevelGearSetHarmonicAnalysis):
    """BevelDifferentialGearSetHarmonicAnalysis
    ...
    def bevel_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5824.BevelDifferentialGearHarmonicAnalysis]":
    ...
    def bevel_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5825.BevelDifferentialGearMeshHarmonicAnalysis]":
