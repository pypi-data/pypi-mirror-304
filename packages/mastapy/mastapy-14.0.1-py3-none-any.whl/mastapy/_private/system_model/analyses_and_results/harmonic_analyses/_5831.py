...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelGearSetHarmonicAnalysis(_5819.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """BevelGearSetHarmonicAnalysis
    ...
    def agma_gleason_conical_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5829.BevelGearHarmonicAnalysis]":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2794.BevelGearSetSystemDeflection":
