...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearHarmonicAnalysis(_5887.GearHarmonicAnalysis):
    """ConceptGearHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_6992.ConceptGearLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2809.ConceptGearSystemDeflection":
