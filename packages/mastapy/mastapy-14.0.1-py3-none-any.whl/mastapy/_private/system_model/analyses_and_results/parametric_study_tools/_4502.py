...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    def analysis_type(self: "Self", value: "_6968.AnalysisType") -> None:
    ...
    @property
    def parametric_study_type(self: "Self") -> "_7080.ParametricStudyType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7080",
            "ParametricStudyType",
        )(value)

    @parametric_study_type.setter
    @enforce_parameter_types
    def parametric_study_type(self: "Self", value: "_7080.ParametricStudyType") -> None:
    ...
    @property
    def step_results(self: "Self") -> "List[_4504.ParametricStudyToolStepResult]":
    ...
    @property
    def study_variables(self: "Self") -> "List[_4505.ParametricStudyVariable]":
    ...
    def parametric_study_logging_variables(
        self: "Self",
    ) -> "List[_2735.AnalysisCaseVariable]":
    ...
    def move_study_variable_down(
        self: "Self", study_variable: "_4505.ParametricStudyVariable"
    ) -> None:
        """Method does not return.
    ...
    def remove_logging_variable(
        self: "Self", analysis_variable: "_2735.AnalysisCaseVariable"
    ) -> None:
        """Method does not return.
