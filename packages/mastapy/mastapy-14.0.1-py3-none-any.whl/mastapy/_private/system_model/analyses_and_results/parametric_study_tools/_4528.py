...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSetParametricStudyTool(_4425.BevelGearSetParametricStudyTool):
    """SpiralBevelGearSetParametricStudyTool
    ...
    def assembly_system_deflection_results(
        self: "Self",
    ) -> "List[_2897.SpiralBevelGearSetSystemDeflection]":
    ...
    def bevel_gears_parametric_study_tool(
        self: "Self",
    ) -> "List[_4527.SpiralBevelGearParametricStudyTool]":
    ...
    def bevel_meshes_parametric_study_tool(
        self: "Self",
    ) -> "List[_4526.SpiralBevelGearMeshParametricStudyTool]":
