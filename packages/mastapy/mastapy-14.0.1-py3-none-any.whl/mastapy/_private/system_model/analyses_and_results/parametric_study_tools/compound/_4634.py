...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicrophoneCompoundParametricStudyTool(_4581.ComponentCompoundParametricStudyTool):
    """MicrophoneCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7076.MicrophoneLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4492.MicrophoneParametricStudyTool]":
