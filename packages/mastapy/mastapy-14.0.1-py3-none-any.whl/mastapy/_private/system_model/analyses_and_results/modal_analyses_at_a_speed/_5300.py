...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetModalAnalysisAtASpeed(_5341.SpecialisedAssemblyModalAnalysisAtASpeed):
    """GearSetModalAnalysisAtASpeed
    ...
    def gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5299.GearModalAnalysisAtASpeed]":
    ...
    def meshes_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5298.GearMeshModalAnalysisAtASpeed]":
