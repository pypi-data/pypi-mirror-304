...
class _Cast_SynchroniserPartCompoundSteadyStateSynchronousResponse:
    ...
    def synchroniser_half_compound_steady_state_synchronous_response(
        self: "CastSelf",
    ) -> "_3325.SynchroniserHalfCompoundSteadyStateSynchronousResponse":
        from mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.compound import (
            _3325,
        )
    ...
    def synchroniser_sleeve_compound_steady_state_synchronous_response(
        self: "CastSelf",
    ) -> "_3327.SynchroniserSleeveCompoundSteadyStateSynchronousResponse":
        from mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.compound import (
            _3327,
        )
...
class SynchroniserPartCompoundSteadyStateSynchronousResponse(
    ...
    def component_analysis_cases(
        self: "Self",
    ) -> "List[_3194.SynchroniserPartSteadyStateSynchronousResponse]":
