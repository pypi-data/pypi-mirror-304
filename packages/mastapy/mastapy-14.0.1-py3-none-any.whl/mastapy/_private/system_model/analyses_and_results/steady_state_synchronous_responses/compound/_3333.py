...
class _Cast_VirtualComponentCompoundSteadyStateSynchronousResponse:
    ...
    def mass_disc_compound_steady_state_synchronous_response(
        self: "CastSelf",
    ) -> "_3284.MassDiscCompoundSteadyStateSynchronousResponse":
        from mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.compound import (
            _3284,
        )
    ...
    def measurement_component_compound_steady_state_synchronous_response(
        self: "CastSelf",
    ) -> "_3285.MeasurementComponentCompoundSteadyStateSynchronousResponse":
        from mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.compound import (
            _3285,
        )
    ...
    def point_load_compound_steady_state_synchronous_response(
        self: "CastSelf",
    ) -> "_3297.PointLoadCompoundSteadyStateSynchronousResponse":
        from mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.compound import (
            _3297,
        )
    ...
    def power_load_compound_steady_state_synchronous_response(
        self: "CastSelf",
    ) -> "_3298.PowerLoadCompoundSteadyStateSynchronousResponse":
        from mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.compound import (
            _3298,
        )
    ...
    def unbalanced_mass_compound_steady_state_synchronous_response(
        self: "CastSelf",
    ) -> "_3332.UnbalancedMassCompoundSteadyStateSynchronousResponse":
        from mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.compound import (
            _3332,
        )
...
class VirtualComponentCompoundSteadyStateSynchronousResponse(
    ...
    def component_analysis_cases(
        self: "Self",
    ) -> "List[_3202.VirtualComponentSteadyStateSynchronousResponse]":
