...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ParametricStudyToolAnalysis(_2707.SingleAnalysis):
    """ParametricStudyToolAnalysis
