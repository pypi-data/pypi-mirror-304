...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2500, _2501
...
class _Cast_Socket:
    ...
    def electric_machine_stator_socket(
        self: "CastSelf",
    ) -> "_2333.ElectricMachineStatorSocket":
        from mastapy._private.system_model.connections_and_sockets import _2333

        return self.__parent__._cast(_2333.ElectricMachineStatorSocket)
...
class Socket(_0.APIBase):
    ...
    @property
    def connected_components(self: "Self") -> "List[_2500.Component]":
    ...
    @property
    def owner(self: "Self") -> "_2500.Component":
    ...
    @enforce_parameter_types
    def connection_to(self: "Self", socket: "Socket") -> "_2327.Connection":
    ...
    def get_possible_sockets_to_connect_to(
        self: "Self", component_to_connect_to: "_2500.Component"
    ) -> "List[Socket]":
