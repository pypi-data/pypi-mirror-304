...
from mastapy._private.system_model.part_model.couplings import _2653, _2656, _2657
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftHubConnection(_2503.Connector):
    """ShaftHubConnection
    ...
    @enforce_parameter_types
    def stiffness_type(
        self: "Self", value: "_2653.RigidConnectorStiffnessType"
    ) -> None:
    ...
    @property
    def tilt_stiffness_type(self: "Self") -> "_2654.RigidConnectorTiltStiffnessTypes":
    ...
    def tilt_stiffness_type(
        self: "Self", value: "_2654.RigidConnectorTiltStiffnessTypes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.RigidConnectorTiltStiffnessTypes",
    ...
    @enforce_parameter_types
    def tooth_spacing_type(
        self: "Self", value: "_2656.RigidConnectorToothSpacingType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: "Self", value: "_2657.RigidConnectorTypes") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
