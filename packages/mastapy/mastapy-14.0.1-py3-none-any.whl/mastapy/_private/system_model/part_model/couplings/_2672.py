...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2673, _2675
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverter(_2644.Coupling):
    """TorqueConverter
    ...
    @property
    def pump(self: "Self") -> "_2673.TorqueConverterPump":
    ...
    @property
    def turbine(self: "Self") -> "_2675.TorqueConverterTurbine":
