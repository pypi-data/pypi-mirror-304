...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCoupling(_2644.Coupling):
    """ConceptCoupling
    ...
    @property
    def half_positioning(self: "Self") -> "_2643.ConceptCouplingHalfPositioning":
    ...
    def half_positioning(
        self: "Self", value: "_2643.ConceptCouplingHalfPositioning"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.ConceptCouplingHalfPositioning",
