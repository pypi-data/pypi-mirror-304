...
from mastapy._private.system_model.part_model.gears import _2584, _2585
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearFromCAD(_2563.MountableComponentFromCAD):
    """CylindricalGearFromCAD
    ...
    @enforce_parameter_types
    def existing_gear_set(self: "Self", value: "_2585.CylindricalGearSet") -> None:
    ...
    @meshing_gear.setter
    @enforce_parameter_types
    def meshing_gear(self: "Self", value: "_2584.CylindricalGear") -> None:
        wrapper_type = (
