...
class _Cast_InnerBearingRaceMountingOptions:
    ...
    def bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2497.BearingRaceMountingOptions":
        return self.__parent__._cast(_2497.BearingRaceMountingOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class InnerBearingRaceMountingOptions(_2497.BearingRaceMountingOptions):
    """InnerBearingRaceMountingOptions
