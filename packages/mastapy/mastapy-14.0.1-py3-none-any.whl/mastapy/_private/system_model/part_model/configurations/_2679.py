...
from mastapy._private.system_model.part_model.configurations import _2678, _2682
...
class _Cast_ActiveShaftDesignSelectionGroup:
    ...
    @property
    def part_detail_configuration(self: "CastSelf") -> "_2682.PartDetailConfiguration":
        return self.__parent__._cast(_2682.PartDetailConfiguration)
...
class ActiveShaftDesignSelectionGroup(
    _2682.PartDetailConfiguration[
        _2678.ActiveShaftDesignSelection, _2541.Shaft, _43.SimpleShaftDefinition
    ]
):
    """ActiveShaftDesignSelectionGroup
