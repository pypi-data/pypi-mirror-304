...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2700, _2701
...
class _Cast_ResultSurfaceOptions:
    ...
    @property
    def result_plane_options(self: "CastSelf") -> "_2700.ResultPlaneOptions":
        from mastapy._private.system_model.part_model.acoustics import _2700

        return self.__parent__._cast(_2700.ResultPlaneOptions)

    @property
    def result_sphere_options(self: "CastSelf") -> "_2701.ResultSphereOptions":
        from mastapy._private.system_model.part_model.acoustics import _2701

        return self.__parent__._cast(_2701.ResultSphereOptions)
