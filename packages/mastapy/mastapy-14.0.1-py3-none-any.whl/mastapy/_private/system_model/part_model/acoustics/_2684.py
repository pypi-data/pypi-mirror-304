...
class AcousticAnalysisOptions(_0.APIBase):
    ...
    @property
    def initial_guess(self: "Self") -> "_7700.InitialGuessOption":
    ...
    @enforce_parameter_types
    def initial_guess(self: "Self", value: "_7700.InitialGuessOption") -> None:
    ...
    @property
    def m2l_cache_type(self: "Self") -> "_7701.M2LHfCacheType":
    ...
    @enforce_parameter_types
    def m2l_cache_type(self: "Self", value: "_7701.M2LHfCacheType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.M2LHfCacheType",
        )
    ...
    def near_field_integrals_cache_type(
        self: "Self",
    ) -> "_7702.NearFieldIntegralsCacheType":
    ...
    @enforce_parameter_types
    def near_field_integrals_cache_type(
        self: "Self", value: "_7702.NearFieldIntegralsCacheType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.NearFieldIntegralsCacheType",
    ...
    @property
    def octree_creation_method(self: "Self") -> "_7703.OctreeCreationMethod":
    ...
    def octree_creation_method(
        self: "Self", value: "_7703.OctreeCreationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.OctreeCreationMethod",
    ...
    @property
    def preconditioner(self: "Self") -> "_7696.AcousticPreconditionerType":
    ...
    @enforce_parameter_types
    def preconditioner(self: "Self", value: "_7696.AcousticPreconditionerType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.AcousticPreconditionerType",
        )
