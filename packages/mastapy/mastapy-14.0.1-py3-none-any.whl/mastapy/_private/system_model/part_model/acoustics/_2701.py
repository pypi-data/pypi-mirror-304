...
class _Cast_ResultSphereOptions:
    ...
    @property
    def result_surface_options(self: "CastSelf") -> "_2703.ResultSurfaceOptions":
        return self.__parent__._cast(_2703.ResultSurfaceOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ResultSphereOptions(_2703.ResultSurfaceOptions):
    """ResultSphereOptions
