...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2691, _2693
...
class AcousticInputSurfaceOptions(_0.APIBase):
    ...
    @property
    def fe_part_options(self: "Self") -> "List[_2691.FEPartInputSurfaceOptions]":
    ...
    @property
    def hole_meshes(self: "Self") -> "List[_2693.HoleInFaceGroup]":
