...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2582, _2589
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class KlingelnbergCycloPalloidHypoidGear(_2595.KlingelnbergCycloPalloidConicalGear):
    """KlingelnbergCycloPalloidHypoidGear
