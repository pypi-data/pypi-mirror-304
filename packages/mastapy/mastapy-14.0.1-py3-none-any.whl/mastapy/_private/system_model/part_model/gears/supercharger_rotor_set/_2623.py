...
from mastapy._private.system_model.part_model.gears.supercharger_rotor_set import _2622
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SuperchargerRotorSetDatabase(_1881.NamedDatabase[_2622.SuperchargerRotorSet]):
    """SuperchargerRotorSetDatabase
