...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2415, _2456
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FESubstructureWithSelectionForHarmonicAnalysis(_2446.FESubstructureWithSelection):
    """FESubstructureWithSelectionForHarmonicAnalysis
    ...
    def boundary_conditions_all_nodes(
        self: "Self",
    ) -> "List[_2456.NodeBoundaryConditionStaticAnalysis]":
