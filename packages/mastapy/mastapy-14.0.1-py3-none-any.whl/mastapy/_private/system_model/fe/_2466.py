...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2460, _2461
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def links(self: "Self") -> "List[_2460.PerLinkExportOptions]":
    ...
    @property
    def nodes(self: "Self") -> "List[_2461.PerNodeExportOptions]":
