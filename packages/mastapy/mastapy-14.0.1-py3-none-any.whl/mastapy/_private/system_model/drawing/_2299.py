...
class _Cast_AdvancedSystemDeflectionViewable:
    ...
    def abstract_system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2298.AbstractSystemDeflectionViewable":
        return self.__parent__._cast(_2298.AbstractSystemDeflectionViewable)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AdvancedSystemDeflectionViewable(_2298.AbstractSystemDeflectionViewable):
    """AdvancedSystemDeflectionViewable
