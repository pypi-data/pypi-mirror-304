...
class EnumWithSelectedValue_GearMeshStiffnessModel(
    ...
    def wrapped_type(
        ...
        Returns:
            _5566.GearMeshStiffnessModel
        """
        return _5566.GearMeshStiffnessModel
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5566.GearMeshStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_5566.GearMeshStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_5566.GearMeshStiffnessModel]":
