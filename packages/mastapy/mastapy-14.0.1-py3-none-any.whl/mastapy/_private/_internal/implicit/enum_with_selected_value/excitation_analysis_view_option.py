...
class EnumWithSelectedValue_ExcitationAnalysisViewOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ExcitationAnalysisViewOption]",
    ) -> "_2317.ExcitationAnalysisViewOption":
        ...
        Returns:
            _2317.ExcitationAnalysisViewOption
        """
        return _2317.ExcitationAnalysisViewOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2317.ExcitationAnalysisViewOption.type_()

    @property
    def selected_value(self: "Self") -> "_2317.ExcitationAnalysisViewOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2317.ExcitationAnalysisViewOption]":
