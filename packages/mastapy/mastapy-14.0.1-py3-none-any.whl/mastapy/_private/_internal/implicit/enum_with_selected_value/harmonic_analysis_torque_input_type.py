...
class EnumWithSelectedValue_HarmonicAnalysisTorqueInputType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HarmonicAnalysisTorqueInputType]",
    ) -> "_5903.HarmonicAnalysisTorqueInputType":
        ...
        Returns:
            _5903.HarmonicAnalysisTorqueInputType
        """
        return _5903.HarmonicAnalysisTorqueInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5903.HarmonicAnalysisTorqueInputType.type_()

    @property
    def selected_value(self: "Self") -> "_5903.HarmonicAnalysisTorqueInputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_5903.HarmonicAnalysisTorqueInputType]":
