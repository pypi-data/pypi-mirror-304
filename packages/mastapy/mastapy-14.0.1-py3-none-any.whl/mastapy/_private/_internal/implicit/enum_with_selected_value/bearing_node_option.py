...
class EnumWithSelectedValue_BearingNodeOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2418.BearingNodeOption
        """
        return _2418.BearingNodeOption
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_BearingNodeOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2418.BearingNodeOption.type_()

    @property
    def selected_value(self: "Self") -> "_2418.BearingNodeOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2418.BearingNodeOption]":
