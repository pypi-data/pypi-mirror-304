...
class EnumWithSelectedValue_ShaftDiameterModificationDueToRollingBearingRing(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ShaftDiameterModificationDueToRollingBearingRing]",
    ) -> "_2534.ShaftDiameterModificationDueToRollingBearingRing":
        ...
        Returns:
            _2534.ShaftDiameterModificationDueToRollingBearingRing
        """
        return _2534.ShaftDiameterModificationDueToRollingBearingRing
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2534.ShaftDiameterModificationDueToRollingBearingRing.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2534.ShaftDiameterModificationDueToRollingBearingRing]":
