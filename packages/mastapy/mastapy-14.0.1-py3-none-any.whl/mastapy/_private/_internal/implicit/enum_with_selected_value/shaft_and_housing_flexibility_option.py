...
class EnumWithSelectedValue_ShaftAndHousingFlexibilityOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ShaftAndHousingFlexibilityOption]",
    ) -> "_5614.ShaftAndHousingFlexibilityOption":
        ...
        Returns:
            _5614.ShaftAndHousingFlexibilityOption
        """
        return _5614.ShaftAndHousingFlexibilityOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5614.ShaftAndHousingFlexibilityOption.type_()

    @property
    def selected_value(self: "Self") -> "_5614.ShaftAndHousingFlexibilityOption":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5614.ShaftAndHousingFlexibilityOption]":
