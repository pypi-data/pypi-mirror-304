...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorToothSpacingType]",
    ) -> "_2656.RigidConnectorToothSpacingType":
        ...
        Returns:
            _2656.RigidConnectorToothSpacingType
        """
        return _2656.RigidConnectorToothSpacingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2656.RigidConnectorToothSpacingType.type_()

    @property
    def selected_value(self: "Self") -> "_2656.RigidConnectorToothSpacingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2656.RigidConnectorToothSpacingType]":
