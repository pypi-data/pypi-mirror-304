...
class EnumWithSelectedValue_RigidConnectorTypes(
    ...
    def wrapped_type(
        ...
        Returns:
            _2657.RigidConnectorTypes
        """
        return _2657.RigidConnectorTypes
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_RigidConnectorTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2657.RigidConnectorTypes.type_()

    @property
    def selected_value(self: "Self") -> "_2657.RigidConnectorTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_2657.RigidConnectorTypes]":
