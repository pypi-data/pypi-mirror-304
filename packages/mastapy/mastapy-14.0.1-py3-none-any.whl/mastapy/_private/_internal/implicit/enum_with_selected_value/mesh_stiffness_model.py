...
class EnumWithSelectedValue_MeshStiffnessModel(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2269.MeshStiffnessModel
        """
        return _2269.MeshStiffnessModel
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_MeshStiffnessModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2269.MeshStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_2269.MeshStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_2269.MeshStiffnessModel]":
