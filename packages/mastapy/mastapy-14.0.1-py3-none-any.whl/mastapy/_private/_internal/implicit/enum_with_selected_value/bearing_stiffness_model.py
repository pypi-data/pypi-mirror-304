...
class EnumWithSelectedValue_BearingStiffnessModel(
    ...
    def wrapped_type(
        ...
        Returns:
            _5514.BearingStiffnessModel
        """
        return _5514.BearingStiffnessModel
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5514.BearingStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_5514.BearingStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_5514.BearingStiffnessModel]":
