...
class ListWithSelectedItem_DutyCycle(_5798.DutyCycle, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_DutyCycle]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5798.DutyCycle.TYPE

    @property
    def selected_value(self: "Self") -> "_5798.DutyCycle":
    ...
    @property
    def available_values(self: "Self") -> "List[_5798.DutyCycle]":
