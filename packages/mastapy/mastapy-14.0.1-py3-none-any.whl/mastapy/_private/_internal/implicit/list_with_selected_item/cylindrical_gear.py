...
class ListWithSelectedItem_CylindricalGear(
    _2584.CylindricalGear, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGear]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2584.CylindricalGear.TYPE

    @property
    def selected_value(self: "Self") -> "_2584.CylindricalGear":
    ...
    @property
    def available_values(self: "Self") -> "List[_2584.CylindricalGear]":
