...
class ListWithSelectedItem_FELink(_2474.FELink, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_FELink]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2474.FELink.TYPE

    @property
    def selected_value(self: "Self") -> "_2474.FELink":
    ...
    @property
    def available_values(self: "Self") -> "List[_2474.FELink]":
