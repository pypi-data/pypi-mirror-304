...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2240, _2241, _2243
...
class _Cast_PlainJournalHousing:
    ...
    def cylindrical_housing_journal_bearing(
        self: "CastSelf",
    ) -> "_2240.CylindricalHousingJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2240

        return self.__parent__._cast(_2240.CylindricalHousingJournalBearing)

    @property
    def machinery_encased_journal_bearing(
        self: "CastSelf",
    ) -> "_2241.MachineryEncasedJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2241

        return self.__parent__._cast(_2241.MachineryEncasedJournalBearing)

    @property
    def pedestal_journal_bearing(self: "CastSelf") -> "_2243.PedestalJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2243

        return self.__parent__._cast(_2243.PedestalJournalBearing)
