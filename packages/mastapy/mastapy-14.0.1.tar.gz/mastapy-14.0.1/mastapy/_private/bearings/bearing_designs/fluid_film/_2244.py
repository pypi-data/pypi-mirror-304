...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2245, _2247
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlainGreaseFilledJournalBearing(_2246.PlainJournalBearing):
    """PlainGreaseFilledJournalBearing
    ...
    def housing_type(
        self: "Self",
    ) -> "_2245.PlainGreaseFilledJournalBearingHousingType":
    ...
    def housing_type(
        self: "Self", value: "_2245.PlainGreaseFilledJournalBearingHousingType"
    ) -> None:
    ...
    @property
    def housing_detail(self: "Self") -> "_2247.PlainJournalHousing":
