...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptAxialClearanceBearing(_2253.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self: "Self") -> "_2251.BearingNodePosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_designs.concept._2251",
            "BearingNodePosition",
        )(value)

    @node_position.setter
    @enforce_parameter_types
    def node_position(self: "Self", value: "_2251.BearingNodePosition") -> None:
