...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2237, _2238
...
class _Cast_AxialFeedJournalBearing:
    ...
    def axial_groove_journal_bearing(
        self: "CastSelf",
    ) -> "_2237.AxialGrooveJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2237

        return self.__parent__._cast(_2237.AxialGrooveJournalBearing)

    @property
    def axial_hole_journal_bearing(self: "CastSelf") -> "_2238.AxialHoleJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2238

        return self.__parent__._cast(_2238.AxialHoleJournalBearing)
