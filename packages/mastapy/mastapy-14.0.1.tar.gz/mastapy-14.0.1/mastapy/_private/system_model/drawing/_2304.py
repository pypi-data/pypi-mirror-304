...
class HarmonicAnalysisViewable(_2303.DynamicAnalysisViewable):
    ...
    @enforce_parameter_types
    def excitation(
        self: "Self", value: "_5813.AbstractPeriodicExcitationDetail"
    ) -> None:
    ...
    @enforce_parameter_types
    def harmonic_analysis_with_varying_stiffness_step(
        self: "Self", value: "_5904.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase"
    ) -> None:
    ...
    @enforce_parameter_types
    def sound_response_type(self: "Self", value: "_4742.DynamicsResponseType") -> None:
    ...
    @enforce_parameter_types
    def uncoupled_mesh(self: "Self", value: "_2846.GearMeshSystemDeflection") -> None:
    ...
    @property
    def dynamic_analysis_draw_style(self: "Self") -> "_6472.DynamicAnalysisDrawStyle":
