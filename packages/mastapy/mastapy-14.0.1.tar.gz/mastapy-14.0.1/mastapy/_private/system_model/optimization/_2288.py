...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization import _2282, _2285, _2287
...
class _Cast_OptimizationStep:
    ...
    def conical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2282.ConicalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2282

        return self.__parent__._cast(_2282.ConicalGearOptimizationStep)

    @property
    def cylindrical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2285.CylindricalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2285

        return self.__parent__._cast(_2285.CylindricalGearOptimizationStep)
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self: "Self") -> "_2287.MicroGeometryOptimisationTarget":
    ...
    def optimisation_target(
        self: "Self", value: "_2287.MicroGeometryOptimisationTarget"
    ) -> None:
