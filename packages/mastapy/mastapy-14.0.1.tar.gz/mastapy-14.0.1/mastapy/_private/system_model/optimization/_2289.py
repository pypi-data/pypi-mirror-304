...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization import _2281, _2284, _2288
...
TStep = TypeVar("TStep", bound="_2288.OptimizationStep")
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OptimizationStrategy(_2290.OptimizationStrategyBase, Generic[TStep]):
    """OptimizationStrategy
