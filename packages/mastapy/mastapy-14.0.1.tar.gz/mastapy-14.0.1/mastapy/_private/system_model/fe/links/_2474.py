...
from mastapy._private.system_model.fe import _2418, _2441, _2454, _2458
...
class _Cast_FELink:
    ...
    @property
    def single_node_fe_link(self: "CastSelf") -> "_2488.SingleNodeFELink":
        from mastapy._private.system_model.fe.links import _2488

        return self.__parent__._cast(_2488.SingleNodeFELink)
...
class FELink(_0.APIBase):
    ...
    @enforce_parameter_types
    def bearing_node_link_option(
        self: "Self", value: "_2418.BearingNodeOption"
    ) -> None:
    ...
    @enforce_parameter_types
    def link_node_source(self: "Self", value: "_2454.LinkNodeSource") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def node_selection_depth(
        self: "Self",
        value: "Union[_2458.NodeSelectionDepthOption, Tuple[_2458.NodeSelectionDepthOption, bool]]",
    ) -> None:
    ...
    def alignment_in_component_coordinate_system(
        self: "Self",
    ) -> "_2453.LinkComponentAxialPositionErrorReporter":
    ...
    @property
    def component(self: "Self") -> "_2522.MountableComponent":
    ...
    @property
    def socket(self: "Self") -> "_2351.Socket":
    ...
    def nodes_grouped_by_angle(
        self: "Self",
    ) -> "OrderedDict[float, List[_2441.FESubstructureNode]]":
    ...
    @enforce_parameter_types
    def add_or_replace_node(self: "Self", node: "_2441.FESubstructureNode") -> None:
