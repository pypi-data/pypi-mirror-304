...
class _Cast_DegreeOfFreedomBoundaryConditionAngular:
    ...
    def degree_of_freedom_boundary_condition(
        self: "CastSelf",
    ) -> "_2426.DegreeOfFreedomBoundaryCondition":
        return self.__parent__._cast(_2426.DegreeOfFreedomBoundaryCondition)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DegreeOfFreedomBoundaryConditionAngular(_2426.DegreeOfFreedomBoundaryCondition):
    """DegreeOfFreedomBoundaryConditionAngular
