...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2415, _2422, _2423, _2432, _2455
...
class _Cast_FESubstructureWithSelectionComponents:
    ...
    def fe_substructure_with_selection(
        self: "CastSelf",
    ) -> "_2446.FESubstructureWithSelection":
        return self.__parent__._cast(_2446.FESubstructureWithSelection)

    @property
    def base_fe_with_selection(self: "CastSelf") -> "_2415.BaseFEWithSelection":
        from mastapy._private.system_model.fe import _2415

        return self.__parent__._cast(_2415.BaseFEWithSelection)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FESubstructureWithSelectionComponents(_2446.FESubstructureWithSelection):
    """FESubstructureWithSelectionComponents
    ...
    def beam_element_properties(
        self: "Self",
    ) -> "List[_2432.ElementPropertiesWithSelection[_222.ElementPropertiesBeam]]":
    ...
    @property
    def component_links(self: "Self") -> "List[_2476.FELinkWithSelection]":
    ...
    @property
    def contact_pairs(self: "Self") -> "List[_2422.ContactPairWithSelection]":
    ...
    @property
    def coordinate_systems(self: "Self") -> "List[_2423.CoordinateSystemWithSelection]":
    ...
    def interface_element_properties(
        self: "Self",
    ) -> "List[_2432.ElementPropertiesWithSelection[_223.ElementPropertiesInterface]]":
    ...
    @property
    def links_for_electric_machine(self: "Self") -> "List[_2476.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    @property
    def links_for_selected_component(self: "Self") -> "List[_2476.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    def mass_element_properties(
        self: "Self",
    ) -> "List[_2432.ElementPropertiesWithSelection[_224.ElementPropertiesMass]]":
    ...
    @property
    def materials(self: "Self") -> "List[_2455.MaterialPropertiesWithSelection]":
    ...
    def other_element_properties(
        self: "Self",
    ) -> "List[_2432.ElementPropertiesWithSelection[_221.ElementPropertiesBase]]":
    ...
    def rigid_element_properties(
        self: "Self",
    ) -> "List[_2432.ElementPropertiesWithSelection[_225.ElementPropertiesRigid]]":
    ...
    def shell_element_properties(
        self: "Self",
    ) -> "List[_2432.ElementPropertiesWithSelection[_226.ElementPropertiesShell]]":
    ...
    def solid_element_properties(
        self: "Self",
    ) -> "List[_2432.ElementPropertiesWithSelection[_227.ElementPropertiesSolid]]":
    ...
    def spring_dashpot_element_properties(
        self: "Self",
    ) -> "List[_2432.ElementPropertiesWithSelection[_228.ElementPropertiesSpringDashpot]]":
