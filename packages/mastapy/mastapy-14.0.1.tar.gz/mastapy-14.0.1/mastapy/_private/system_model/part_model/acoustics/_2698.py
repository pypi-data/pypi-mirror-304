...
class MicrophoneArrayDesign(_0.APIBase):
    ...
    def spherical_envelope_centre(
        self: "Self",
    ) -> "_2704.SphericalEnvelopeCentreDefinition":
    ...
    @enforce_parameter_types
    def spherical_envelope_centre(
        self: "Self", value: "_2704.SphericalEnvelopeCentreDefinition"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Acoustics.SphericalEnvelopeCentreDefinition",
    ...
    @property
    def spherical_envelope_type(self: "Self") -> "_2705.SphericalEnvelopeType":
    ...
    def spherical_envelope_type(
        self: "Self", value: "_2705.SphericalEnvelopeType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def selected_part(self: "Self") -> "List[_2699.PartSelectionForAcousticEnvelope]":
