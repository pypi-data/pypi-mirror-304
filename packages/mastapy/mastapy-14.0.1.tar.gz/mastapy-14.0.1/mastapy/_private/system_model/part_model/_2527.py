...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2500, _2517, _2526
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetCarrier(_2522.MountableComponent):
    """PlanetCarrier
    ...
    @property
    def load_sharing_settings(self: "Self") -> "_2517.LoadSharingSettings":
    ...
    @property
    def planetary_sockets(self: "Self") -> "List[_2343.PlanetarySocket]":
