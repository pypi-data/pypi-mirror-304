...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2492, _2500, _2517, _2526
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CycloidalDisc(_2491.AbstractShaft):
    """CycloidalDisc
    ...
    def planetary_bearing_sockets(
        self: "Self",
    ) -> "List[_2394.CycloidalDiscPlanetaryBearingSocket]":
