...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2545, _2548, _2551
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ParallelPartGroupSelection(_2549.ParallelPartGroup):
    """ParallelPartGroupSelection
    ...
    @property
    def design_measurements(self: "Self") -> "List[_2548.DesignMeasurements]":
