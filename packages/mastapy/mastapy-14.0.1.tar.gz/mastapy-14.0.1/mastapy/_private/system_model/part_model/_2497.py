...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2514, _2525
...
class _Cast_BearingRaceMountingOptions:
    ...
    def inner_bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2514.InnerBearingRaceMountingOptions":
        from mastapy._private.system_model.part_model import _2514

        return self.__parent__._cast(_2514.InnerBearingRaceMountingOptions)

    @property
    def outer_bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2525.OuterBearingRaceMountingOptions":
        from mastapy._private.system_model.part_model import _2525

        return self.__parent__._cast(_2525.OuterBearingRaceMountingOptions)
