...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2583, _2591, _2593
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSet(_2573.AGMAGleasonConicalGearSet):
    """HypoidGearSet
    ...
    @property
    def hypoid_gears(self: "Self") -> "List[_2593.HypoidGear]":
    ...
    @property
    def hypoid_meshes(self: "Self") -> "List[_2370.HypoidGearMesh]":
