...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2584, _2601
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSet(_2591.GearSet):
    """CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self: "Self") -> "_2622.SuperchargerRotorSet":
    ...
    @property
    def cylindrical_gears(self: "Self") -> "List[_2584.CylindricalGear]":
    ...
    @property
    def cylindrical_meshes(self: "Self") -> "List[_2364.CylindricalGearMesh]":
    ...
    def add_gear(self: "Self") -> "_2584.CylindricalGear":
