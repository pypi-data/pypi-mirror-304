...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2694, _2695, _2703
...
T = TypeVar("T", bound="_2703.ResultSurfaceOptions")
...
class _Cast_MeshedResultSurface:
    ...
    @property
    def meshed_result_surface_base(self: "CastSelf") -> "_2697.MeshedResultSurfaceBase":
        return self.__parent__._cast(_2697.MeshedResultSurfaceBase)

    @property
    def meshed_result_plane(self: "CastSelf") -> "_2694.MeshedResultPlane":
        from mastapy._private.system_model.part_model.acoustics import _2694

        return self.__parent__._cast(_2694.MeshedResultPlane)

    @property
    def meshed_result_sphere(self: "CastSelf") -> "_2695.MeshedResultSphere":
        from mastapy._private.system_model.part_model.acoustics import _2695

        return self.__parent__._cast(_2695.MeshedResultSphere)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MeshedResultSurface(_2697.MeshedResultSurfaceBase, Generic[T]):
    """MeshedResultSurface
