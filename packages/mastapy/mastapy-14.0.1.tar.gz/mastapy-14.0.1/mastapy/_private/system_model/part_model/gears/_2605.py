...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearSet(_2579.BevelGearSet):
    """StraightBevelDiffGearSet
    ...
    @property
    def straight_bevel_diff_gears(self: "Self") -> "List[_2604.StraightBevelDiffGear]":
    ...
    def straight_bevel_diff_meshes(
        self: "Self",
    ) -> "List[_2380.StraightBevelDiffGearMesh]":
