...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Synchroniser(_2535.SpecialisedAssembly):
    """Synchroniser
    ...
    @property
    def clutch_connection_left(self: "Self") -> "_2397.ClutchConnection":
    ...
    @property
    def clutch_connection_right(self: "Self") -> "_2397.ClutchConnection":
        """mastapy.system_model.connections_and_sockets.couplings.ClutchConnection
    ...
    @property
    def hub_and_sleeve(self: "Self") -> "_2671.SynchroniserSleeve":
    ...
    @property
    def left_cone(self: "Self") -> "_2669.SynchroniserHalf":
    ...
    @property
    def right_cone(self: "Self") -> "_2669.SynchroniserHalf":
        """mastapy.system_model.part_model.couplings.SynchroniserHalf
