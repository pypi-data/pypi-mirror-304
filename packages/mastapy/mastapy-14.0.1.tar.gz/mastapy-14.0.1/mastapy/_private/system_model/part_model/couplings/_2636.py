...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2637, _2647, _2652
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BeltDrive(_2535.SpecialisedAssembly):
    """BeltDrive
    ...
    @property
    def type_of_belt(self: "Self") -> "_2637.BeltDriveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.couplings._2637", "BeltDriveType"
        )(value)

    @type_of_belt.setter
    @enforce_parameter_types
    def type_of_belt(self: "Self", value: "_2637.BeltDriveType") -> None:
    ...
    @property
    def belt_connections(self: "Self") -> "List[_2323.BeltConnection]":
    ...
    @property
    def pulleys(self: "Self") -> "List[_2652.Pulley]":
