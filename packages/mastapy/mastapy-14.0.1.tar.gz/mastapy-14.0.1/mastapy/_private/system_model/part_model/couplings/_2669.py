...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2645, _2668
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserHalf(_2670.SynchroniserPart):
    """SynchroniserHalf
    ...
    @property
    def cones(self: "Self") -> "List[_2668.SynchroniserCone]":
