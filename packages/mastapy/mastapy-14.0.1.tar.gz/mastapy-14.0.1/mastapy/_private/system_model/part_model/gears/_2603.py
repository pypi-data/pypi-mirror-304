...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSet(_2579.BevelGearSet):
    """SpiralBevelGearSet
    ...
    @property
    def spiral_bevel_gears(self: "Self") -> "List[_2602.SpiralBevelGear]":
    ...
    @property
    def spiral_bevel_meshes(self: "Self") -> "List[_2378.SpiralBevelGearMesh]":
