...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2694, _2695, _2696
...
class _Cast_MeshedResultSurfaceBase:
    ...
    @property
    def meshed_result_surface(self: "CastSelf") -> "_2696.MeshedResultSurface":
        from mastapy._private.system_model.part_model.acoustics import _2696

        return self.__parent__._cast(_2696.MeshedResultSurface)
