...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoad(_2538.VirtualComponent):
    """PowerLoad
    ...
    def electric_machine_search_region_specification_method(
        self: "Self",
    ) -> "_2505.ElectricMachineSearchRegionSpecificationMethod":
    ...
    @enforce_parameter_types
    def electric_machine_search_region_specification_method(
        self: "Self", value: "_2505.ElectricMachineSearchRegionSpecificationMethod"
    ) -> None:
    ...
    @enforce_parameter_types
    def power_load_type(self: "Self", value: "_2274.PowerLoadType") -> None:
    ...
    @property
    def single_blade_details(self: "Self") -> "_2540.WindTurbineSingleBladeDetails":
