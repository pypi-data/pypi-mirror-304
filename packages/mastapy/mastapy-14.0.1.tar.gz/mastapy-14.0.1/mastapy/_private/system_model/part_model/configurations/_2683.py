...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2569, _2570
...
class _Cast_PartDetailSelection:
    ...
    def active_gear_set_design_selection(
        self: "CastSelf",
    ) -> "_2570.ActiveGearSetDesignSelection":
        from mastapy._private.system_model.part_model.gears import _2570

        return self.__parent__._cast(_2570.ActiveGearSetDesignSelection)

    @property
    def active_fe_substructure_selection(
        self: "CastSelf",
    ) -> "_2676.ActiveFESubstructureSelection":
        from mastapy._private.system_model.part_model.configurations import _2676

        return self.__parent__._cast(_2676.ActiveFESubstructureSelection)

    @property
    def active_shaft_design_selection(
        self: "CastSelf",
    ) -> "_2678.ActiveShaftDesignSelection":
        from mastapy._private.system_model.part_model.configurations import _2678

        return self.__parent__._cast(_2678.ActiveShaftDesignSelection)

    @property
    def bearing_detail_selection(self: "CastSelf") -> "_2681.BearingDetailSelection":
        from mastapy._private.system_model.part_model.configurations import _2681

        return self.__parent__._cast(_2681.BearingDetailSelection)
