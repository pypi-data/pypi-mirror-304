...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSet(_2579.BevelGearSet):
    """ZerolBevelGearSet
    ...
    @property
    def zerol_bevel_gears(self: "Self") -> "List[_2612.ZerolBevelGear]":
    ...
    @property
    def zerol_bevel_meshes(self: "Self") -> "List[_2386.ZerolBevelGearMesh]":
