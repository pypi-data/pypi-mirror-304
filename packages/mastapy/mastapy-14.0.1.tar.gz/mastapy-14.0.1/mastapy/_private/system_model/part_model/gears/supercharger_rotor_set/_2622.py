...
class SuperchargerRotorSet(_1882.NamedDatabaseItem):
    ...
    @property
    def y_variable_for_imported_data(self: "Self") -> "_2624.YVariableForImportedData":
    ...
    def y_variable_for_imported_data(
        self: "Self", value: "_2624.YVariableForImportedData"
    ) -> None:
    ...
    @property
    def boost_pressure(self: "Self") -> "_2614.BoostPressureInputOptions":
    ...
    @property
    def file(self: "Self") -> "_2617.RotorSetDataInputFileOptions":
    ...
    @property
    def input_power(self: "Self") -> "_2615.InputPowerInputOptions":
    ...
    @property
    def pressure_ratio(self: "Self") -> "_2616.PressureRatioInputOptions":
    ...
    @property
    def rotor_speed(self: "Self") -> "_2619.RotorSpeedInputOptions":
    ...
    @property
    def measured_points(self: "Self") -> "List[_2618.RotorSetMeasuredPoint]":
