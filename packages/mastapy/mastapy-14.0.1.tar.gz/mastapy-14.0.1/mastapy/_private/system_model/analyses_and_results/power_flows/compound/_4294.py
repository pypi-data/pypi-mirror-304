...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelGearSetCompoundPowerFlow(_4282.AGMAGleasonConicalGearSetCompoundPowerFlow):
    """BevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4157.BevelGearSetPowerFlow]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4157.BevelGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BevelGearSetPowerFlow]
