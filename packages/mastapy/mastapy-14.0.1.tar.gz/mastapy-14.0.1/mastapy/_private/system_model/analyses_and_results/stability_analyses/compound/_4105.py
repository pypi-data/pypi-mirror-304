...
class SpiralBevelGearSetCompoundStabilityAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3970.SpiralBevelGearSetStabilityAnalysis]":
    ...
    def spiral_bevel_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4103.SpiralBevelGearCompoundStabilityAnalysis]":
    ...
    def spiral_bevel_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4104.SpiralBevelGearMeshCompoundStabilityAnalysis]":
