...
class _Cast_CylindricalGearManufactureError:
    ...
    @property
    def gear_manufacture_error(self: "CastSelf") -> "_7042.GearManufactureError":
        return self.__parent__._cast(_7042.GearManufactureError)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearManufactureError(_7042.GearManufactureError):
    """CylindricalGearManufactureError
