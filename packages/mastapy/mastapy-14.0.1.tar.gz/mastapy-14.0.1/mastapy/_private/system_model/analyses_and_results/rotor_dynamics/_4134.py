...
class _Cast_ShaftComplexShape:
    ...
    @property
    def shaft_forced_complex_shape(self: "CastSelf") -> "_4135.ShaftForcedComplexShape":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4135,
        )

        return self.__parent__._cast(_4135.ShaftForcedComplexShape)

    @property
    def shaft_modal_complex_shape(self: "CastSelf") -> "_4136.ShaftModalComplexShape":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4136,
        )

        return self.__parent__._cast(_4136.ShaftModalComplexShape)
