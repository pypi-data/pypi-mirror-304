...
class _Cast_CompoundAnalysis:
    ...
    def compound_advanced_system_deflection_analysis(
        self: "CastSelf",
    ) -> "_2745.CompoundAdvancedSystemDeflectionAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2745

        return self.__parent__._cast(_2745.CompoundAdvancedSystemDeflectionAnalysis)

    @property
    def compound_advanced_system_deflection_sub_analysis(
        self: "CastSelf",
    ) -> "_2746.CompoundAdvancedSystemDeflectionSubAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2746

        return self.__parent__._cast(_2746.CompoundAdvancedSystemDeflectionSubAnalysis)

    @property
    def compound_advanced_time_stepping_analysis_for_modulation(
        self: "CastSelf",
    ) -> "_2747.CompoundAdvancedTimeSteppingAnalysisForModulation":
    ...
    def compound_critical_speed_analysis(
        self: "CastSelf",
    ) -> "_2748.CompoundCriticalSpeedAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2748

        return self.__parent__._cast(_2748.CompoundCriticalSpeedAnalysis)

    @property
    def compound_dynamic_analysis(self: "CastSelf") -> "_2749.CompoundDynamicAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2749

        return self.__parent__._cast(_2749.CompoundDynamicAnalysis)

    @property
    def compound_dynamic_model_at_a_stiffness_analysis(
        self: "CastSelf",
    ) -> "_2750.CompoundDynamicModelAtAStiffnessAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2750

        return self.__parent__._cast(_2750.CompoundDynamicModelAtAStiffnessAnalysis)

    @property
    def compound_dynamic_model_for_harmonic_analysis(
        self: "CastSelf",
    ) -> "_2751.CompoundDynamicModelForHarmonicAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2751

        return self.__parent__._cast(_2751.CompoundDynamicModelForHarmonicAnalysis)

    @property
    def compound_dynamic_model_for_modal_analysis(
        self: "CastSelf",
    ) -> "_2752.CompoundDynamicModelForModalAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2752

        return self.__parent__._cast(_2752.CompoundDynamicModelForModalAnalysis)

    @property
    def compound_dynamic_model_for_stability_analysis(
        self: "CastSelf",
    ) -> "_2753.CompoundDynamicModelForStabilityAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2753

        return self.__parent__._cast(_2753.CompoundDynamicModelForStabilityAnalysis)

    @property
    def compound_dynamic_model_for_steady_state_synchronous_response_analysis(
        self: "CastSelf",
    ) -> "_2754.CompoundDynamicModelForSteadyStateSynchronousResponseAnalysis":
    ...
    def compound_harmonic_analysis(
        self: "CastSelf",
    ) -> "_2755.CompoundHarmonicAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2755

        return self.__parent__._cast(_2755.CompoundHarmonicAnalysis)

    @property
    def compound_harmonic_analysis_for_advanced_time_stepping_analysis_for_modulation(
        self: "CastSelf",
    ) -> "_2756.CompoundHarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation":
    ...
    def compound_harmonic_analysis_of_single_excitation_analysis(
        self: "CastSelf",
    ) -> "_2757.CompoundHarmonicAnalysisOfSingleExcitationAnalysis":
    ...
    @property
    def compound_modal_analysis(self: "CastSelf") -> "_2758.CompoundModalAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2758

        return self.__parent__._cast(_2758.CompoundModalAnalysis)

    @property
    def compound_modal_analysis_at_a_speed(
        self: "CastSelf",
    ) -> "_2759.CompoundModalAnalysisAtASpeed":
        from mastapy._private.system_model.analyses_and_results import _2759

        return self.__parent__._cast(_2759.CompoundModalAnalysisAtASpeed)

    @property
    def compound_modal_analysis_at_a_stiffness(
        self: "CastSelf",
    ) -> "_2760.CompoundModalAnalysisAtAStiffness":
        from mastapy._private.system_model.analyses_and_results import _2760

        return self.__parent__._cast(_2760.CompoundModalAnalysisAtAStiffness)

    @property
    def compound_modal_analysis_for_harmonic_analysis(
        self: "CastSelf",
    ) -> "_2761.CompoundModalAnalysisForHarmonicAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2761

        return self.__parent__._cast(_2761.CompoundModalAnalysisForHarmonicAnalysis)

    @property
    def compound_multibody_dynamics_analysis(
        self: "CastSelf",
    ) -> "_2762.CompoundMultibodyDynamicsAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2762

        return self.__parent__._cast(_2762.CompoundMultibodyDynamicsAnalysis)

    @property
    def compound_power_flow_analysis(
        self: "CastSelf",
    ) -> "_2763.CompoundPowerFlowAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2763

        return self.__parent__._cast(_2763.CompoundPowerFlowAnalysis)

    @property
    def compound_stability_analysis(
        self: "CastSelf",
    ) -> "_2764.CompoundStabilityAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2764

        return self.__parent__._cast(_2764.CompoundStabilityAnalysis)

    @property
    def compound_steady_state_synchronous_response_analysis(
        self: "CastSelf",
    ) -> "_2765.CompoundSteadyStateSynchronousResponseAnalysis":
    ...
    def compound_steady_state_synchronous_response_at_a_speed_analysis(
        self: "CastSelf",
    ) -> "_2766.CompoundSteadyStateSynchronousResponseAtASpeedAnalysis":
    ...
    def compound_steady_state_synchronous_response_on_a_shaft_analysis(
        self: "CastSelf",
    ) -> "_2767.CompoundSteadyStateSynchronousResponseOnAShaftAnalysis":
    ...
    def compound_system_deflection_analysis(
        self: "CastSelf",
    ) -> "_2768.CompoundSystemDeflectionAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2768

        return self.__parent__._cast(_2768.CompoundSystemDeflectionAnalysis)

    @property
    def compound_torsional_system_deflection_analysis(
        self: "CastSelf",
    ) -> "_2769.CompoundTorsionalSystemDeflectionAnalysis":
        from mastapy._private.system_model.analyses_and_results import _2769

        return self.__parent__._cast(_2769.CompoundTorsionalSystemDeflectionAnalysis)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CompoundAnalysis(_7725.MarshalByRefObjectPermanent):
    """CompoundAnalysis
    ...
    def perform_analysis_with_progress(
        self: "Self", progress: "_7731.TaskProgress"
    ) -> None:
        """Method does not return.
    ...
    ) -> "Iterable[_7715.DesignEntityCompoundAnalysis]":
