...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetHarmonicAnalysis(_5819.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """HypoidGearSetHarmonicAnalysis
    ...
    def agma_gleason_conical_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5905.HypoidGearHarmonicAnalysis]":
    ...
    def agma_gleason_conical_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5906.HypoidGearMeshHarmonicAnalysis]":
