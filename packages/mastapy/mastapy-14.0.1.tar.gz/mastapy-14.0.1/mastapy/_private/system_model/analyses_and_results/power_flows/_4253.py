...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearSetPowerFlow(_4157.BevelGearSetPowerFlow):
    """StraightBevelDiffGearSetPowerFlow
    ...
    def bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4252.StraightBevelDiffGearPowerFlow]":
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4251.StraightBevelDiffGearMeshPowerFlow]":
