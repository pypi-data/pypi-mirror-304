...
class TimeSeriesImporter(_0.APIBase):
    ...
    @enforce_parameter_types
    def destination_design_state_column(
        self: "Self", value: "_7144.DestinationDesignState"
    ) -> None:
    ...
    @property
    def import_type(self: "Self") -> "_7059.ImportType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7059",
            "ImportType",
        )(value)

    @import_type.setter
    @enforce_parameter_types
    def import_type(self: "Self", value: "_7059.ImportType") -> None:
    ...
    @property
    def design_state_options(self: "Self") -> "_7143.DesignStateOptions":
    ...
    @property
    def gear_ratio_options(self: "Self") -> "_7146.GearRatioInputOptions":
    ...
    @property
    def load_case_name_inputs(self: "Self") -> "_7147.LoadCaseNameOptions":
    ...
    @property
    def time_step_input(self: "Self") -> "_7155.TimeStepInputOptions":
    ...
    def boost_pressure_inputs(
        self: "Self",
    ) -> "List[_7142.BoostPressureLoadCaseInputOptions]":
    ...
    @property
    def file_inputs(self: "Self") -> "List[_7149.MultiTimeSeriesDataInputFileOptions]":
    ...
    @property
    def force_inputs(self: "Self") -> "List[_7145.ForceInputOptions]":
    ...
    @property
    def moment_inputs(self: "Self") -> "List[_7148.MomentInputOptions]":
    ...
    @property
    def speed_inputs(self: "Self") -> "List[_7153.SpeedInputOptions]":
    ...
    @property
    def torque_inputs(self: "Self") -> "List[_7156.TorqueInputOptions]":
