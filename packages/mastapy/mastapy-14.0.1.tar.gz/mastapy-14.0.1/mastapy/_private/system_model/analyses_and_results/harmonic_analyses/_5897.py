...
class _Cast_HarmonicAnalysisExportOptions:
    ...
    def harmonic_analysis_fe_export_options(
        self: "CastSelf",
    ) -> "_5898.HarmonicAnalysisFEExportOptions":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5898,
        )

        return self.__parent__._cast(_5898.HarmonicAnalysisFEExportOptions)

    @property
    def harmonic_analysis_root_assembly_export_options(
        self: "CastSelf",
    ) -> "_5901.HarmonicAnalysisRootAssemblyExportOptions":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5901,
        )

        return self.__parent__._cast(_5901.HarmonicAnalysisRootAssemblyExportOptions)

    @property
    def harmonic_analysis_shaft_export_options(
        self: "CastSelf",
    ) -> "_5902.HarmonicAnalysisShaftExportOptions":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5902,
        )

        return self.__parent__._cast(_5902.HarmonicAnalysisShaftExportOptions)
...
class HarmonicAnalysisExportOptions(_0.APIBase, Generic[TPartAnalysis, TPart]):
    ...
    @export_type.setter
    @enforce_parameter_types
    def export_type(self: "Self", value: "_5879.ExportOutputType") -> None:
    ...
    @enforce_parameter_types
    def type_of_result_to_export(
        self: "Self", value: "_4742.DynamicsResponseType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def analysis_options(self: "Self") -> "_5900.HarmonicAnalysisOptions":
