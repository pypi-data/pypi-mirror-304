...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetCompoundStabilityAnalysis(_4062.GearSetCompoundStabilityAnalysis):
    """ConceptGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3896.ConceptGearSetStabilityAnalysis]":
    ...
    def concept_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4031.ConceptGearCompoundStabilityAnalysis]":
    ...
    def concept_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4032.ConceptGearMeshCompoundStabilityAnalysis]":
