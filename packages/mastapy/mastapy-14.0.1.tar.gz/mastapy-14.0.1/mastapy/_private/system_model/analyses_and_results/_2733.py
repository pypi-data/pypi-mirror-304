...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SystemDeflectionAnalysis(_2707.SingleAnalysis):
    """SystemDeflectionAnalysis
