...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self: "Self") -> "_5510.AnalysisTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5510",
            "AnalysisTypes",
        )(value)

    @analysis_type.setter
    @enforce_parameter_types
    def analysis_type(self: "Self", value: "_5510.AnalysisTypes") -> None:
    ...
    @enforce_parameter_types
    def bearing_stiffness_model(
        self: "Self", value: "_5514.BearingStiffnessModel"
    ) -> None:
    ...
    def method_to_define_period(
        self: "Self",
    ) -> "_5573.InertiaAdjustedLoadCasePeriodMethod":
    ...
    @enforce_parameter_types
    def method_to_define_period(
        self: "Self", value: "_5573.InertiaAdjustedLoadCasePeriodMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCasePeriodMethod",
    ...
    def static_load_cases_to_create(
        self: "Self",
    ) -> "_5574.InertiaAdjustedLoadCaseResultsToCreate":
    ...
    @enforce_parameter_types
    def static_load_cases_to_create(
        self: "Self", value: "_5574.InertiaAdjustedLoadCaseResultsToCreate"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCaseResultsToCreate",
    ...
    def external_interface_options(
        self: "Self",
    ) -> "_5660.DynamicExternalInterfaceOptions":
    ...
    @property
    def run_up_analysis_options(self: "Self") -> "_5590.MBDRunUpAnalysisOptions":
    ...
    @property
    def spline_damping_options(self: "Self") -> "_5623.SplineDampingOptions":
