...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6538
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserHalfDynamicAnalysis(_6538.SynchroniserPartDynamicAnalysis):
    """SynchroniserHalfDynamicAnalysis
