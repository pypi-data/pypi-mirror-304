...
class DutyCycleResultsForAllComponents(_0.APIBase):
    ...
    def results_for_all_gear_sets(
        self: "Self",
    ) -> "_4462.DutyCycleResultsForAllGearSets":
    ...
    def results_for_root_assembly(
        self: "Self",
    ) -> "_4463.DutyCycleResultsForRootAssembly":
    ...
    def results_for_all_bearings(
        self: "Self",
    ) -> "List[_4464.DutyCycleResultsForSingleBearing]":
    ...
    def results_for_all_shafts(
        self: "Self",
    ) -> "List[_4465.DutyCycleResultsForSingleShaft]":
