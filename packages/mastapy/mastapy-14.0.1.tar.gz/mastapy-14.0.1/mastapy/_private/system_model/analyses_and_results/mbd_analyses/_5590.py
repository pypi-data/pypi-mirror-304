...
class _Cast_MBDRunUpAnalysisOptions:
    ...
    @property
    def abstract_analysis_options(self: "CastSelf") -> "_7708.AbstractAnalysisOptions":
        return self.__parent__._cast(_7708.AbstractAnalysisOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MBDRunUpAnalysisOptions(_7708.AbstractAnalysisOptions[_6956.TimeSeriesLoadCase]):
    """MBDRunUpAnalysisOptions
    ...
    def input_velocity_processing_type(
        self: "Self",
    ) -> "_5576.InputVelocityForRunUpProcessingType":
    ...
    @enforce_parameter_types
    def input_velocity_processing_type(
        self: "Self", value: "_5576.InputVelocityForRunUpProcessingType"
    ) -> None:
    ...
    @property
    def run_up_driving_mode(self: "Self") -> "_5613.RunUpDrivingMode":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5613",
            "RunUpDrivingMode",
        )(value)

    @run_up_driving_mode.setter
    @enforce_parameter_types
    def run_up_driving_mode(self: "Self", value: "_5613.RunUpDrivingMode") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.RunUpDrivingMode",
        )
    ...
    def shape_of_initial_acceleration_period(
        self: "Self",
    ) -> "_5618.ShapeOfInitialAccelerationPeriodForRunUp":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5618",
    ...
    @enforce_parameter_types
    def shape_of_initial_acceleration_period(
        self: "Self", value: "_5618.ShapeOfInitialAccelerationPeriodForRunUp"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ShapeOfInitialAccelerationPeriodForRunUp",
