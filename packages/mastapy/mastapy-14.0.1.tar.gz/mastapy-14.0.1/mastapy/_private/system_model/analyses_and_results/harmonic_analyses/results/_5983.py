...
class _Cast_ExcitationSourceSelectionGroup:
    ...
    def excitation_source_selection_base(
        self: "CastSelf",
    ) -> "_5982.ExcitationSourceSelectionBase":
        return self.__parent__._cast(_5982.ExcitationSourceSelectionBase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ExcitationSourceSelectionGroup(_5982.ExcitationSourceSelectionBase):
    """ExcitationSourceSelectionGroup
    ...
    @property
    def sub_items(self: "Self") -> "List[_5982.ExcitationSourceSelectionBase]":
