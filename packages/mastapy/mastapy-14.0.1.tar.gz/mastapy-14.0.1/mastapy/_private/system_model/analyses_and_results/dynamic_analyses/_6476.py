...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetDynamicAnalysis(_6481.GearSetDynamicAnalysis):
    """FaceGearSetDynamicAnalysis
    ...
    @property
    def gears_dynamic_analysis(self: "Self") -> "List[_6474.FaceGearDynamicAnalysis]":
    ...
    def meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6475.FaceGearMeshDynamicAnalysis]":
