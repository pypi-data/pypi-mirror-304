...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserHalfSystemDeflection(_2911.SynchroniserPartSystemDeflection):
    """SynchroniserHalfSystemDeflection
    ...
    @property
    def clutch_connection(self: "Self") -> "_2798.ClutchConnectionSystemDeflection":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4259.SynchroniserHalfPowerFlow":
