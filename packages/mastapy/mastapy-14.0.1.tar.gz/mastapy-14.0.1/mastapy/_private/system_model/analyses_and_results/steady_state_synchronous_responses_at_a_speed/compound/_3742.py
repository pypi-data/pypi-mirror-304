...
class _Cast_AssemblyCompoundSteadyStateSynchronousResponseAtASpeed:
    ...
    def root_assembly_compound_steady_state_synchronous_response_at_a_speed(
        self: "CastSelf",
    ) -> "_3831.RootAssemblyCompoundSteadyStateSynchronousResponseAtASpeed":
        from mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import (
            _3831,
        )
...
class AssemblyCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3610.AssemblySteadyStateSynchronousResponseAtASpeed]":
    ...
    def bearings(
        self: "Self",
    ) -> "List[_3743.BearingCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def belt_drives(
        self: "Self",
    ) -> "List[_3745.BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_3748.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_3755.BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def bolts(
        self: "Self",
    ) -> "List[_3754.BoltCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cv_ts(
        self: "Self",
    ) -> "List[_3776.CVTCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def clutches(
        self: "Self",
    ) -> "List[_3756.ClutchCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_3761.ConceptCouplingCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_3766.ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_3778.CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_3780.CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_3784.CylindricalGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def fe_parts(
        self: "Self",
    ) -> "List[_3791.FEPartCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_3790.FaceGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def flexible_pin_assemblies(
        ...
        "List[_3792.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3799.HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3806.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3809.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def mass_discs(
        self: "Self",
    ) -> "List[_3810.MassDiscCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def measurement_components(
        ...
        "List[_3811.MeasurementComponentCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def microphones(
        self: "Self",
    ) -> "List[_3813.MicrophoneCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def oil_seals(
        self: "Self",
    ) -> "List[_3815.OilSealCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_3817.PartToPartShearCouplingCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_3822.PlanetCarrierCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_3823.PointLoadCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_3824.PowerLoadCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def ring_pins(
        self: "Self",
    ) -> "List[_3826.RingPinsCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def rolling_ring_assemblies(
        ...
        "List[_3828.RollingRingAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_3833.ShaftHubConnectionCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def shafts(
        self: "Self",
    ) -> "List[_3832.ShaftCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3838.SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_3839.SpringDamperCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_3844.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_gear_sets(
        ...
        "List[_3847.StraightBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_3850.SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_3854.TorqueConverterCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_3858.UnbalancedMassCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_3862.WormGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3865.ZerolBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
