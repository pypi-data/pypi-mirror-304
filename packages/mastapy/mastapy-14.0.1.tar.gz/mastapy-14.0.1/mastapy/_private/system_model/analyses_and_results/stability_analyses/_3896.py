...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetStabilityAnalysis(_3927.GearSetStabilityAnalysis):
    """ConceptGearSetStabilityAnalysis
    ...
    def gears_stability_analysis(
        self: "Self",
    ) -> "List[_3897.ConceptGearStabilityAnalysis]":
    ...
    def meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3895.ConceptGearMeshStabilityAnalysis]":
