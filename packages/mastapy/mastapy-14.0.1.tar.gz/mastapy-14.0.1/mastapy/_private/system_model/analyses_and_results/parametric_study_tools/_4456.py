...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetParametricStudyTool(_4474.GearSetParametricStudyTool):
    """CylindricalGearSetParametricStudyTool
    ...
    def assembly_system_deflection_results(
        self: "Self",
    ) -> "List[_2829.CylindricalGearSetSystemDeflection]":
    ...
    def gears_parametric_study_tool(
        self: "Self",
    ) -> "List[_4455.CylindricalGearParametricStudyTool]":
    ...
    def meshes_parametric_study_tool(
        self: "Self",
    ) -> "List[_4454.CylindricalGearMeshParametricStudyTool]":
