...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCompoundSystemDeflection(_2965.ComponentCompoundSystemDeflection):
    """DatumCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2838.DatumSystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2838.DatumSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.DatumSystemDeflection]
