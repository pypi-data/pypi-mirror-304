...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSetCompoundPowerFlow(_4294.BevelGearSetCompoundPowerFlow):
    """StraightBevelGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4256.StraightBevelGearSetPowerFlow]":
    ...
    def straight_bevel_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4386.StraightBevelGearCompoundPowerFlow]":
    ...
    def straight_bevel_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4387.StraightBevelGearMeshCompoundPowerFlow]":
