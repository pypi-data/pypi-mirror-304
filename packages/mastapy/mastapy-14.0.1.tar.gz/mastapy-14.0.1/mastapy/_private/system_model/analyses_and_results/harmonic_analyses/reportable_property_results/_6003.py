...
class _Cast_ResultsForMultipleOrdersForFESurface:
    ...
    def results_for_multiple_orders(
        self: "CastSelf",
    ) -> "_6002.ResultsForMultipleOrders":
        return self.__parent__._cast(_6002.ResultsForMultipleOrders)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ResultsForMultipleOrdersForFESurface(_6002.ResultsForMultipleOrders):
    """ResultsForMultipleOrdersForFESurface
