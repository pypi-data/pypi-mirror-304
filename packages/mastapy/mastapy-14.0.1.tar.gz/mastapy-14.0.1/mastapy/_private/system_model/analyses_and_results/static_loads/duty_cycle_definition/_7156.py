...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueInputOptions(_7151.PowerLoadInputOptions):
    """TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self: "Self") -> "_7157.TorqueValuesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads.duty_cycle_definition._7157",
    ...
    def conversion_to_load_case(
        self: "Self", value: "_7157.TorqueValuesObtainedFrom"
    ) -> None:
