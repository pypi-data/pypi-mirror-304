...
class LoadCase(_2737.Context):
    ...
    @property
    def bearing_element_orbit_model(self: "Self") -> "_5512.BearingElementOrbitModel":
    ...
    def bearing_element_orbit_model(
        self: "Self", value: "_5512.BearingElementOrbitModel"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.BearingElementOrbitModel",
    ...
    @property
    def additional_acceleration(self: "Self") -> "_6961.AdditionalAccelerationOptions":
    ...
    @property
    def input_power_load(self: "Self") -> "_7092.PowerLoadLoadCase":
    ...
    @property
    def output_power_load(self: "Self") -> "_7092.PowerLoadLoadCase":
        """mastapy.system_model.analyses_and_results.static_loads.PowerLoadLoadCase
    ...
    def parametric_study_tool_options(
        self: "Self",
    ) -> "_4502.ParametricStudyToolOptions":
    ...
    def transmission_efficiency_settings(
        self: "Self",
    ) -> "_7131.TransmissionEfficiencySettings":
    ...
    @property
    def power_loads(self: "Self") -> "List[_7092.PowerLoadLoadCase]":
    ...
    @enforce_parameter_types
    def inputs_for_cvt(self: "Self", design_entity: "_2647.CVT") -> "_7006.CVTLoadCase":
