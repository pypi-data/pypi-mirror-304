...
class BevelDifferentialGearSetCompoundModalAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4700.BevelDifferentialGearSetModalAnalysis]":
    ...
    def bevel_differential_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4856.BevelDifferentialGearCompoundModalAnalysis]":
    ...
    def bevel_differential_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4857.BevelDifferentialGearMeshCompoundModalAnalysis]":
