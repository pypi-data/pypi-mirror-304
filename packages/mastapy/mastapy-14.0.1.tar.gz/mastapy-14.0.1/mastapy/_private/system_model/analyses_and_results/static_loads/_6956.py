...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2707, _2726, _2737
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TimeSeriesLoadCase(_6954.LoadCase):
    """TimeSeriesLoadCase
    ...
    @property
    def multibody_dynamics_analysis(self: "Self") -> "_2726.MultibodyDynamicsAnalysis":
    ...
    @property
    def driva_analysis_options(self: "Self") -> "_5589.MBDAnalysisOptions":
    ...
    @property
    def time_series_load_case_group(self: "Self") -> "_5805.TimeSeriesLoadCaseGroup":
    ...
    def duplicate(
        self: "Self",
        new_load_case_group: "_5805.TimeSeriesLoadCaseGroup",
        name: "str" = "None",
    ) -> "TimeSeriesLoadCase":
