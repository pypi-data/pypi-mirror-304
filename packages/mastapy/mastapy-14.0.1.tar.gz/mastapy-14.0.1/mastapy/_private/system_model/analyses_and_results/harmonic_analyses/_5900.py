...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def response_cache_level(self: "Self") -> "_5935.ResponseCacheLevel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses._5935",
            "ResponseCacheLevel",
        )(value)

    @response_cache_level.setter
    @enforce_parameter_types
    def response_cache_level(self: "Self", value: "_5935.ResponseCacheLevel") -> None:
    ...
    @property
    def excitation_selection(self: "Self") -> "_5983.ExcitationSourceSelectionGroup":
    ...
    @property
    def modal_analysis_options(self: "Self") -> "_4774.ModalAnalysisOptions":
    ...
    @property
    def stiffness_options(self: "Self") -> "_5954.StiffnessOptionsForHarmonicAnalysis":
