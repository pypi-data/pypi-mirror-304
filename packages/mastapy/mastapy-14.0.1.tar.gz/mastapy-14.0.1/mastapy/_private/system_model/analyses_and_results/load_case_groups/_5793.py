...
class _Cast_AbstractLoadCaseGroup:
    ...
    def abstract_static_load_case_group(
        self: "CastSelf",
    ) -> "_5794.AbstractStaticLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5794,
        )

        return self.__parent__._cast(_5794.AbstractStaticLoadCaseGroup)
    ...
    def time_series_load_case_group(
        self: "CastSelf",
    ) -> "_5805.TimeSeriesLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5805,
        )

        return self.__parent__._cast(_5805.TimeSeriesLoadCaseGroup)
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    @property
    def load_case_root_assemblies(self: "Self") -> "List[_7101.RootAssemblyLoadCase]":
    ...
    def create_load_cases(
        self: "Self", number_of_load_cases: "int", token: "_7731.TaskProgress"
    ) -> "List[_6954.LoadCase]":
    ...
    @enforce_parameter_types
    def perform_pst_with_progress(self: "Self", progress: "_7731.TaskProgress") -> None:
        """Method does not return.
