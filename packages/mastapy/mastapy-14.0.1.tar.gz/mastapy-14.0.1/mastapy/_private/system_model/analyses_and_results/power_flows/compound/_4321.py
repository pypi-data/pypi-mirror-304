...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CycloidalDiscCompoundPowerFlow(_4277.AbstractShaftCompoundPowerFlow):
    """CycloidalDiscCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4185.CycloidalDiscPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4185.CycloidalDiscPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CycloidalDiscPowerFlow]
