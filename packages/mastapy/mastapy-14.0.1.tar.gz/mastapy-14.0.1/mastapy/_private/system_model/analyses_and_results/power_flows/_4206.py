...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetPowerFlow(_4145.AGMAGleasonConicalGearSetPowerFlow):
    """HypoidGearSetPowerFlow
    ...
    def agma_gleason_conical_gears_power_flow(
        self: "Self",
    ) -> "List[_4205.HypoidGearPowerFlow]":
    ...
    @property
    def hypoid_gears_power_flow(self: "Self") -> "List[_4205.HypoidGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearPowerFlow]
    ...
    def agma_gleason_conical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4204.HypoidGearMeshPowerFlow]":
    ...
    @property
    def hypoid_meshes_power_flow(self: "Self") -> "List[_4204.HypoidGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearMeshPowerFlow]
