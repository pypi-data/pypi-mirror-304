...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2706, _2762
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TimeSeriesLoadCaseGroup(_5793.AbstractLoadCaseGroup):
    """TimeSeriesLoadCaseGroup
    ...
    @property
    def load_cases(self: "Self") -> "List[_6956.TimeSeriesLoadCase]":
