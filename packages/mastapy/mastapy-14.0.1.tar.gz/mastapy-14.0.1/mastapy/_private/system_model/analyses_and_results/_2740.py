...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2736, _2744
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DesignEntitySingleContextAnalysis(_2738.DesignEntityAnalysis):
    """DesignEntitySingleContextAnalysis
    ...
    @property
    def planetary_original(self: "Self") -> "_2738.DesignEntityAnalysis":
