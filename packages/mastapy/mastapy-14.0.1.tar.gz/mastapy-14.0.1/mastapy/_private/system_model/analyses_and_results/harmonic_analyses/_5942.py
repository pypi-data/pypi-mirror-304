...
class ShaftHarmonicAnalysis(
    _5814.AbstractShaftHarmonicAnalysis, _2743.IHaveShaftHarmonicResults
):
    """ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4796.ShaftModalAnalysis":
    ...
    @property
    def export(self: "Self") -> "_5902.HarmonicAnalysisShaftExportOptions":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2893.ShaftSystemDeflection":
