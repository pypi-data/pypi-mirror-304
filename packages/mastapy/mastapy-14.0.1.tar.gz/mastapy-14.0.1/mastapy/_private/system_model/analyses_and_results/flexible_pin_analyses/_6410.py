...
class _Cast_CombinationAnalysis:
    ...
    @property
    def flexible_pin_analysis(self: "CastSelf") -> "_6411.FlexiblePinAnalysis":
        from mastapy._private.system_model.analyses_and_results.flexible_pin_analyses import (
            _6411,
        )

        return self.__parent__._cast(_6411.FlexiblePinAnalysis)
    ...
    def wind_turbine_certification_report(
        self: "CastSelf",
    ) -> "_6418.WindTurbineCertificationReport":
        from mastapy._private.system_model.analyses_and_results.flexible_pin_analyses import (
            _6418,
        )

        return self.__parent__._cast(_6418.WindTurbineCertificationReport)
