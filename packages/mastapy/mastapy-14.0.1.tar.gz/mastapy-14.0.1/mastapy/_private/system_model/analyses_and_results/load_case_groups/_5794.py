...
class _Cast_AbstractStaticLoadCaseGroup:
    ...
    @property
    def abstract_load_case_group(self: "CastSelf") -> "_5793.AbstractLoadCaseGroup":
        return self.__parent__._cast(_5793.AbstractLoadCaseGroup)

    @property
    def abstract_design_state_load_case_group(
        self: "CastSelf",
    ) -> "_5792.AbstractDesignStateLoadCaseGroup":
        return self.__parent__._cast(_5792.AbstractDesignStateLoadCaseGroup)

    @property
    def design_state(self: "CastSelf") -> "_5797.DesignState":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5797,
        )

        return self.__parent__._cast(_5797.DesignState)

    @property
    def duty_cycle(self: "CastSelf") -> "_5798.DutyCycle":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5798,
        )

        return self.__parent__._cast(_5798.DutyCycle)

    @property
    def sub_group_in_single_design_state(
        self: "CastSelf",
    ) -> "_5801.SubGroupInSingleDesignState":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5801,
        )

        return self.__parent__._cast(_5801.SubGroupInSingleDesignState)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AbstractStaticLoadCaseGroup(_5793.AbstractLoadCaseGroup):
    """AbstractStaticLoadCaseGroup
    ...
    def bearings(
        ...
        "List[_5807.ComponentStaticLoadCaseGroup[_2495.Bearing, _6970.BearingLoadCase]]"
    ):
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5810.GearSetStaticLoadCaseGroup[_2585.CylindricalGearSet, _2584.CylindricalGear, _7012.CylindricalGearLoadCase, _2364.CylindricalGearMesh, _7014.CylindricalGearMeshLoadCase, _7016.CylindricalGearSetLoadCase]]":
    ...
    @property
    def design_states(self: "Self") -> "List[_5792.AbstractDesignStateLoadCaseGroup]":
    ...
    def fe_parts(
        self: "Self",
    ) -> "List[_5807.ComponentStaticLoadCaseGroup[_2509.FEPart, _7038.FEPartLoadCase]]":
    ...
    def gear_sets(
        self: "Self",
    ) -> "List[_5810.GearSetStaticLoadCaseGroup[_2591.GearSet, _2589.Gear, _7041.GearLoadCase, _2368.GearMesh, _7043.GearMeshLoadCase, _7046.GearSetLoadCase]]":
    ...
    @property
    def parts_with_excitations(self: "Self") -> "List[_5811.PartStaticLoadCaseGroup]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_5807.ComponentStaticLoadCaseGroup[_2529.PointLoad, _7091.PointLoadLoadCase]]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_5807.ComponentStaticLoadCaseGroup[_2530.PowerLoad, _7092.PowerLoadLoadCase]]":
    ...
    @property
    def static_loads(self: "Self") -> "List[_6955.StaticLoadCase]":
    ...
    @property
    def compound_power_flow(self: "Self") -> "_2763.CompoundPowerFlowAnalysis":
    ...
    @property
    def compound_harmonic_analysis(self: "Self") -> "_2755.CompoundHarmonicAnalysis":
    ...
    @property
    def compound_modal_analysis(self: "Self") -> "_2758.CompoundModalAnalysis":
    ...
    @property
    def compound_stability_analysis(self: "Self") -> "_2764.CompoundStabilityAnalysis":
    ...
    @enforce_parameter_types
    def analysis_of(
        self: "Self", analysis_type: "_6968.AnalysisType"
    ) -> "_2706.CompoundAnalysis":
