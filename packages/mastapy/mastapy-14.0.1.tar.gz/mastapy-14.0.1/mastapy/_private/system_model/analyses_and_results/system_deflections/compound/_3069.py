...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetCompoundSystemDeflection(_3001.GearSetCompoundSystemDeflection):
    """WormGearSetCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2926.WormGearSetSystemDeflection]":
    ...
    def worm_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_3067.WormGearCompoundSystemDeflection]":
    ...
    def worm_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_3068.WormGearMeshCompoundSystemDeflection]":
