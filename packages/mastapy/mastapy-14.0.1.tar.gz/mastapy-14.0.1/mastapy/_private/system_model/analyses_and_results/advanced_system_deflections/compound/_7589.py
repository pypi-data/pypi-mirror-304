...
class _Cast_ComponentCompoundAdvancedSystemDeflection:
    ...
    def abstract_shaft_compound_advanced_system_deflection(
        self: "CastSelf",
    ) -> "_7565.AbstractShaftCompoundAdvancedSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound import (
            _7565,
        )
    ...
    def abstract_shaft_or_housing_compound_advanced_system_deflection(
        self: "CastSelf",
    ) -> "_7566.AbstractShaftOrHousingCompoundAdvancedSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound import (
            _7566,
        )
    ...
    def bolt_compound_advanced_system_deflection(
        self: "CastSelf",
    ) -> "_7583.BoltCompoundAdvancedSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound import (
            _7583,
        )

        return self.__parent__._cast(_7583.BoltCompoundAdvancedSystemDeflection)
    ...
    def cycloidal_disc_compound_advanced_system_deflection(
        self: "CastSelf",
    ) -> "_7609.CycloidalDiscCompoundAdvancedSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound import (
            _7609,
        )
    ...
    def datum_compound_advanced_system_deflection(
        self: "CastSelf",
    ) -> "_7615.DatumCompoundAdvancedSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound import (
            _7615,
        )

        return self.__parent__._cast(_7615.DatumCompoundAdvancedSystemDeflection)

    @property
    def external_cad_model_compound_advanced_system_deflection(
        self: "CastSelf",
    ) -> "_7616.ExternalCADModelCompoundAdvancedSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound import (
            _7616,
        )
    ...
    def fe_part_compound_advanced_system_deflection(
        self: "CastSelf",
    ) -> "_7620.FEPartCompoundAdvancedSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound import (
            _7620,
        )

        return self.__parent__._cast(_7620.FEPartCompoundAdvancedSystemDeflection)
    ...
    def guide_dxf_model_compound_advanced_system_deflection(
        self: "CastSelf",
    ) -> "_7625.GuideDxfModelCompoundAdvancedSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound import (
            _7625,
        )
    ...
    def microphone_compound_advanced_system_deflection(
        self: "CastSelf",
    ) -> "_7642.MicrophoneCompoundAdvancedSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound import (
            _7642,
        )

        return self.__parent__._cast(_7642.MicrophoneCompoundAdvancedSystemDeflection)
    ...
    def shaft_compound_advanced_system_deflection(
        self: "CastSelf",
    ) -> "_7661.ShaftCompoundAdvancedSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound import (
            _7661,
        )

        return self.__parent__._cast(_7661.ShaftCompoundAdvancedSystemDeflection)
...
class ComponentCompoundAdvancedSystemDeflection(
    ...
    def component_analysis_cases(
        self: "Self",
    ) -> "List[_7454.ComponentAdvancedSystemDeflection]":
