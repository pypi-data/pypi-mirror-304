...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftCompoundSystemDeflection(_2941.AbstractShaftCompoundSystemDeflection):
    """ShaftCompoundSystemDeflection
    ...
    def shaft_duty_cycle_damage_results(
        self: "Self",
    ) -> "_3039.ShaftDutyCycleSystemDeflection":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2893.ShaftSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection]
