...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftHubConnectionSystemDeflection(_2815.ConnectorSystemDeflection):
    """ShaftHubConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4241.ShaftHubConnectionPowerFlow":
    ...
    @property
    def left_flank_contacts(self: "Self") -> "List[_2939.SplineFlankContactReporting]":
    ...
    def major_diameter_contacts(
        self: "Self",
    ) -> "List[_2939.SplineFlankContactReporting]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.reporting.SplineFlankContactReporting]
    ...
    @property
    def right_flank_contacts(self: "Self") -> "List[_2939.SplineFlankContactReporting]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.reporting.SplineFlankContactReporting]
