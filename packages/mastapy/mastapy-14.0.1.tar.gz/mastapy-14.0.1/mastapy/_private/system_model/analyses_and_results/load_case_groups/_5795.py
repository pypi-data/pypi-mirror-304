...
class _Cast_ClutchEngagementStatus:
    ...
    def generic_clutch_engagement_status(
        self: "CastSelf",
    ) -> "_5799.GenericClutchEngagementStatus":
        return self.__parent__._cast(_5799.GenericClutchEngagementStatus)
...
class ClutchEngagementStatus(
    _5799.GenericClutchEngagementStatus[_2397.ClutchConnection]
):
    """ClutchEngagementStatus
