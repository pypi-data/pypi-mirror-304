...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def excel_file_details(self: "Self") -> "_6685.ExcelFileDetails":
    ...
    @property
    def masta_file_details(self: "Self") -> "_6688.MASTAFileDetails":
    ...
    def excel_sheet_design_state_selection(
        self: "Self",
    ) -> "List[_6687.ExcelSheetDesignStateSelector]":
