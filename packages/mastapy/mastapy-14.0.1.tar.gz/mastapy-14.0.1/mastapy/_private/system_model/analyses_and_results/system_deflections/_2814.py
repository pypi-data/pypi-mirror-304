...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConnectionSystemDeflection(_7712.ConnectionFEAnalysis):
    """ConnectionSystemDeflection
    ...
    @property
    def system_deflection(self: "Self") -> "_2914.SystemDeflection":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4174.ConnectionPowerFlow":
