...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetModalAnalysis(_4752.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4828.WormGearModalAnalysis]":
    ...
    @property
    def worm_gears_modal_analysis(self: "Self") -> "List[_4828.WormGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearModalAnalysis]
    ...
    @property
    def meshes_modal_analysis(self: "Self") -> "List[_4827.WormGearMeshModalAnalysis]":
    ...
    def worm_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4827.WormGearMeshModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearMeshModalAnalysis]
