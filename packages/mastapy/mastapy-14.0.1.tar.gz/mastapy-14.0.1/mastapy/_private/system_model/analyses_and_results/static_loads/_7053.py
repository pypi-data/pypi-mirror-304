...
class _Cast_HarmonicLoadDataImportFromMotorPackages:
    ...
    def harmonic_load_data_import_base(
        self: "CastSelf",
    ) -> "_7052.HarmonicLoadDataImportBase":
        return self.__parent__._cast(_7052.HarmonicLoadDataImportBase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HarmonicLoadDataImportFromMotorPackages(_7052.HarmonicLoadDataImportBase[T]):
    """HarmonicLoadDataImportFromMotorPackages
