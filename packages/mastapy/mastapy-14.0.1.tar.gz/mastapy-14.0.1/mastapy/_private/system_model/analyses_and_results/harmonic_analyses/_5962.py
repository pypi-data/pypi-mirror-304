...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5955
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelSunGearHarmonicAnalysis(_5955.StraightBevelDiffGearHarmonicAnalysis):
    """StraightBevelSunGearHarmonicAnalysis
