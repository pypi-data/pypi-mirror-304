...
class Design(_0.APIBase):
    ...
    @property
    def design_states(self: "Self") -> "List[_5797.DesignState]":
    ...
    @property
    def duty_cycles(self: "Self") -> "List[_5798.DutyCycle]":
    ...
    def time_series_load_case_groups(
        self: "Self",
    ) -> "List[_5805.TimeSeriesLoadCaseGroup]":
    ...
    def add_synchroniser_shift_empty(self: "Self") -> "_3073.SynchroniserShift":
    ...
    @enforce_parameter_types
    def add_synchroniser_shift(self: "Self", name: "str") -> "_3073.SynchroniserShift":
        """mastapy.system_model.analyses_and_results.synchroniser_analysis.SynchroniserShift
    ...
    @enforce_parameter_types
    def design_state_named(self: "Self", name: "str") -> "_5797.DesignState":
        """mastapy.system_model.analyses_and_results.load_case_groups.DesignState
    ...
    @enforce_parameter_types
    def duty_cycle_named(self: "Self", name: "str") -> "_5798.DutyCycle":
        """mastapy.system_model.analyses_and_results.load_case_groups.DutyCycle
    ...
    def remove_synchroniser_shift(
        self: "Self", shift: "_3073.SynchroniserShift"
    ) -> None:
        """Method does not return.
    ...
    def save_load_case_results(
        self: "Self", file_name: "str", load_cases: "List[_6954.LoadCase]"
    ) -> None:
        """Method does not return.
