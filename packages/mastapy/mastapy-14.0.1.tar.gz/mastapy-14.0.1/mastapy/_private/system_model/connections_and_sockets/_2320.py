...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2491, _2522
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AbstractShaftToMountableComponentConnection(_2327.Connection):
    """AbstractShaftToMountableComponentConnection
    ...
    @property
    def mountable_component(self: "Self") -> "_2522.MountableComponent":
    ...
    @property
    def shaft(self: "Self") -> "_2491.AbstractShaft":
