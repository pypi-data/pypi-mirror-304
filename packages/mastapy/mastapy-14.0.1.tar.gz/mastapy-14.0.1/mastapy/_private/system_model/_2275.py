...
T = TypeVar("T", bound="_2500.Component")
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def axial_offset(self: "Self") -> "_2276.RelativeOffsetOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2276", "RelativeOffsetOption"
        )(value)

    @axial_offset.setter
    @enforce_parameter_types
    def axial_offset(self: "Self", value: "_2276.RelativeOffsetOption") -> None:
        value = conversion.mp_to_pn_enum(
