...
class _Cast_Database:
    ...
    def conical_gear_optimization_strategy_database(
        ...
        return self.__parent__._cast(_2283.ConicalGearOptimizationStrategyDatabase)
    ...
    def optimization_strategy_database(
        ...
        return self.__parent__._cast(_2291.OptimizationStrategyDatabase)
    ...
    def supercharger_rotor_set_database(
        ...
        return self.__parent__._cast(_2623.SuperchargerRotorSetDatabase)
