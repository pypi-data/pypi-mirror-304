...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization import _2281, _2284, _2289, _2290
...
class _Cast_NamedDatabaseItem:
    ...
    def conical_gear_optimisation_strategy(
        self: "CastSelf",
    ) -> "_2281.ConicalGearOptimisationStrategy":
        from mastapy._private.system_model.optimization import _2281

        return self.__parent__._cast(_2281.ConicalGearOptimisationStrategy)

    @property
    def cylindrical_gear_optimisation_strategy(
        self: "CastSelf",
    ) -> "_2284.CylindricalGearOptimisationStrategy":
        from mastapy._private.system_model.optimization import _2284

        return self.__parent__._cast(_2284.CylindricalGearOptimisationStrategy)

    @property
    def optimization_strategy(self: "CastSelf") -> "_2289.OptimizationStrategy":
        from mastapy._private.system_model.optimization import _2289

        return self.__parent__._cast(_2289.OptimizationStrategy)

    @property
    def optimization_strategy_base(
        self: "CastSelf",
    ) -> "_2290.OptimizationStrategyBase":
        from mastapy._private.system_model.optimization import _2290

        return self.__parent__._cast(_2290.OptimizationStrategyBase)

    @property
    def supercharger_rotor_set(self: "CastSelf") -> "_2622.SuperchargerRotorSet":
        from mastapy._private.system_model.part_model.gears.supercharger_rotor_set import (
            _2622,
        )

        return self.__parent__._cast(_2622.SuperchargerRotorSet)
