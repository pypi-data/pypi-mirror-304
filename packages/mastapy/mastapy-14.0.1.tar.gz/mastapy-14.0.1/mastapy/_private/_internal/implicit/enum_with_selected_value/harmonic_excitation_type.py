...
class EnumWithSelectedValue_HarmonicExcitationType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7048.HarmonicExcitationType
        """
        return _7048.HarmonicExcitationType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7048.HarmonicExcitationType.type_()

    @property
    def selected_value(self: "Self") -> "_7048.HarmonicExcitationType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7048.HarmonicExcitationType]":
