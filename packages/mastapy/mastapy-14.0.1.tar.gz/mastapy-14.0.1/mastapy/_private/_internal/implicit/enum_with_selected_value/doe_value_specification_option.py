...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DoeValueSpecificationOption]",
    ) -> "_4460.DoeValueSpecificationOption":
        ...
        Returns:
            _4460.DoeValueSpecificationOption
        """
        return _4460.DoeValueSpecificationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _4460.DoeValueSpecificationOption.type_()

    @property
    def selected_value(self: "Self") -> "_4460.DoeValueSpecificationOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_4460.DoeValueSpecificationOption]":
