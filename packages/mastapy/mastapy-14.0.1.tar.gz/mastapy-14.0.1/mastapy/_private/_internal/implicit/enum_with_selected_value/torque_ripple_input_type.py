...
class EnumWithSelectedValue_TorqueRippleInputType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7129.TorqueRippleInputType
        """
        return _7129.TorqueRippleInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7129.TorqueRippleInputType.type_()

    @property
    def selected_value(self: "Self") -> "_7129.TorqueRippleInputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7129.TorqueRippleInputType]":
