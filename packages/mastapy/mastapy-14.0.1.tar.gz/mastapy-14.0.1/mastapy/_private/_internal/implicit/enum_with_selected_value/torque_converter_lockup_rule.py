...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueConverterLockupRule]",
    ) -> "_5640.TorqueConverterLockupRule":
        ...
        Returns:
            _5640.TorqueConverterLockupRule
        """
        return _5640.TorqueConverterLockupRule
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5640.TorqueConverterLockupRule.type_()

    @property
    def selected_value(self: "Self") -> "_5640.TorqueConverterLockupRule":
    ...
    @property
    def available_values(self: "Self") -> "List[_5640.TorqueConverterLockupRule]":
