...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorStiffnessType]",
    ) -> "_2653.RigidConnectorStiffnessType":
        ...
        Returns:
            _2653.RigidConnectorStiffnessType
        """
        return _2653.RigidConnectorStiffnessType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2653.RigidConnectorStiffnessType.type_()

    @property
    def selected_value(self: "Self") -> "_2653.RigidConnectorStiffnessType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2653.RigidConnectorStiffnessType]":
