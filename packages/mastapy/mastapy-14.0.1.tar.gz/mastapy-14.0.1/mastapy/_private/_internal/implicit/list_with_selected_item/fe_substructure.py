...
class ListWithSelectedItem_FESubstructure(
    _2439.FESubstructure, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_FESubstructure]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2439.FESubstructure.TYPE

    @property
    def selected_value(self: "Self") -> "_2439.FESubstructure":
    ...
    @property
    def available_values(self: "Self") -> "List[_2439.FESubstructure]":
