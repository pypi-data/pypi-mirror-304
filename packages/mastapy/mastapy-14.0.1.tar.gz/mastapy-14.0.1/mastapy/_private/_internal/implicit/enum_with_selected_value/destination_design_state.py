...
class EnumWithSelectedValue_DestinationDesignState(
    ...
    def wrapped_type(
        ...
        Returns:
            _7144.DestinationDesignState
        """
        return _7144.DestinationDesignState
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7144.DestinationDesignState.type_()

    @property
    def selected_value(self: "Self") -> "_7144.DestinationDesignState":
    ...
    @property
    def available_values(self: "Self") -> "List[_7144.DestinationDesignState]":
