...
class EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod]",
    ) -> "_2272.PowerLoadInputTorqueSpecificationMethod":
        ...
        Returns:
            _2272.PowerLoadInputTorqueSpecificationMethod
        """
        return _2272.PowerLoadInputTorqueSpecificationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2272.PowerLoadInputTorqueSpecificationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2272.PowerLoadInputTorqueSpecificationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2272.PowerLoadInputTorqueSpecificationMethod]":
