...
class EnumWithSelectedValue_ThermalExpansionOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _2467.ThermalExpansionOption
        """
        return _2467.ThermalExpansionOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2467.ThermalExpansionOption.type_()

    @property
    def selected_value(self: "Self") -> "_2467.ThermalExpansionOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2467.ThermalExpansionOption]":
