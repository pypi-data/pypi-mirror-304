...
from mastapy._private.system_model.fe import _2421
...
class EnumWithSelectedValue_ComponentOrientationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ComponentOrientationOption]",
    ) -> "_2421.ComponentOrientationOption":
        ...
        Returns:
            _2421.ComponentOrientationOption
        """
        return _2421.ComponentOrientationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2421.ComponentOrientationOption.type_()

    @property
    def selected_value(self: "Self") -> "_2421.ComponentOrientationOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2421.ComponentOrientationOption]":
