...
class ListWithSelectedItem_FESubstructureNode(
    _2441.FESubstructureNode, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_FESubstructureNode]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2441.FESubstructureNode.TYPE

    @property
    def selected_value(self: "Self") -> "_2441.FESubstructureNode":
    ...
    @property
    def available_values(self: "Self") -> "List[_2441.FESubstructureNode]":
