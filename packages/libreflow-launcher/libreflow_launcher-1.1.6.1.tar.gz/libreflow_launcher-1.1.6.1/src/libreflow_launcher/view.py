...
class ComboBox(QtWidgets.QComboBox):
    ...
    def _on_index_changed(self, i):
        ...
        self.style().polish(self)
        if isinstance(self.parent, SettingsContent):
...
class GlobalSettings(SettingsContent):
    ...
    def get_content(self):
        ...
        poetry_label = QtWidgets.QLabel("Poetry path")
        poetry_input = LineEdit(
            data['poetry_path'],
            ['mandatory', 'path'],
            'poetry_path',
            self.settings_list
        )
        poetry_input.setObjectName("SettingsInput")
        second_group = [poetry_label, poetry_input]
        ...
        third_group = [python_label, python_input]
        ...
        quarter_group = [site_label, site_input]
        ...
        fifth_group = [show_process_label, show_process_input]
        ...
        sixth_group = [advanced_label, advanced_input]
        contents.append(sixth_group)
