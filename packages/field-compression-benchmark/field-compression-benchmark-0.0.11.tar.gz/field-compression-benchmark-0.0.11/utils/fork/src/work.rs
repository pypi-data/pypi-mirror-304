...
impl<
        ...
        A,
        Q: Serialize + DeserializeOwned,
    > Drop for ForkedWorkIterator<'a, F, I, A, Q>
{
    fn drop(&mut self) {
...
impl<
        ...
        A,
        Q: Serialize + DeserializeOwned,
    > Iterator for ForkedWorkIterator<'a, F, I, A, Q>
{
...
impl<
        ...
        A,
        Q: Serialize + DeserializeOwned,
    > FusedIterator for ForkedWorkIterator<'a, F, I, A, Q>
{
}
