...
class TerrestrialRelativePositionEphemeris(BaseModel):
    """
    Ephemeris of the relative position and velocity vectors of ground-based targets w.r.t. the space object 
    """ # noqa: E501
    ...
    target_names: Optional[List[StrictStr]] = Field(default=None, description="Target names", alias="targetNames")
