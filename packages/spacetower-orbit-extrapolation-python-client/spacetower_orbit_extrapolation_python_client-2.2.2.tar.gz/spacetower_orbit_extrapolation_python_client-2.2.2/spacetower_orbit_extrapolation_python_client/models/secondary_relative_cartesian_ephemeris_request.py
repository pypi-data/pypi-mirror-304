...
class SecondaryRelativeCartesianEphemerisRequest(BaseModel):
    ...
    secondary_objects: Optional[Annotated[List[SecondaryObject], Field(min_length=1)]] = Field(default=None, alias="secondaryObjects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "secondaryObjects": [SecondaryObject.from_dict(_item) for _item in obj["secondaryObjects"]] if obj.get("secondaryObjects") is not None else None
        })
        return _obj
