...
from decentnet.modules.tcp.socket_functions import set_sock_properties_common, set_sock_properties_ipv6
...
class TCPServer:
    def __init__(self, host, port):
        ...
        if ":" not in host:
            ...
            set_sock_properties_ipv6(self.server)
            self.server.bind((self.host, self.port, 0, 0))

        set_sock_properties_common(self.server)
        self.clients = []
    ...
    def run(self):
        ...
        while True:
            ...
            set_sock_properties_common(client_socket)
