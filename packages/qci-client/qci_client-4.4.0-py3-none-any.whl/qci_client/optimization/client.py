        ...
        *,
        ...
        if job_type == enum.JobType.GRAPH_PARTITIONING:
            ...
            if device_type == enum.DeviceType.DIRAC2:
                ...
                if "normalized_loss_rate" in job_params:
                    # Optional parameter.
                    device_config["normalized_loss_rate"] = job_params[
            ...
            if "domain_max" in job_params:
                # Optional parameter.
                device_config["domain_max"] = job_params["domain_max"]
