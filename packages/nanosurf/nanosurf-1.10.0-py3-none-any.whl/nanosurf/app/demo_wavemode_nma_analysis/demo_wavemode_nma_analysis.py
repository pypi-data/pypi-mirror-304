...
def analyze_force_curve(distance_nm:np.array, force_nN:np.array, i:int, plot_curve_index:int = -1):
    ...
    analysis_result["fit_distance"] = np.array(distance_nm[max_force_index:contact_point_index])
    analysis_result["fit_force"] = fit_func(np.array(distance_nm[max_force_index:contact_point_index]), *popt_model_fit)
...
def plot_single_curve(curve_dict: dict):
    ...
    plt.scatter(distance_nm[baseline_index_start:baseline_index_end], force_nN[baseline_index_start:baseline_index_end])
    ...
    plt.scatter(distance_nm[contact_point_index], force_nN[contact_point_index])
    plt.scatter(distance_nm[fit_index_start], force_nN[fit_index_start])
    plt.scatter(distance_nm[fit_index_end], force_nN[fit_index_end])
    plt.show()
