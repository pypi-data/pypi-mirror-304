...
class NHFDataset():
    ...
    def need_conversion_to_physical_units(self) -> bool:
        ...
        """
        return isinstance(self.dataset, h5py.Dataset)
    ...
    def scale_dataset_to_physical_units(self) -> None:
        ...
        """
        assert self.need_conversion_to_physical_units(), "Do not covert multiple times. Dataset is already in physical units" 
        try:
