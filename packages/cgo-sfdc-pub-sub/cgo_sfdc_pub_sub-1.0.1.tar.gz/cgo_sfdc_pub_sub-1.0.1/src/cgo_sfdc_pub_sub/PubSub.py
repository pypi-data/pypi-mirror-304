...
class PubSub(object):
    ...
    def __init__(self, argument_dict):
        ...
        self.metadata = (('accesstoken', get_argument('accesstoken', argument_dict)),
                         ('instanceurl', get_argument('instanceurl', argument_dict)),
                         ('tenantid', get_argument('tenantid', argument_dict)))
        ...
        if get_argument('api_version', argument_dict) == None:
            self.apiVersion = '55.0'
        else:
            # Otherwise, get the version from the argument
            self.apiVersion = get_argument('api_version', argument_dict)
