from youtube_autonomous.segments.enums import SegmentField, EnhancementField, SegmentType, ShortcodeType, EnhancementType, EnhancementMode, ShortcodeStringDuration, EnhancementStringDuration, SegmentStringDuration, EnhancementStringDuration, SegmentMode, ShortcodeMode, ShortcodeField, SegmentStart, EnhancementStart, ShortcodeStart
...
class ElementValidator:
    ...
    def validate_duration_for_type(component: Component, duration: Union[SegmentStringDuration, EnhancementStringDuration, ShortcodeStringDuration, int, float, str, None], type: str):
        ...
        if not variable_is_positive_number(duration) and not duration in config.string_durations:
    ...
    def validate_start_field(component: Component, start: Union[int, float, str, None]):
        if start is not None:
            if not variable_is_positive_number(start):
                if component == Component.SEGMENT:
