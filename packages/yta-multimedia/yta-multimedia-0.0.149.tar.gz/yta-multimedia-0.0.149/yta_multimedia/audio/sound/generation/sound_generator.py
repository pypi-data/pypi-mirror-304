...
class SoundGenerator:
    ...
    def create_silence_audio(cls, duration: float, output_filename: Union[str, None] = None):
        ...
        audio_filename = get_resource(SILENCE_10_SECONDS_GOOGLE_DRIVE_DOWNLOAD_URL, cls.SILENCE_SOUND_FILENAME)
    ...
    def create_typing_audio(cls, output_filename: Union[str, None] = None):
        ...
        with that name.
        """
        audio_filename = get_resource(TYPING_KEYBOARD_3_SECONDS_GOOGLE_DRIVE_DOWNLOAD_URL, cls.TYPING_SOUND_FILENAME)
        audioclip = AudioFileClip(audio_filename)
