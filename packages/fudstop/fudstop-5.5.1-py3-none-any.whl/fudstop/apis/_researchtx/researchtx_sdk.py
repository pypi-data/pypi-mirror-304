...
class ResearchTexasSDK:
    ...
    async def get_filings(self, id: str, page_size: int = 50, search_text: str = '', headers: str = None):
        """Get case filings"""
        url = f"https://research.txcourts.gov/CourtRecordsSearch/case/{id}/events"
        
        r = requests.post(url=url, data={"pageSize": page_size, "pageIndex": 0, "sortNewestToOldest": False, 
        ...
        if r.status_code == 200:
            ...
            df.to_csv('filings_divorce.csv', index=False)
