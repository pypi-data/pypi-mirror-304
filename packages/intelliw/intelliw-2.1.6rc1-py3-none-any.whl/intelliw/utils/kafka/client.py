...
class KafkaClient:
    ...
    def consume_messages(self, topics: list, handle_func, timeout=1.0, return_by_empty=False, return_by_count=0, return_by_func=None):
        """
        消费 Kafka 消息
        ...
        try:
            ...
            while True:
                ...
                if return_by_count and count >= return_by_count:
                    return None
                if return_by_func(msg.key(), msg.value()) is True:
                    return None
