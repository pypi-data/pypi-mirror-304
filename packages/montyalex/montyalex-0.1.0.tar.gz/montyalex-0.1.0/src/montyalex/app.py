    ...
    if commands:
        ...
        for name, shorthelp, index, defaults in mtax_commands:
            if index:
                ...
                command_help = f"    {name} -> [dim italic]{shorthelp}[/]"
            if defaults:
...
def mtax(
    split: bool = Option(
        False, '--split', show_default='--no-split', help='Split the lines for better readability'),
    save_funcargs_to_file: bool = Option(
        False, '--save-a', '-s-a',
        show_default='--no-save-a',
        help='Save a file with the functions arguments available here for projects or ease of use'),
    save_blueprints_to_file: bool = Option(
        False, '--save-b', '-s-b',
        show_default='--no-save-b',
        help='Save a file with the blueprints available here for projects or ease of use'),
    save_commands_to_file: bool = Option(
        False, '--save-c', '-s-c',
        show_default='--no-save-c',
        help='Save a file with the commands available here for projects or ease of use'),
    save_file: bool = Option(
        False, '--save',
        show_default='--no-save',
        help='Save a file with the info here for projects or ease of use'),
    func_args: bool = Option(
        False, '-a', '--args', show_default='-!a', help='Show the arguments of functions'),
    blueprints: bool = Option(
        False, '-b', '--blueprints',
        show_default='-!b',
        help='Shows the blueprints (classes) of functions'),
    commands: bool = Option(
        False, '-c', '--commands',
        show_default='-!c',
        help='Shows the commands / functions'),
    super_silence: bool = Option(
        False, '-ss', show_default='-!ss', help='Super silence ALL messages in console'),
    silence: bool = Option(
        False, '-s', show_default='-!s', help='Silence extreneous messages in console')):
    """."""
