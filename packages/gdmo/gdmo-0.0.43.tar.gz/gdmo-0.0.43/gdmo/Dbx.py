...
class DbxWidget:
    ...
    def __new__(self, dbutils, name, type='text', defaultValue='', **kwargs):
        ...
        if 'returntype' in kwargs:
            ...
            if kwargs['returntype'] not in valid_return_types:
