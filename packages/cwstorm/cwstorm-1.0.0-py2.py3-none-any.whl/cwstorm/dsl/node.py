...
Subclasses should specify the attributes to be serialized in a class attribute called ATTRS. This is a dict, keyed by attribute name, with values specifying the attribute type and any additional validation constraints.
