        ...
        condition = ConditionDataModel(
            {
                ...
                "cloud_area_fraction_high": details_metno.get(
                ...
                "weather": details_metno_next_1_hours.get("summary", {}).get(
                    "symbol_code"
                ),
                "weather6": details_metno_next_6_hours.get("summary", {}).get(
                    "symbol_code"
                ),
                "precipitation_amount": details_metno_next_1_hours.get(
                    "details", {}
                ).get("precipitation_amount"),
                "precipitation_amount6": details_metno_next_6_hours.get(
                    "details", {}
                ).get("precipitation_amount"),
            }
        )
