...
__all__ = ['which_environment', 'DJ_Workspace_NoAuth', 'read_domo_jupyter_account', 'get_creds_from_domojupyter_account',
           'DJ_Workspace_InvalidCreds', 'generate_token_auth', 'generate_full_auth', 'generate_domo_auth', 'reset_ds']
...
async def reset_ds(df: pd.DataFrame, dataset_id, domojupyter_fn: Callable):
    empty_df = pd.DataFrame(columns=df.columns)

    domojupyter_fn.write_dataframe(empty_df, dataset_id, update_method="REPLACE")

    return "hope you knew wht you were doing"
