class HardwareInfo:
    ...
    def GetID(cls):
        ...
        * Mac: Gets a id based on multiple hardware components such as motherboard
        * Linux: Gets an unique identifier for the current installation \n
            * Note: retrieves an unique identifier for the current installation which changes between OS installation. \
