...
from uv_version.increment.processing import IncrementEnum, increment_version


class TestIncrementVersion(object):
    ...
    def test_1(self, version: str, part: IncrementEnum, result: str):
