...
def score_file(scr):
    ...
    if "XDG_CONFIG_HOME" in my_env:
        configdir = my_env["XDG_CONFIG_DIR"]
    else:
        configdir = os.path.join(os.path.expanduser("~" + getpass.getuser()), ".config")

    scorefilename = os.path.join(configdir, "glerm_score")
