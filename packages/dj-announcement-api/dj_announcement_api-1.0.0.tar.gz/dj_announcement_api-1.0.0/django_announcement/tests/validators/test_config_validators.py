...
class TestValidateBooleanSetting:
    ...
    def test_invalid_boolean(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "django_announcement.E001_SOME_BOOLEAN_SETTING"
...
class TestValidateListFields:
    ...
    def test_invalid_list_type(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "django_announcement.E002_SOME_LIST_SETTING"
    ...
    def test_empty_list(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "django_announcement.E003_SOME_LIST_SETTING"
    ...
    def test_invalid_element_in_list(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "django_announcement.E004_SOME_LIST_SETTING"
...
class TestValidateThrottleRate:
    ...
    def test_invalid_format(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "django_announcement.E006"
    ...
    def test_invalid_time_unit(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "django_announcement.E008"
    ...
    def test_non_numeric_rate(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "django_announcement.E007"
