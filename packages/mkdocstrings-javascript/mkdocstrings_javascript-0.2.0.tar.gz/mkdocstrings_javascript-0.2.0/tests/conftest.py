...
if TYPE_CHECKING:
    ...
    from mkdocstrings_handlers.javascript.handler import JavascriptHandler
...
def fixture_mkdocs_conf(request: pytest.FixtureRequest, tmp_path: Path) -> Iterator[config.Config]:
    ...
    conf_dict = {
        ...
        "plugins": [{"mkdocstrings": {"default_handler": "javascript"}}],
...
def fixture_handler(plugin: MkdocstringsPlugin, ext_markdown: Markdown) -> JavascriptHandler:
