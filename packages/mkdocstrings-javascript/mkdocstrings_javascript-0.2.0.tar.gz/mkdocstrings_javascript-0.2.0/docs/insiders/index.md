...
*mkdocstrings-javascript* follows the **sponsorware** release strategy, which means
...
*mkdocstrings-javascript Insiders* is a private fork of *mkdocstrings-javascript*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *mkdocstrings-javascript*.
...
*mkdocstrings-javascript* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *mkdocstrings-javascript*,
...
<small>
  ...
  your profile and avatar to show your support for *mkdocstrings-javascript*.
...
to use *mkdocstrings-javascript* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *mkdocstrings-javascript*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *mkdocstrings-javascript
Insiders* precisely under the same terms as *mkdocstrings-javascript*, which are given
