...
def get_version(dist: str = "mkdocstrings-javascript") -> str:
...
def get_debug_info() -> Environment:
    ...
    packages = ["mkdocstrings-javascript"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("MKDOCSTRINGS_JAVASCRIPT")]]
    return Environment(
