...
class OlhoVivoAPI:
    ...
    def _get(self, url, params=None) -> requests.Response | None:
        """
    ...
    def _request(self, endpoint: list[str], params: dict = None, error_msg: str = 'Erro ao buscar dados'):
        """
    ...
    def get_linha_sentido(self, linha: str, sentido: int = 1) -> list[LinhaBase]:
        """
    ...
    def get_previsao_linha_parada(self, codigo_linha: int, codigo_parada: int) -> list[Linha]:
        """
        ...
        data = self._request(
            ["Previsao"],
            params={'codigoLinha': codigo_linha, 'codigoParada': codigo_parada},
