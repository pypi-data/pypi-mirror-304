...
registry.register('devart.bigcommerce', 'devart.bigcommerce.sqlalchemy', 'DevartBigCommerceDialect')

class DevartBigCommerceDialect(SQLiteDialect):
    driver = "devart"
    name = "bigcommerce"
    ...
    def import_dbapi(cls):
        ...
        bigcommerce_package = devart.bigcommerce
        setattr(bigcommerce_package, "sqlite_version_info", (3, 39, 2))
        return bigcommerce_package
