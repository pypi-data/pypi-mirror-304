...
def check_family_exists_by_name(session, family_name): #TODO: api call 
    """
...
class ModelArch:
    ...
    """
    Class to interact with the model architecture API to get model architecture info.
    """
