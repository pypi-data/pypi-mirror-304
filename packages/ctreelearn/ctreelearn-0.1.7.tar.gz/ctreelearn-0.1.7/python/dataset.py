  ...
  def __init__(self, *args, **kwargs):
    ...
    if(len(args) == 4 or len(args) == 5):
      ...
      for f in os.listdir(dirName):
        ...
        if(self.isLoaded):
            tree = ctl.ComponentTree(img_vector, self.num_rows, self.num_cols, self.__isMaxtree)
      ...
      self.__isMaxtree = dataset.__isMaxtree
      if(self.isLoaded):
