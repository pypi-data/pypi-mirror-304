...
class LeadStatusClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, product_slug, created_by, updated_by, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, product_slug, created_by, updated_by, *args, **kwargs):  # noqa: E501
        """LeadStatusClass - a model defined in OpenAPI
