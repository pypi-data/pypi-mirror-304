...
def assert_shape_results(
    ...
    uni_cache: dict[ShapeType, str] = {}
    var_cache: dict[ShapeType, str] = {}
    shapes = {
        key: value.shape.get_shapes(uni_cache, var_cache, verbose=True)
        if isinstance(value, Tensor)
        else []
        for key, value in data.items()
    }
    check_shapes_semantically(shapes, ref_results)
...
def make_assertions(
    ...
    if is_type_checker(ref_results, constraint_fn):
        ...
        assert_shape_results(data, ref_results, updated_symbols, expected_updates)
...
def _assert_constraint_results(
    ...
    shape_map = create_shape_map(shapes, ConstraintSolver())
    ...
    make_assertions(
        constraint_fn, data, ref_results, reupdated_symbols, set(), final_values
    )
...
def test_bcast_forward_7():
    ...
    assert_constraint_results(shapes, final_shapes, bcast, False, {"output", "right"})
...
def test_bcast_forward_9():
    ...
    assert_constraint_results(shapes, final_shapes, bcast, True, {"output", "right"})
...
def test_bcast_forward_11():
    ...
    assert_constraint_results(
        shapes, final_shapes, bcast, False, {"output", "left", "right"}
    )
...
def test_bcast_forward_11_2():
    ...
    assert_constraint_results(shapes, final_shapes, bcast, False, {"output", "left"})
...
def test_bcast_backward_12():
    ...
    assert_constraint_results(shapes, final_shapes, bcast, True, {"left", "right"})
...
def test_bcast_backward_25():
    ...
    assert_constraint_results(
        shapes, final_shapes, bcast, False, {"output", "right", "left"}
    )
...
def test_bcast_forward_backward_1():
    ...
    assert_constraint_results(shapes, final_shapes, bcast, True, {"output", "left"})
...
def test_bcast_matmul_forward_1():
    ...
    assert_constraint_results(
        shapes, final_shapes, bcast_matrix_mult, False, {"output", "left"}
    )
...
def test_reduce_forward_11():
    ...
    assert_constraint_results(
        shapes, final_shapes, reduce_constraints, True, {"input", "output"}, scalar_info
    )
...
def test_reduce_forward_backward_1():
    ...
    scalar_info = {"axis": Scalar(value=(-2, 2))}
    assert_constraint_results(
        shapes, final_shapes, reduce_constraints, True, {"output", "input"}, scalar_info
    )
...
def test_max_pool_11():
    ...
    assert_constraint_results(
        shapes, final_shapes, sliding_window_2d_constraints, False, set(), scalar_info
    )
...
def test_broadcast_to_1():
    ...
    assert_constraint_results(
        shapes, final_shapes, broadcast_to_constraints, False, {"output"}, scalar_info
    )
...
def test_broadcast_to_3():
    ...
    assert_constraint_results(
        shapes, final_shapes, broadcast_to_constraints, False, set(), scalar_info
    )
...
def test_reshape_2():
    ...
    assert_constraint_results(
        shapes, final_shapes, reshape_constraints, False, {"output"}, scalar_info
    )
...
def test_squeeze_7():
    ...
    assert_constraint_results(shapes, final_shapes, squeeze_constraints, False, set())
...
def test_swap_axes_5():
    ...
    scalar_info = {"axis1": Scalar(value=3), "axis2": Scalar(value=1)}
    assert_constraint_results(
        shapes, final_shapes, swap_axes_constraints, True, {"output"}, scalar_info
    )
...
def test_swap_axes_7():
    ...
    scalar_info = {"axis1": Scalar(value=-3), "axis2": Scalar(value=-1)}
    assert_constraint_results(
        shapes, final_shapes, swap_axes_constraints, True, {"input"}, scalar_info
    )
...
def test_where_1():
    ...
    assert_constraint_results(shapes, final_shapes, where_constrains, False, {"output"})
...
def test_polynomial_features_4():
    ...
    with pytest.raises(ValueError) as err_info:
        assert_constraint_results(
            shapes, {}, polynomial_features_constraints, False, set(), scalar_info
        )
    assert (
        str(err_info.value)
...
def test_tensor_item_constraints_1():
    ...
    assert_constraint_results(
        shapes, final_shapes, tensor_item_constraints, True, {"input"}, scalar_info
    )
...
def test_tensor_item_constraints_5():
    ...
    assert_constraint_results(
        shapes, final_shapes, tensor_item_constraints, True, {"output"}, scalar_info
    )
...
def test_tensor_item_constraints_6():
    ...
    assert_constraint_results(
        shapes, final_shapes, tensor_item_constraints, False, {"output"}, scalar_info
    )
...
def test_scalar_item_type_constraints_1():
    ...
    assert_constraint_results(
        {}, final_types, scalar_item_type_constraint, True, {"output"}, scalar_info
    )
...
def test_scalar_item_type_constraints_3():
    ...
    assert_constraint_results(
        {}, final_types, scalar_item_type_constraint, True, {"input"}, scalar_info
    )
...
def test_scalar_item_type_constraints_4():
    ...
    assert_constraint_results(
        {}, final_types, scalar_item_type_constraint, False, {"output"}, scalar_info
    )
...
def test_scalar_item_type_constraints_13():
    ...
    assert_constraint_results(
        {}, final_types, scalar_item_type_constraint, False, {"input"}, scalar_info
    )
...
def test_scalar_slice_type_constraints_1():
    ...
    assert_constraint_results(
        {}, final_types, scalar_slice_type_constraint, False, {"output"}, scalar_info
    )
...
def test_scalar_slice_type_constraints_2():
    ...
    assert_constraint_results(
        {}, final_types, scalar_slice_type_constraint, True, {"output"}, scalar_info
    )
...
def test_scalar_slice_type_constraints_4():
    ...
    assert_constraint_results(
        {}, final_types, scalar_slice_type_constraint, True, {"input"}, scalar_info
    )
...
def test_scalar_slice_type_constraints_9():
    ...
    assert_constraint_results(
        {}, final_types, scalar_slice_type_constraint, False, {"input"}, scalar_info
    )
