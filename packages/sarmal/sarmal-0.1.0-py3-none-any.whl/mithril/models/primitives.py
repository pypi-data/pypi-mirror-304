...
class SupervisedLoss(PrimitiveModel):
    ...
    def __call__(  # type: ignore[override]
        ...
        kwargs = {"input": input, "target": target, "output": output}
...
class KLDivergence(PrimitiveModel):
    ...
    def __call__(  # type: ignore[override]
        ...
        kwargs = {"input": input, "target": target, "cutoff": cutoff, "output": output}
        return ExtendInfo(self, kwargs)
...
class StableReciprocal(PrimitiveModel):
    ...
    def __call__(  # type: ignore[override]
        ...
        kwargs = {"input": input, "cutoff": cutoff, "output": output}
        return ExtendInfo(self, kwargs)
...
class LeakyRelu(Activation):
    ...
    def __call__(  # type: ignore[override]
        ...
        kwargs = {"input": input, "slope": slope, "output": output}
        return ExtendInfo(self, kwargs)
...
class PermuteTensor(PrimitiveModel):
    ...
    def __call__(  # type: ignore[override]
        ...
        kwargs = {"input": input, "indices": indices, "output": output}
        return ExtendInfo(self, kwargs)
...
class PaddingConverter1D(PrimitiveModel):
    ...
    def __call__(  # type: ignore[override]
        ...
        kwargs = {"input": input, "kernel_size": kernel_size, "output": output}
        return ExtendInfo(self, kwargs)
...
class DistanceMatrix(PrimitiveModel):
    ...
    def __call__(  # type: ignore[override]
        ...
        kwargs = {"left": left, "right": right, "norm": norm, "output": output}
        return ExtendInfo(self, kwargs)
...
class PolynomialFeatures(PrimitiveModel):
    ...
    def __call__(  # type: ignore[override]
        ...
        kwargs = {"input": input, "degree": degree, "output": output}
        return ExtendInfo(self, kwargs)
...
class GPRVOuter(PrimitiveModel):
    ...
    def __call__(  # type: ignore[override]
        ...
        kwargs = {"K": K, "K_term": K_term, "L": L, "output": output}
        return ExtendInfo(self, kwargs)
...
class Arange(PrimitiveModel):
    ...
    def __call__(  # type: ignore[override]
        ...
        kwargs = {"start": start, "stop": stop, "step": step, "output": output}
        return ExtendInfo(self, kwargs)
...
class BroadcastTo(PrimitiveModel):
    ...
    def __call__(  # type: ignore[override]
        ...
        kwargs = {"input": input, "shape": shape, "output": output}
        return ExtendInfo(self, kwargs)
...
class Eigvalsh(PrimitiveModel):
    ...
    def __call__(  # type: ignore[override]
        ...
        kwargs = {"K_term": K_term, "L": L, "threshold": threshold, "output": output}
        return ExtendInfo(self, kwargs)
...
class AUCCore(PrimitiveModel):
    ...
    def __call__(  # type: ignore[override]
        ...
        kwargs = {"input": input, "label": label, "output": output}
        return ExtendInfo(self, kwargs)
...
class SwapAxes(PrimitiveModel):
    ...
    def __call__(  # type: ignore[override]
        ...
        kwargs = {"input": input, "axis1": axis1, "axis2": axis2, "output": output}
        return ExtendInfo(self, kwargs)
...
class Where(PrimitiveModel):
    ...
    def __call__(  # type: ignore[override]
        ...
        kwargs = {"cond": cond, "input1": input1, "input2": input2, "output": output}
        return ExtendInfo(self, kwargs)
...
class Trapezoid(PrimitiveModel):
    ...
    def __call__(  # type: ignore[override]
        ...
        return ExtendInfo(self, {"y": y, "x": x, "output": output})
