...
class Model(BaseModel):
    ...
    def extend(
        ...
        **kwargs: ConnectionType,
        ...
        shape_info: Mapping[str, ShapeTemplateType] = dict()
        ...
        # Update Canonicals
        if isinstance(c_input := model._canonical_input, ConnectionData):
            c_input_obj = self.conns.get_con_by_metadata(c_input.metadata)
        ...
        if isinstance(c_output := model._canonical_output, ConnectionData):
            c_output_obj = self.conns.get_con_by_metadata(c_output.metadata)
