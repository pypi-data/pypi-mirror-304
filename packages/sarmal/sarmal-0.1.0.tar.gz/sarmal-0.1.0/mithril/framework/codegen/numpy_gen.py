...
from ..common import FinalCost, LossKey, Tensor, ValueType, is_type_adjustment_required
        ...
        def evaluate_gradients_wrapper_manualgrad(
            ...
            *,
            ...
            for key in (
                ...
                if key in params:
                    out_data = params[key]
                elif "output" in cached_data[key + "_cache"]:
                    out_data = cached_data[key + "_cache"]["output"]
                else:
                    ...
                    if _key in self.pm._input_keys:
                        ...
                        out_data = cached_data[_key + "_cache"]["output"]
