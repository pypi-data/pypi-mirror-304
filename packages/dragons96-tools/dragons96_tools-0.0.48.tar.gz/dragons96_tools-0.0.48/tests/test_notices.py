from dragons96_tools.notices import SmtpEmailNotice, FeishuRobotNotice, FeishuRobotTextMsg, FeishuRobotPostMsg, \
    FeishuRobotCardMsg, FeishuRobotCardMsgTemplate
from dragons96_tools.builders import HtmlBuilder
