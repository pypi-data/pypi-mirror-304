...
_DEFAULTNODEINFOOTHER = DESCRIPTOR.message_types_by_name[
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _NETADDRESS.fields_by_name[
        'id'
    ]._serialized_options = b'\342\336\037\002ID'
    _NETADDRESS.fields_by_name['ip']._options = None
    _NETADDRESS.fields_by_name[
        'ip'
    ]._serialized_options = b'\342\336\037\002IP'
    _PROTOCOLVERSION.fields_by_name['p2p']._options = None
    _PROTOCOLVERSION.fields_by_name[
        'p2p'
    ]._serialized_options = b'\342\336\037\003P2P'
