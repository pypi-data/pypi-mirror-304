...
_VALIDATORSIGNINGINFO = DESCRIPTOR.message_types_by_name[
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _VALIDATORSIGNINGINFO.fields_by_name[
        'start_height'
    ]._serialized_options = b'\362\336\037\023yaml:\"start_height\"'
    _VALIDATORSIGNINGINFO.fields_by_name['index_offset']._options = None
    _VALIDATORSIGNINGINFO.fields_by_name[
        'index_offset'
    ]._serialized_options = b'\362\336\037\023yaml:\"index_offset\"'
