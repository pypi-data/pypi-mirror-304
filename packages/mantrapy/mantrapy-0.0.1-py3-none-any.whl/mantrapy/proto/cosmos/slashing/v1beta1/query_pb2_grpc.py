...
class QueryStub:
    ...
    def __init__(self, channel):
        ...
        self.Params = channel.unary_unary(
            ...
            request_serializer=cosmos_dot_slashing_dot_v1beta1_dot_query__pb2.
...
def add_QueryServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        grpc.unary_unary_rpc_method_handler(
            servicer.Params,
            request_deserializer=cosmos_dot_slashing_dot_v1beta1_dot_query__pb2
            .QueryParamsRequest.FromString,
            response_serializer=cosmos_dot_slashing_dot_v1beta1_dot_query__pb2.
        ...
        grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=cosmos_dot_slashing_dot_v1beta1_dot_query__pb2
            .QuerySigningInfoRequest.FromString,
            response_serializer=cosmos_dot_slashing_dot_v1beta1_dot_query__pb2.
            QuerySigningInfoResponse.SerializeToString,
        ),
        'SigningInfos':
        grpc.unary_unary_rpc_method_handler(
            servicer.SigningInfos,
            request_deserializer=cosmos_dot_slashing_dot_v1beta1_dot_query__pb2
            .QuerySigningInfosRequest.FromString,
            response_serializer=cosmos_dot_slashing_dot_v1beta1_dot_query__pb2.
            QuerySigningInfosResponse.SerializeToString,
        ),
    }
...
class Query:
    ...
    def Params(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/cosmos.slashing.v1beta1.Query/Params',
            cosmos_dot_slashing_dot_v1beta1_dot_query__pb2.QueryParamsRequest.
            SerializeToString,
    ...
    def SigningInfo(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/cosmos.slashing.v1beta1.Query/SigningInfo',
            cosmos_dot_slashing_dot_v1beta1_dot_query__pb2.
            QuerySigningInfoRequest.SerializeToString,
            cosmos_dot_slashing_dot_v1beta1_dot_query__pb2.
            QuerySigningInfoResponse.FromString,
            options,
