...
class QueryStub:
    ...
    def __init__(self, channel):
        ...
        self.Params = channel.unary_unary(
            ...
            response_deserializer=cosmos_dot_mint_dot_v1beta1_dot_query__pb2.
...
def add_QueryServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        grpc.unary_unary_rpc_method_handler(
            servicer.Params,
            request_deserializer=cosmos_dot_mint_dot_v1beta1_dot_query__pb2.
            QueryParamsRequest.FromString,
            response_serializer=cosmos_dot_mint_dot_v1beta1_dot_query__pb2.
        ...
        grpc.unary_unary_rpc_method_handler(
            servicer.Inflation,
            request_deserializer=cosmos_dot_mint_dot_v1beta1_dot_query__pb2.
            QueryInflationRequest.FromString,
            response_serializer=cosmos_dot_mint_dot_v1beta1_dot_query__pb2.
            QueryInflationResponse.SerializeToString,
        ),
        'AnnualProvisions':
        grpc.unary_unary_rpc_method_handler(
            servicer.AnnualProvisions,
            request_deserializer=cosmos_dot_mint_dot_v1beta1_dot_query__pb2.
            QueryAnnualProvisionsRequest.FromString,
            response_serializer=cosmos_dot_mint_dot_v1beta1_dot_query__pb2.
...
class Query:
    ...
    def Params(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/cosmos.mint.v1beta1.Query/Params',
            cosmos_dot_mint_dot_v1beta1_dot_query__pb2.QueryParamsRequest.
            SerializeToString,
            cosmos_dot_mint_dot_v1beta1_dot_query__pb2.QueryParamsResponse.
            FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def Inflation(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/cosmos.mint.v1beta1.Query/Inflation',
            cosmos_dot_mint_dot_v1beta1_dot_query__pb2.QueryInflationRequest.
            SerializeToString,
            cosmos_dot_mint_dot_v1beta1_dot_query__pb2.QueryInflationResponse.
            FromString,
            options,
            channel_credentials,
            insecure,
