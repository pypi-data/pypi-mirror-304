...
class QueryStub:
    ...
    def __init__(self, channel):
        ...
        self.Allowance = channel.unary_unary(
            ...
            request_serializer=cosmos_dot_feegrant_dot_v1beta1_dot_query__pb2.
            QueryAllowanceRequest.SerializeToString,
            response_deserializer=cosmos_dot_feegrant_dot_v1beta1_dot_query__pb2
...
def add_QueryServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        grpc.unary_unary_rpc_method_handler(
            servicer.Allowance,
            request_deserializer=cosmos_dot_feegrant_dot_v1beta1_dot_query__pb2
            .QueryAllowanceRequest.FromString,
        ...
        grpc.unary_unary_rpc_method_handler(
            servicer.Allowances,
            request_deserializer=cosmos_dot_feegrant_dot_v1beta1_dot_query__pb2
            .QueryAllowancesRequest.FromString,
            response_serializer=cosmos_dot_feegrant_dot_v1beta1_dot_query__pb2.
...
class Query:
    ...
    def Allowance(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/cosmos.feegrant.v1beta1.Query/Allowance',
            cosmos_dot_feegrant_dot_v1beta1_dot_query__pb2.
            QueryAllowanceRequest.SerializeToString,
            cosmos_dot_feegrant_dot_v1beta1_dot_query__pb2.
            QueryAllowanceResponse.FromString,
            options,
