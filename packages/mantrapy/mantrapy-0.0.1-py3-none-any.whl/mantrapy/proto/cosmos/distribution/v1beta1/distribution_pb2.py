...
_VALIDATORHISTORICALREWARDS = DESCRIPTOR.message_types_by_name[
    'ValidatorHistoricalRewards'
]
_VALIDATORCURRENTREWARDS = DESCRIPTOR.message_types_by_name[
    'ValidatorCurrentRewards'
]
_VALIDATORACCUMULATEDCOMMISSION = DESCRIPTOR.message_types_by_name[
    'ValidatorAccumulatedCommission'
]
_VALIDATOROUTSTANDINGREWARDS = DESCRIPTOR.message_types_by_name[
    'ValidatorOutstandingRewards'
]
_VALIDATORSLASHEVENT = DESCRIPTOR.message_types_by_name['ValidatorSlashEvent']
_VALIDATORSLASHEVENTS = DESCRIPTOR.message_types_by_name[
    'ValidatorSlashEvents'
]
_FEEPOOL = DESCRIPTOR.message_types_by_name['FeePool']
_COMMUNITYPOOLSPENDPROPOSAL = DESCRIPTOR.message_types_by_name[
    'CommunityPoolSpendProposal'
]
_DELEGATORSTARTINGINFO = DESCRIPTOR.message_types_by_name[
    'DelegatorStartingInfo'
]
_DELEGATIONDELEGATORREWARD = DESCRIPTOR.message_types_by_name[
    'DelegationDelegatorReward'
]
_COMMUNITYPOOLSPENDPROPOSALWITHDEPOSIT = DESCRIPTOR.message_types_by_name[
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _PARAMS.fields_by_name[
        'community_tax'
    ]._serialized_options = b'\362\336\037\024yaml:\"community_tax\"\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\310\336\037\000'
    ...
    _VALIDATOROUTSTANDINGREWARDS.fields_by_name[
        'rewards'
    ]._serialized_options = b'\362\336\037\016yaml:\"rewards\"\252\337\037+github.com/cosmos/cosmos-sdk/types.DecCoins\310\336\037\000'
    ...
    _DELEGATORSTARTINGINFO.fields_by_name[
        'stake'
    ]._serialized_options = b'\362\336\037\014yaml:\"stake\"\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\310\336\037\000'
