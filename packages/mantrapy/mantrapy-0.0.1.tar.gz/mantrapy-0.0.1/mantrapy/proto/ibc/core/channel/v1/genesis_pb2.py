...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GENESISSTATE.fields_by_name[
        'channels'
    ]._serialized_options = b'\372\336\037\021IdentifiedChannel\310\336\037\000'
    ...
    _GENESISSTATE.fields_by_name[
        'send_sequences'
    ]._serialized_options = b'\310\336\037\000\362\336\037\025yaml:\"send_sequences\"'
    _GENESISSTATE.fields_by_name['recv_sequences']._options = None
    _GENESISSTATE.fields_by_name[
        'recv_sequences'
    ]._serialized_options = b'\310\336\037\000\362\336\037\025yaml:\"recv_sequences\"'
    _GENESISSTATE.fields_by_name['ack_sequences']._options = None
    _GENESISSTATE.fields_by_name[
        'ack_sequences'
    ]._serialized_options = b'\310\336\037\000\362\336\037\024yaml:\"ack_sequences\"'
    _GENESISSTATE.fields_by_name['next_channel_sequence']._options = None
    _GENESISSTATE.fields_by_name[
        'next_channel_sequence'
    ]._serialized_options = b'\362\336\037\034yaml:\"next_channel_sequence\"'
    _PACKETSEQUENCE.fields_by_name['port_id']._options = None
    _PACKETSEQUENCE.fields_by_name[
        'port_id'
