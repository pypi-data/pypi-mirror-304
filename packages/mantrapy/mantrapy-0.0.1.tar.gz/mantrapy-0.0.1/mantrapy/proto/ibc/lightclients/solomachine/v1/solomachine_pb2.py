...
_TIMESTAMPEDSIGNATUREDATA = DESCRIPTOR.message_types_by_name[
...
_PACKETCOMMITMENTDATA = DESCRIPTOR.message_types_by_name[
    'PacketCommitmentData'
]
_PACKETACKNOWLEDGEMENTDATA = DESCRIPTOR.message_types_by_name[
    'PacketAcknowledgementData'
]
_PACKETRECEIPTABSENCEDATA = DESCRIPTOR.message_types_by_name[
    'PacketReceiptAbsenceData'
]
_NEXTSEQUENCERECVDATA = DESCRIPTOR.message_types_by_name[
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _CONSENSUSSTATE.fields_by_name[
        'public_key'
    ]._serialized_options = b'\362\336\037\021yaml:\"public_key\"'
    ...
    _HEADER.fields_by_name[
        'new_diversifier'
    ]._serialized_options = b'\362\336\037\026yaml:\"new_diversifier\"'
    _HEADER._options = None
    _HEADER._serialized_options = b'\210\240\037\000'
    _MISBEHAVIOUR.fields_by_name['client_id']._options = None
    _MISBEHAVIOUR.fields_by_name[
        'client_id'
    ]._serialized_options = b'\362\336\037\020yaml:\"client_id\"'
    _MISBEHAVIOUR.fields_by_name['signature_one']._options = None
    _MISBEHAVIOUR.fields_by_name[
        'signature_one'
    ]._serialized_options = b'\362\336\037\024yaml:\"signature_one\"'
    _MISBEHAVIOUR.fields_by_name['signature_two']._options = None
    _MISBEHAVIOUR.fields_by_name[
        'signature_two'
    ]._serialized_options = b'\362\336\037\024yaml:\"signature_two\"'
    ...
    _SIGNATUREANDDATA.fields_by_name[
        'data_type'
    ]._serialized_options = b'\362\336\037\020yaml:\"data_type\"'
    ...
    _TIMESTAMPEDSIGNATUREDATA.fields_by_name[
        'signature_data'
    ]._serialized_options = b'\362\336\037\025yaml:\"signature_data\"'
    ...
    _HEADERDATA.fields_by_name[
        'new_pub_key'
    ]._serialized_options = b'\362\336\037\022yaml:\"new_pub_key\"'
    ...
    _CLIENTSTATEDATA.fields_by_name[
        'client_state'
    ]._serialized_options = b'\362\336\037\023yaml:\"client_state\"'
    ...
    _NEXTSEQUENCERECVDATA.fields_by_name[
        'next_seq_recv'
    ]._serialized_options = b'\362\336\037\024yaml:\"next_seq_recv\"'
