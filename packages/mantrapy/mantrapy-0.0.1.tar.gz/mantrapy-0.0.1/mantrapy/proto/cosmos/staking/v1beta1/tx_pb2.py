...
_MSGCREATEVALIDATORRESPONSE = DESCRIPTOR.message_types_by_name[
    'MsgCreateValidatorResponse'
]
_MSGEDITVALIDATOR = DESCRIPTOR.message_types_by_name['MsgEditValidator']
_MSGEDITVALIDATORRESPONSE = DESCRIPTOR.message_types_by_name[
...
_MSGBEGINREDELEGATERESPONSE = DESCRIPTOR.message_types_by_name[
    'MsgBeginRedelegateResponse'
]
_MSGUNDELEGATE = DESCRIPTOR.message_types_by_name['MsgUndelegate']
_MSGUNDELEGATERESPONSE = DESCRIPTOR.message_types_by_name[
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MSGEDITVALIDATOR.fields_by_name[
        'commission_rate'
    ]._serialized_options = b'\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\362\336\037\026yaml:\"commission_rate\"'
    _MSGEDITVALIDATOR.fields_by_name['min_self_delegation']._options = None
    _MSGEDITVALIDATOR.fields_by_name[
        'min_self_delegation'
    ]._serialized_options = b'\332\336\037&github.com/cosmos/cosmos-sdk/types.Int\362\336\037\032yaml:\"min_self_delegation\"'
