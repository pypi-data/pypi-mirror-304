...
class QueryStub:
    ...
    def __init__(self, channel):
        ...
        self.CurrentPlan = channel.unary_unary(
            ...
            request_serializer=cosmos_dot_upgrade_dot_v1beta1_dot_query__pb2.
...
def add_QueryServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=cosmos_dot_upgrade_dot_v1beta1_dot_query__pb2.
            QueryCurrentPlanRequest.FromString,
            response_serializer=cosmos_dot_upgrade_dot_v1beta1_dot_query__pb2.
            QueryCurrentPlanResponse.SerializeToString,
        ),
        'AppliedPlan':
        grpc.unary_unary_rpc_method_handler(
            servicer.AppliedPlan,
            request_deserializer=cosmos_dot_upgrade_dot_v1beta1_dot_query__pb2.
            QueryAppliedPlanRequest.FromString,
            response_serializer=cosmos_dot_upgrade_dot_v1beta1_dot_query__pb2.
            QueryAppliedPlanResponse.SerializeToString,
        ),
        ...
        grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=cosmos_dot_upgrade_dot_v1beta1_dot_query__pb2.
            QueryModuleVersionsRequest.FromString,
            response_serializer=cosmos_dot_upgrade_dot_v1beta1_dot_query__pb2.
...
class Query:
    ...
    def CurrentPlan(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/cosmos.upgrade.v1beta1.Query/CurrentPlan',
            cosmos_dot_upgrade_dot_v1beta1_dot_query__pb2.
            QueryCurrentPlanRequest.SerializeToString,
            cosmos_dot_upgrade_dot_v1beta1_dot_query__pb2.
            QueryCurrentPlanResponse.FromString,
            options,
