...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _BASEACCOUNT.fields_by_name[
        'account_number'
    ]._serialized_options = b'\362\336\037\025yaml:\"account_number\"'
    ...
    _PARAMS.fields_by_name[
        'max_memo_characters'
    ]._serialized_options = b'\362\336\037\032yaml:\"max_memo_characters\"'
    _PARAMS.fields_by_name['tx_sig_limit']._options = None
    _PARAMS.fields_by_name[
        'tx_sig_limit'
    ]._serialized_options = b'\362\336\037\023yaml:\"tx_sig_limit\"'
