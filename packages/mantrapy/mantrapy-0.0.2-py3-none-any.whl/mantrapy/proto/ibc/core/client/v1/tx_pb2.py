...
_MSGCREATECLIENTRESPONSE = DESCRIPTOR.message_types_by_name[
    'MsgCreateClientResponse'
]
_MSGUPDATECLIENT = DESCRIPTOR.message_types_by_name['MsgUpdateClient']
_MSGUPDATECLIENTRESPONSE = DESCRIPTOR.message_types_by_name[
    'MsgUpdateClientResponse'
]
_MSGUPGRADECLIENT = DESCRIPTOR.message_types_by_name['MsgUpgradeClient']
_MSGUPGRADECLIENTRESPONSE = DESCRIPTOR.message_types_by_name[
    'MsgUpgradeClientResponse'
]
_MSGSUBMITMISBEHAVIOUR = DESCRIPTOR.message_types_by_name[
    'MsgSubmitMisbehaviour'
]
_MSGSUBMITMISBEHAVIOURRESPONSE = DESCRIPTOR.message_types_by_name[
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    ]._serialized_options = b'\362\336\037\033yaml:\"proof_upgrade_client\"'
    _MSGUPGRADECLIENT.fields_by_name[
        'proof_upgrade_consensus_state'
    ]._options = None
    _MSGUPGRADECLIENT.fields_by_name[
        'proof_upgrade_consensus_state'
    ]._serialized_options = b'\362\336\037$yaml:\"proof_upgrade_consensus_state\"'
