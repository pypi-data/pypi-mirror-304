...
class MsgStub:
    ...
    def __init__(self, channel):
        ...
        self.Transfer = channel.unary_unary(
            ...
            request_serializer=
            ibc_dot_applications_dot_transfer_dot_v1_dot_tx__pb2.MsgTransfer.
            SerializeToString,
            response_deserializer=
            ibc_dot_applications_dot_transfer_dot_v1_dot_tx__pb2.
...
def add_MsgServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=
            ibc_dot_applications_dot_transfer_dot_v1_dot_tx__pb2.
            MsgTransferResponse.SerializeToString,
        ),
    }
