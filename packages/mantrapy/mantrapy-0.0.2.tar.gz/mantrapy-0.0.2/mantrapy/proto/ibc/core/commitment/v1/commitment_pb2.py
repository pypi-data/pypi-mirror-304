...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MERKLEPREFIX.fields_by_name[
        'key_prefix'
    ]._serialized_options = b'\362\336\037\021yaml:\"key_prefix\"'
    _MERKLEPATH.fields_by_name['key_path']._options = None
    _MERKLEPATH.fields_by_name[
        'key_path'
    ]._serialized_options = b'\362\336\037\017yaml:\"key_path\"'
