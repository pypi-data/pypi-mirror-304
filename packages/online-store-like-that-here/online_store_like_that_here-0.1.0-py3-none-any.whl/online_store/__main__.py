from online_store import user_management
from online_store import order_management


user_manager = user_management.UserManager()   # Создай экземпляр класса управления учётными записями клиентов
order_manager = order_management.OrderManager()   # Создай экземпляр класса управления заказами
...
def order_menu():
    ...
    if choice == '1':
        ...
        order_manager.create_order(order_id, {item:price})
    elif choice == '2':
        order_id = input('Введите ID заказа: ')
