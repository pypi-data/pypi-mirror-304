...
from erc7730.model.context import BindingContext, Deployment
...
def get_deployments(descriptor: InputERC7730Descriptor) -> list[Deployment]:
    """Get deployments section for a descriptor."""
    return get_binding_context(descriptor).deployments


def get_binding_context(descriptor: InputERC7730Descriptor) -> BindingContext:
