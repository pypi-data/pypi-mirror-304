...
class ReadyDecorator:
    ...
    _always_check: tuple[Union[str, tuple[str, str]], ...] = ()
    ...
    @classproperty
    def always_check(cls) -> tuple[Union[str, tuple[str, str]], ...]:  # noqa: N805
        return cls._always_check

    @classmethod
    @typechecked
    def set_always_check(cls, value: tuple[Union[str, tuple[str, str]], ...]):
        """Changes :obj:`_always_check` to the given value."""
        cls._always_check = value

    @classmethod
    @typechecked
    def ready(cls, needed_attributes: tuple[Union[str, tuple[str, str]], ...]):
