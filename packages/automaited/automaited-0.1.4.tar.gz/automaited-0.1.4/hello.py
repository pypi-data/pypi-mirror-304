...
client = DocExtClient(API_KEY="TEST_BETA:denis.golovin@automaited.com", base_url="http://localhost:8197/api/external_devs") # Use this for now, prod API keys coming soon
