...
class DatabaseConnection:
    def __init__(self, service, environment=None, hostname=None, port=None, username=None, password=None, database=None, region=None, server=None, instance_connection_name=None, require_ssl=False):
        """
