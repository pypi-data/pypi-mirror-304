            ...
            if is_question:
                ...
                messages.append(
                    self._create_message_param(
                        "user",
                        "Can you solve or answer my question please with using your functions like `answer_subtask`?",
                    )
                )
                messages.append(
                    self._create_message_param(
                        ...
                        (
                            ...
                            "Also, I will use my functions like `answer_subtask` to solve or answer it to show my ability."
                            "</thinking>"
                            "<output>\n"
