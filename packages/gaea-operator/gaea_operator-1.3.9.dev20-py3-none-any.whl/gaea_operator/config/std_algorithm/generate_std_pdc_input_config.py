...
def main(args):
    ...
    check_ret = check_label_description(advanced_parameters["networkArchitecture"], 
                                        generate_config, label_description)
    ...
    label_description = label_description_reorder(advanced_parameters["networkArchitecture"], 
                                                  label_description, generate_config)
    ...
    paddle_framework = \
        generate_config['base_and_pretrain'][advanced_parameters["networkArchitecture"]]['paddle_framework']
