...
from gaea_operator.nodes import Image, Properties
...
def pipeline(accelerator: str = "T4",
    ...
    train = Train(config=config["nodes"][Train.name()], train_skip=train_skip, accelerator=train_accelerator)
    train.properties = Properties(images=name_to_images[train.name()])
    train_step = train(algorithm=config["pipeline"]["algorithm"],
    ...
    eval_step = eval(algorithm=config["pipeline"]["algorithm"],
                     base_params=base_params,
                     base_env=base_env,
    ...
    transform_step = transform(algorithm=config["pipeline"]["algorithm"],
                               base_params=base_params,
                               base_env=base_env,
    ...
    transform_eval_step = transform_eval(algorithm=config["pipeline"]["algorithm"],
                                         base_params=base_params,
                                         base_env=base_env,
    ...
    package_step = package(algorithm=config["pipeline"]["algorithm"],
                           base_params=base_params,
                           base_env=base_env,
                           transform_model_name=transform_eval_input_model_name,
    ...
    inference_step = inference(algorithm=config["pipeline"]["algorithm"],
                               base_params=base_params,
                               base_env=base_env,
