...
NAME_TO_IMAGES = {
    BaseTrain.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/acg_aiqp_algo/paddlecloud/ubuntu18.04:std-alg-yoloseg-dev13")
        ],
    BaseEval.name():
        [
            Image(kind=Accelerator.NVIDIA,
    ...
    BaseTransform.name():
        [
            ...
            Image(kind=Accelerator.KUNLUN,
                  name="iregistry.baidu-int.com/windmill-public/transform:std-alg-dev401")
        ],
    BaseTransformEval.name():
        [
            ...
            Image(kind=Accelerator.KUNLUN,
                  name="iregistry.baidu-int.com/windmill-public/inference/kunlun:1.3.8-dev103")
        ],
    BasePackage.name():
        [
            Image(kind=Accelerator.NVIDIA,
