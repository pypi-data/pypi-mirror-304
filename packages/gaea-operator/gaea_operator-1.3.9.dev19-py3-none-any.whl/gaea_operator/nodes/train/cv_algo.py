...
def train(args):
    ...
    meta_data = _product_metadata(args, train_advanced_parameters, tracker_client, dataset.labels)
    ...
    response = windmill_client.create_model(workspace_id=workspace_id,
                                            ...
                                            category=category,
                                            model_formats=args.model_formats,
...
def _product_metadata(args, train_advanced_parameters, tracker_client, labels):
    """
    create metadata
    """
