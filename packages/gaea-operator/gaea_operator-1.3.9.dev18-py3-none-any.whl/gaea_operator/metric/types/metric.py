...
class AnnotationRatioMetricResult(BaseModel):
    ...
    """
    labelName: Optional[str] = None
    imageCount: Optional[Union[int, LabelMetricResult]] = None
    annotatedImageCount: Optional[Union[int, LabelMetricResult]] = None
    ratio: Optional[Union[float, LabelMetricResult]] = None
