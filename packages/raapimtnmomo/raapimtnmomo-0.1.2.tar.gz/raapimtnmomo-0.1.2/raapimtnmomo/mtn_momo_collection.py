...
class MTNMoMoCollection(MTNMoMo):
    ...
    def create_transaction(self, params, custom_params=None) -> dict:
        """
    ...
    def get_transaction(self, x_reference_id) -> dict:
        """
    ...
    def get_account_balance(self, currency=None) -> dict:
        """
    ...
    def get_basic_user_info(self, number_momo) -> dict:
        """
