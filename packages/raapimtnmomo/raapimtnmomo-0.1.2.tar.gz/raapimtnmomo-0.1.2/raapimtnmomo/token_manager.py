...
class TokenManager:
    ...
    def get_token(self, config, product) -> str:
        """
    ...
    def is_token_valid(self, token_data) -> bool:
        """
    ...
    def fetch_new_token(self, config, product) -> dict:
        """
    ...
    def save_token(self, token_data) -> None:
        """
    ...
    def load_token(self) -> Union[dict, None]:
        """
