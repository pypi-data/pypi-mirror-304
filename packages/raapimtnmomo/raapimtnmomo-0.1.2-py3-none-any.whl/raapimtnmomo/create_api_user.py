import argparse
from .sandbox_user_provisioning import SandboxUserProvisioning
...
def main():
    ...
    print('Creating API and API Key Secrete user with the following details:')
    ...
    try:
        ...
        result = user.create()
        print("API User and API Key Secrete created successfully.")
