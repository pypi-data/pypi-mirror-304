...
class LogHandler:
    def __init__(self, ak=None, sk=None, server=None, bucket_name=None):
        ...
        """
        self.ak = ak if ak else "CHRZSAE9JCAZCZRVQNNT"
        self.sk = sk if sk else "Q2lFSm4QAxUiWtQHEIK0bTU5jURc8dvi27rVHv1u"
        self.server = server if server else "obs.cn-east-3.myhuaweicloud.com"
        self.bucket_name = bucket_name if bucket_name else "xmzsdk"
...
#     additional_data = {"user": "example_user", "action": "example_action"}
#     sdk_name = "example_sdk"
#     log_handler.process_log(additional_data, sdk_name)
