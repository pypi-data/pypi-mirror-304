...
class MTService:
    ...
    def file_translation(self, url, file_type, lang_from, lang_to):
        ...
        try:
            ...
            log.process_log(response.to_dict(), "文档翻译")
    ...
    def get_file_translation_result(self, job_id):
        ...
        try:
            ...
            log.process_log(response.to_dict(), "获取文档翻译结果")
            return response.to_dict()
        except exceptions.ClientRequestException as e:
            print(e)
            return None
    ...
    def language_detection(self, text):
        ...
        try:
            ...
            log.process_log(response.to_dict(), "语种检测")
            return response.to_dict()
        except exceptions.ClientRequestException as e:
            print(e)
            return None
    ...
    def text_translation(self, text, lang_from, lang_to, scene="common"):
        ...
        try:
            ...
            log.process_log(response.to_dict(), "文本翻译")
            return response.to_dict()
        except exceptions.ClientRequestException as e:
            print(e)
            return None
