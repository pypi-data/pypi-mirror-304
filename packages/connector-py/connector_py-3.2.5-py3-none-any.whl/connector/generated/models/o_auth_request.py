...
class OAuthRequest(BaseModel):
    ...
    def data_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['FORMDATA', 'QUERY', 'JSON']):
            raise ValueError("must be one of enum values ('FORMDATA', 'QUERY', 'JSON')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": obj.get("data") if obj.get("data") is not None else 'FORMDATA'
        })
        return _obj
