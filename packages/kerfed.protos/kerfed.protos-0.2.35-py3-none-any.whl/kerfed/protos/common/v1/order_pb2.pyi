...
class OrderState(google.protobuf.message.Message):
    ...
    @property
    def files(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___FileState]:
    ...
    def __init__(
        ...
        *,
        ...
        is_processing: builtins.bool = ...,
        is_paid: builtins.bool = ...,
        files: collections.abc.Iterable[global___FileState] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["events", b"events", "files", b"files", "is_paid", b"is_paid", "is_processing", b"is_processing"]) -> None: ...
