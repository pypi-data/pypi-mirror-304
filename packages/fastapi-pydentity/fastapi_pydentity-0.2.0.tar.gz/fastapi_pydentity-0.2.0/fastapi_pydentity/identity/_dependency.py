...
from fastapi_pydentity.authentication._dependency import IAuthenticationSchemeProviderDepends
...
from fastapi_pydentity.identity._options import IDENTITY_OPTIONS
...
def get_user_claim_principal_factory(
    ...
    return UserClaimsPrincipalFactory(user_manager, role_manager, options)
