...
class Command(BaseCommand):
    ...
    def create_file(self, app_path, file_name, source_file_name):
        ...
        importlib.resources.read_text(package_name, f'management/source_files.{source_file_name}')

        # Read the source content
        try:
            file_content = importlib.resources.read_text(package_name, f'management.source_files.{source_file_name}')
