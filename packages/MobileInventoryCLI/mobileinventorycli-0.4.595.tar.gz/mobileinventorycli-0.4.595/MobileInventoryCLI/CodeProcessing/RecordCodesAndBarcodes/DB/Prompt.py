...
{Fore.light_sea_green}'img-gen-bcd','bcd-img'{Fore.light_yellow}- generate a custom barcode img from input data possible output is selected from {barcode.PROVIDED_BARCODES}{Style.reset}
...
'''
                print(extra)
                continue
            elif cmd.lower() in ['img-gen','bcd-img']:
