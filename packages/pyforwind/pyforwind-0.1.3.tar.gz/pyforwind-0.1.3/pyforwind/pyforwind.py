...
class SWF:
    ...
    def logger(self):
        ...
        params = [
            self.L_int[0], self.L_int[1], self.L_int[2], self.sigma[0], self.sigma[1], 
            self.sigma[2], self.mu, self.V_hub, self.h_hub, self.H, self.T, self.range[1],
            self.dim[0], self.dim[1], self.n_comp, self.tilde_L, self.tilde_T, self.N_xi
        ]
        print(params)
        params_str = [
            'L_int_x', 'L_int_y', 'L_int_z', 'sigma_x', 'sigma_y', 'sigma_z', 'mu', 'V_hub', 'h_hub', 
