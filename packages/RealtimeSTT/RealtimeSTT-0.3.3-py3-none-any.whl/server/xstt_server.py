...
async def send_to_client(message):
    ...
    if client_websocket and client_websocket.open:
        try:
            ...
            client_websocket = None  # Reset client on any exception
    else:
...
def on_recording_start():
    ...
    try:
        ...
        print(f"Error in on_recording_start while sending to client: {e}")
...
def on_recording_stop():
    ...
    try:
        ...
        print(f"Error in on_recording_stop while sending to client: {e}")

def on_vad_detect_start():
    # Send a message to the client when VAD starts
    try:
        asyncio.new_event_loop().run_until_complete(
            send_to_client(
                json.dumps({
        ...
        print(f"Error in on_vad_detect_start while sending to client: {e}")
...
def on_wakeword_detection_start():
    ...
    try:
        ...
        print(f"Error in on_wakeword_detection_start while sending to client: {e}")
...
def on_wakeword_detection_end():
    ...
    try:
        ...
        print(f"Error in on_wakeword_detection_end while sending to client: {e}")
...
def on_transcription_start():
    ...
    try:
        ...
        print(f"Error in on_transcription_start while sending to client: {e}")
...
def on_realtime_transcription_update(text):
    ...
    try:
        ...
        print(f"Error in on_realtime_transcription_update while sending to client: {e}")
