...
class AudioToTextRecorderClient:
    ...
    def __init__(self,
        ...
        def signal_handler(sig, frame):
            print("CTRL+C detected, stopping the recorder...")
    ...
    def text(self, on_transcription_finished=None):
        ...
        try:
            total_wait_time = 0
            wait_interval = 0.1  # Wait in small intervals, e.g., 100ms
    ...
    #         if not self.final_text_ready.wait(timeout=60):
    #             print("Timeout while waiting for text to the server.")
    #             self.recording_start.clear()
    #             if on_transcription_finished:
