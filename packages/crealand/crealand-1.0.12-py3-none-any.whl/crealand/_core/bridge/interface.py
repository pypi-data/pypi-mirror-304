...
# call API
def _call_api(dest: Literal['web-ide', 'unity'], func_name: str, func_args: list):
...
def _call_api_async(dest: Literal['web-ide', 'unity'], func_name: str, func_args: list, callback=None):
