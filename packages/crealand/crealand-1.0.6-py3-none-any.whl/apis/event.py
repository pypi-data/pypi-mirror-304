...
from crealand.utils.logger_setup import setup_logger
from crealand.apis.constants import KeyboardType, KeyActiveType, KeyboardActiveType, MouseKeyType
...
def subscribeEvent(dest, func_name, func_args, callback):
    ...
    return call_api_async(dest, func_name, func_args, eventCallback)
