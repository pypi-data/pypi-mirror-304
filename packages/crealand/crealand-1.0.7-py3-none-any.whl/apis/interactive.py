from crealand.core.bridge.interface import call_api_async, call_api
from crealand.apis.constants import (
    DestType,
    ResultType,
    ToastPosition,
    ToastState,
...
class Dialogue:
    ...
    #     result = call_api('web-ide', "checkDialogOption", [opt_name])
    #     return True

    # 立绘对话选项 显示
    @staticmethod
    def set_option_show(is_show: bool = True):
        result = call_api('web-ide', "api.toggleDialogOptions", [{"show": is_show}])
        return result
    #  立绘对话 显示
    @staticmethod
