...
class Gravity:
    ...
    def add_sensor(sensor: str, area_id: int) ->None:
        ...
        call_api('unity','unity.sensor.attachGravity',[area_id])
    ...
    def set_gravity( runtime_id: str, gravity_value: int):
        ...
        call_api('unity','unity.sensor.setGravity',[runtime_id,gravity_value])

    # 获取重力值
    @staticmethod
    def get_gravity_value( sensor: str):
        runtime_id = Gravity.get_sensor(sensor) 
        value= call_api('unity','unity.sensor.getGravity',[runtime_id])
        return value
