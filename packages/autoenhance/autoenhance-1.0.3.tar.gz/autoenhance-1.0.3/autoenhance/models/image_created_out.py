...
class ImageCreatedOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ai_version", "brightness_boost", "brightness_boost_external", "brightness_boost_internal", "clarity_level", "cloud_type", "contrast_boost", "contrast_boost_external", "contrast_boost_internal", "date_added", "denoise_level", "downloaded", "enhance", "enhance_type", "image_id", "image_name", "image_type", "is_threesixty", "lens_correction", "metadata", "order_id", "privacy", "rating", "s3PutObjectUrl", "saturation_level", "scene", "sharpen_level", "sky_replacement", "status", "status_reason", "user_id", "vertical_correction", "window_pull"]
