...
class OrdersApi:
    ...
    def merge_hdr(
        self,
        id: StrictStr,
        order_hdr_merge: Optional[OrderHDRMerge] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: str
        :param order_hdr_merge:
        :type order_hdr_merge: OrderHDRMerge
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._merge_hdr_serialize(
            id=id,
            order_hdr_merge=order_hdr_merge,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def merge_hdr_without_preload_content(
        self,
        id: StrictStr,
        order_hdr_merge: Optional[OrderHDRMerge] = None,
        _request_timeout: Union[
    ...
    def _merge_hdr_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if order_hdr_merge is not None:
            _body_params = order_hdr_merge
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v3/orders/{id}/merge',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
