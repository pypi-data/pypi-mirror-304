...
class ImagesApi:
    ...
    def create_image(
        self,
        image_in: Optional[ImageIn] = None,
    ...
    def _download_enhanced_image_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/images/{id}/enhanced',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def report_image(
        self,
        id: StrictStr,
        report_in: Optional[ReportIn] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    def report_image_with_http_info(
        self,
        id: StrictStr,
        report_in: Optional[ReportIn] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def report_image_without_preload_content(
        self,
        id: StrictStr,
        report_in: Optional[ReportIn] = None,
        _request_timeout: Union[
    ...
    def _report_image_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v3/images/{id}/report',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def v3_images_id_process_post(
        self,
        id: StrictStr,
        image_in_update: Optional[ImageInUpdate] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: str
        :param image_in_update:
        :type image_in_update: ImageInUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._v3_images_id_process_post_serialize(
            id=id,
            image_in_update=image_in_update,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def v3_images_id_process_post_with_http_info(
        self,
        id: StrictStr,
        image_in_update: Optional[ImageInUpdate] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def v3_images_id_process_post_without_preload_content(
        self,
        id: StrictStr,
        image_in_update: Optional[ImageInUpdate] = None,
        _request_timeout: Union[
    ...
    def _v3_images_id_process_post_serialize(
        self,
        id,
        image_in_update,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if image_in_update is not None:
            _body_params = image_in_update
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v3/images/{id}/process',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
