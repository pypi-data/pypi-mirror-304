...
def encode(encoder: Callable[[Any, Any, Any, _A], IEncodable], obj: Any) -> IEncodable:
    ...
    oa_table: Any = Dictionary([], ObjectExpr3153())
    class ObjectExpr3154:
        @property
    ...
    cell_table: Any = Dictionary([], ObjectExpr3154())
...
def decode(decoder: Callable[[Array[str], Array[OntologyAnnotation], Array[CompositeCell]], __A]) -> Decoder_1[Any]:
    def _arrow3157(get: IGetters, decoder: Any=decoder) -> __B:
        ...
        def _arrow3156(__unit: None=None) -> Array[CompositeCell]:
