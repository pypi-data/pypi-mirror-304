...
class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        def _arrow441(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr440(IRequiredGetter):
            ...
            return ObjectExpr440()

        self.required: IRequiredGetter = _arrow441()
        def _arrow443(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr442(IOptionalGetter):
        ...
        self.optional: IOptionalGetter = _arrow443()
        def _arrow448(__unit: None=None) -> IMultipleOptionalGetter:
            _this_2: Any = self
        ...
        self.multiple_optional: IMultipleOptionalGetter = _arrow448()
        def _arrow450(__unit: None=None) -> IOverflowGetter:
            _this_3: Any = self
            class ObjectExpr449(IOverflowGetter):
            ...
            return ObjectExpr449()

        self.overflow: IOverflowGetter = _arrow450()
