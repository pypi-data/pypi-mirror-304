...
class IOType(Union):
    ...
    def as_input(self, __unit: None=None) -> str:
        ...
        def string_create(x: Any | None=None) -> str:
            def _arrow714(__unit: None=None, x: Any=x) -> str:
                copy_of_struct: __A = x
                return to_string(copy_of_struct)

            return ("Input [" + _arrow714()) + "]"
...
IOType_reflection = _expr716

def _expr718() -> TypeInfo:
...
CompositeHeader_reflection = _expr718
