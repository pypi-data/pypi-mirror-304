...
def _arrow1988(get: IGetters) -> Publication:
    ...
    def _arrow1987(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = resize_array(decoder_2)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Publication(_arrow1982(), _arrow1983(), _arrow1984(), _arrow1985(), _arrow1986(), _arrow1987())


decoder: Decoder_1[Publication] = object(_arrow1988)
...
def ROCrate_encoder(oa: Publication) -> IEncodable:
    ...
    def _arrow1992(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1995(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1997(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1998(author_list: str, oa: Any=oa) -> IEncodable:
        return ROCrate_encodeAuthorListString(author_list)

    def _arrow2000(value_6: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2001(oa_1: OntologyAnnotation, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2002(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoderDisambiguatingDescription(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1992()), ("@type", ObjectExpr1993()), try_include("pubMedID", _arrow1995, oa.PubMedID), try_include("doi", _arrow1997, oa.DOI), try_include("authorList", _arrow1998, oa.Authors), try_include("title", _arrow2000, oa.Title), try_include("status", _arrow2001, oa.Status), try_include_seq("comments", _arrow2002, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2018(get: IGetters) -> Publication:
    ...
    def _arrow2016(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_4: IOptionalGetter = get.Optional
    ...
    return Publication(_arrow2008(), _arrow2011(), _arrow2013(), _arrow2015(), _arrow2016(), _arrow2017())


ROCrate_decoder: Decoder_1[Publication] = object(_arrow2018)
...
def ISAJson_encoder(id_map: Any | None, oa: Publication) -> IEncodable:
    ...
    def _arrow2026(value: str, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("pubMedID", _arrow2026, oa.PubMedID), try_include("doi", _arrow2030, oa.DOI), try_include("authorList", _arrow2032, oa.Authors), try_include("title", _arrow2034, oa.Title), try_include("status", _arrow2035, oa.Status), try_include_seq("comments", _arrow2036, oa.Comments)]))
