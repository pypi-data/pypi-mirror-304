...
def _arrow2079(get: IGetters) -> Person:
    ...
    def _arrow2077(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow2078(__unit: None=None) -> Array[Comment] | None:
        arg_21: Decoder_1[Array[Comment]] = resize_array(decoder_1)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_21)

    return Person(_arrow2061(), _arrow2062(), _arrow2063(), _arrow2066(), _arrow2067(), _arrow2068(), _arrow2069(), _arrow2072(), _arrow2073(), _arrow2077(), _arrow2078())


decoder: Decoder_1[Person] = object(_arrow2079)
...
def ROCrate_Affiliation_encoder(affiliation: str) -> IEncodable:
    ...
    def _arrow2090(__unit: None=None, affiliation: Any=affiliation) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = of_array([("@type", ObjectExpr2088()), ("@id", _arrow2090()), ("name", ObjectExpr2091()), ("@context", context_jsonvalue)])
...
def _arrow2093(get: IGetters) -> str:
    object_arg: IRequiredGetter = get.Required
    return object_arg.Field("name", string)


ROCrate_Affiliation_decoder: Decoder_1[str] = object(_arrow2093)
...
def ROCrate_encoder(oa: Person) -> IEncodable:
    ...
    def _arrow2097(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2106(value_6: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2108(value_8: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2110(value_10: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2114(value_12: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2117(value_14: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2119(value_16: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2120(affiliation: str, oa: Any=oa) -> IEncodable:
        return ROCrate_Affiliation_encoder(affiliation)

    def _arrow2121(oa_1: OntologyAnnotation, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2122(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoderDisambiguatingDescription(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2097()), ("@type", ObjectExpr2098()), try_include("orcid", _arrow2100, oa.ORCID), try_include("firstName", _arrow2102, oa.FirstName), try_include("lastName", _arrow2106, oa.LastName), try_include("midInitials", _arrow2108, oa.MidInitials), try_include("email", _arrow2110, oa.EMail), try_include("phone", _arrow2114, oa.Phone), try_include("fax", _arrow2117, oa.Fax), try_include("address", _arrow2119, oa.Address), try_include("affiliation", _arrow2120, oa.Affiliation), try_include_seq("roles", _arrow2121, oa.Roles), try_include_seq("comments", _arrow2122, oa.Comments), ("@context", context_jsonvalue_1)]))
...
def _arrow2139(get: IGetters) -> Person:
    ...
    def _arrow2137(__unit: None=None) -> Array[OntologyAnnotation] | None:
        arg_19: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_ROCrate_decoderDefinedTerm)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("roles", arg_19)

    def _arrow2138(__unit: None=None) -> Array[Comment] | None:
        arg_21: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoderDisambiguatingDescription)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_21)

    return Person(_arrow2126(), _arrow2127(), _arrow2128(), _arrow2129(), _arrow2130(), _arrow2132(), _arrow2133(), _arrow2135(), _arrow2136(), _arrow2137(), _arrow2138())


ROCrate_decoder: Decoder_1[Person] = object(_arrow2139)
...
def ROCrate_encodeAuthorListString(author_list: str) -> IEncodable:
    def encode_single(name: str, author_list: Any=author_list) -> IEncodable:
        ...
        def _arrow2143(value_1: str, name: Any=name) -> IEncodable:
        ...
        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@type", ObjectExpr2141()), try_include("name", _arrow2143, name), ("@context", context_minimal_json_value)]))
...
def _arrow2147(get: IGetters) -> str:
    def _arrow2146(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("name", string)

    return default_arg(_arrow2146(), "")


ROCrate_decodeAuthorListString: Decoder_1[str] = map_3(ctor, array_3(object(_arrow2147)))
...
def ISAJson_encoder(id_map: Any | None, person: Person) -> IEncodable:
    def f(person_1: Person, id_map: Any=id_map, person: Any=person) -> IEncodable:
        ...
        def _arrow2151(value: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2153(value_2: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2155(value_4: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2157(value_6: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2159(value_8: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2161(value_10: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2166(value_14: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2169(value_16: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2170(oa: OntologyAnnotation, person_1: Any=person_1) -> IEncodable:
            return OntologyAnnotation_encoder(oa)

        def _arrow2171(comment: Comment, person_1: Any=person_1) -> IEncodable:
            return encoder_1(comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2151, ROCrate_genID(person_2)), try_include("firstName", _arrow2153, person_2.FirstName), try_include("lastName", _arrow2155, person_2.LastName), try_include("midInitials", _arrow2157, person_2.MidInitials), try_include("email", _arrow2159, person_2.EMail), try_include("phone", _arrow2161, person_2.Phone), try_include("fax", _arrow2163, person_2.Fax), try_include("address", _arrow2166, person_2.Address), try_include("affiliation", _arrow2169, person_2.Affiliation), try_include_seq("roles", _arrow2170, person_2.Roles), try_include_seq("comments", _arrow2171, person_2.Comments)]))
...
def _arrow2185(get: IGetters) -> Person:
    ...
    def _arrow2183(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    return Person_setOrcidFromComments(Person(None, _arrow2175(), _arrow2176(), _arrow2177(), _arrow2178(), _arrow2179(), _arrow2180(), _arrow2181(), _arrow2182(), _arrow2183(), _arrow2184()))


ISAJson_decoder: Decoder_1[Person] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2185)
