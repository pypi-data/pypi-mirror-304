...
def ROCrate_encoder(oa: Sample) -> IEncodable:
    ...
    def _arrow2350(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2358(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2359(x: IEncodable, oa: Any=oa) -> IEncodable:
        return x

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2350()), ("@type", list_1_2(singleton(ObjectExpr2353()))), try_include("name", _arrow2358, oa.Name), try_include_list("additionalProperties", _arrow2359, additional_properties), ("@context", context_jsonvalue)]))
...
class ObjectExpr2362(Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]]):
    def Decode(self, s: IDecoderHelpers_1[Any], json: Any) -> FSharpResult_2[tuple[MaterialAttributeValue | None, FactorValue | None], tuple[str, ErrorReason_1[__A_]]]:
        def _arrow2361(__unit: None=None) -> str:
        ...
        if (_arrow2361() if s.has_property("additionalType", json) else "") == "FactorValue":
...
ROCrate_additionalPropertyDecoder: Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]] = ObjectExpr2362()

def _arrow2366(get: IGetters) -> Sample:
    ...
    def _arrow2363(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("@id", Decode_uri)

    def _arrow2364(__unit: None=None) -> str | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("name", string)

    def _arrow2365(__unit: None=None) -> FSharpList[Source] | None:
        arg_7: Decoder_1[FSharpList[Source]] = list_1_3(ROCrate_decoder_3)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("derivesFrom", arg_7)

    return Sample(_arrow2363(), _arrow2364(), pattern_input[0], pattern_input[1], _arrow2365())


ROCrate_decoder: Decoder_1[Sample] = object(_arrow2366)
...
def ISAJson_encoder(id_map: Any | None, oa: Sample) -> IEncodable:
    def f(oa_1: Sample, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2370(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2372(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2373(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        def _arrow2374(fv: FactorValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, fv)

        def _arrow2375(oa_3: Source, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, oa_3)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2370, ROCrate_genID(oa_1)), try_include("name", _arrow2372, oa_1.Name), try_include_list_opt("characteristics", _arrow2373, oa_1.Characteristics), try_include_list_opt("factorValues", _arrow2374, oa_1.FactorValues), try_include_list_opt("derivesFrom", _arrow2375, oa_1.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2377(s_1: Sample, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2377, f, oa, id_map)
...
def _arrow2383(get: IGetters) -> Sample:
    def _arrow2378(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
    ...
    def _arrow2380(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    def _arrow2381(__unit: None=None) -> FSharpList[FactorValue] | None:
        arg_7: Decoder_1[FSharpList[FactorValue]] = list_1_3(ISAJson_decoder_2)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("factorValues", arg_7)

    def _arrow2382(__unit: None=None) -> FSharpList[Source] | None:
        arg_9: Decoder_1[FSharpList[Source]] = list_1_3(ISAJson_decoder_3)
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("derivesFrom", arg_9)

    return Sample(_arrow2378(), _arrow2379(), _arrow2380(), _arrow2381(), _arrow2382())


ISAJson_decoder: Decoder_1[Sample] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2383)
