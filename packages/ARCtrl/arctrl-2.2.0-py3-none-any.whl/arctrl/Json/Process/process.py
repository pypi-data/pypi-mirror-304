...
def ROCrate_encoder(study_name: str | None, assay_name: str | None, oa: Process) -> IEncodable:
    ...
    def _arrow2404(__unit: None=None, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2407(value_2: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2408(oa_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(study_name, assay_name, oa.Name, oa_1)

    def _arrow2409(author_list: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encodeAuthorListString(author_list)

    def _arrow2411(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2412(value_6: ProcessInput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_3(value_6)

    def _arrow2413(value_7: ProcessOutput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_4(value_7)

    def _arrow2414(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_5(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2404()), ("@type", list_1_1(singleton(ObjectExpr2405()))), try_include("name", _arrow2407, oa.Name), try_include("executesProtocol", _arrow2408, oa.ExecutesProtocol), try_include_list_opt("parameterValues", ROCrate_encoder_2, oa.ParameterValues), try_include("performer", _arrow2409, oa.Performer), try_include("date", _arrow2411, oa.Date), try_include_list_opt("inputs", _arrow2412, oa.Inputs), try_include_list_opt("outputs", _arrow2413, oa.Outputs), try_include_list_opt("comments", _arrow2414, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2429(get: IGetters) -> Process:
    ...
    def _arrow2419(__unit: None=None) -> Protocol | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("executesProtocol", ROCrate_decoder_1)

    def _arrow2421(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
    ...
    def _arrow2424(__unit: None=None) -> FSharpList[ProcessInput] | None:
    ...
    def _arrow2428(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(ROCrate_decoder_5)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Process(_arrow2417(), _arrow2418(), _arrow2419(), _arrow2421(), _arrow2422(), _arrow2423(), None, None, _arrow2424(), _arrow2426(), _arrow2428())


ROCrate_decoder: Decoder_1[Process] = object(_arrow2429)
...
def ISAJson_encoder(study_name: str | None, assay_name: str | None, id_map: Any | None, oa: Process) -> IEncodable:
    def f(oa_1: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2434(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2442(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2443(oa_4: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_4)

        def _arrow2444(oa_5: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_5)

        def _arrow2445(value_8: ProcessInput, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, value_8)

        def _arrow2446(value_9: ProcessOutput, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_4(id_map, value_9)

        def _arrow2447(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_5(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2434, ROCrate_genID(oa_1)), try_include("name", _arrow2436, oa_1.Name), try_include("executesProtocol", _arrow2437, oa_1.ExecutesProtocol), try_include_list_opt("parameterValues", _arrow2438, oa_1.ParameterValues), try_include("performer", _arrow2440, oa_1.Performer), try_include("date", _arrow2442, oa_1.Date), try_include("previousProcess", _arrow2443, oa_1.PreviousProcess), try_include("nextProcess", _arrow2444, oa_1.NextProcess), try_include_list_opt("inputs", _arrow2445, oa_1.Inputs), try_include_list_opt("outputs", _arrow2446, oa_1.Outputs), try_include_list_opt("comments", _arrow2447, oa_1.Comments)]))
    ...
    if id_map is not None:
        def _arrow2449(p: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(p)

        return encode(_arrow2449, f, oa, id_map)
...
def _arrow2462(__unit: None=None) -> Decoder_1[Process]:
    def decode(__unit: None=None) -> Decoder_1[Process]:
        def _arrow2461(get: IGetters) -> Process:
            ...
            def _arrow2452(__unit: None=None) -> Protocol | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("executesProtocol", ISAJson_decoder_1)

            def _arrow2453(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
