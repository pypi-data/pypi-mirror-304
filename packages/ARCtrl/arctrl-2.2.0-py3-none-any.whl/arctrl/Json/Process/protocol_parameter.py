...
def encoder(id_map: Any | None, value: ProtocolParameter) -> IEncodable:
    def f(value_1: ProtocolParameter, id_map: Any=id_map, value: Any=value) -> IEncodable:
        ...
        def _arrow2112(value_2: str, value_1: Any=value_1) -> IEncodable:
        ...
        def _arrow2115(oa: OntologyAnnotation, value_1: Any=value_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2112, gen_id(value_1)), try_include("parameterName", _arrow2115, value_1.ParameterName)]))
    ...
    if id_map is not None:
        def _arrow2125(p_1: ProtocolParameter, id_map: Any=id_map, value: Any=value) -> str:
            return gen_id(p_1)

        return encode(_arrow2125, f, value, id_map)
...
def _arrow2134(get: IGetters) -> ProtocolParameter:
    def _arrow2131(__unit: None=None) -> OntologyAnnotation | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("parameterName", OntologyAnnotation_ISAJson_decoder)

    return ProtocolParameter(None, _arrow2131())


decoder: Decoder_1[ProtocolParameter] = object(_arrow2134)
