...
def _arrow1415(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1401()), ("additionalType", ObjectExpr1402()), ("alternateName", ObjectExpr1403()), ("measurementMethod", ObjectExpr1404()), ("description", ObjectExpr1406()), ("category", ObjectExpr1407()), ("categoryCode", ObjectExpr1408()), ("value", ObjectExpr1409()), ("valueCode", ObjectExpr1410()), ("unit", ObjectExpr1411()), ("unitCode", ObjectExpr1412()), ("comments", ObjectExpr1413())])
    ...
    return ObjectExpr1414()


context_jsonvalue: IEncodable = _arrow1415()
