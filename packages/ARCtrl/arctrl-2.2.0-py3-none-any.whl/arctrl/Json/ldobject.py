...
def generic_encoder(obj: Any=None) -> IEncodable:
    if str(type(obj)) == "<class \'str\'>":
        ...
        def _arrow2892(__unit: None=None, obj: Any=obj) -> IEnumerable_1[IEncodable]:
            def _arrow2888(__unit: None=None) -> IEnumerator[Any]:
                return get_enumerator(obj)

            def _arrow2890(enumerator: IEnumerator[Any]) -> bool:
                return enumerator.System_Collections_IEnumerator_MoveNext()

            def _arrow2891(enumerator_1: IEnumerator[Any]) -> Any:
                return enumerator_1.System_Collections_IEnumerator_get_Current()

            return map(generic_encoder, enumerate_from_functions(_arrow2888, _arrow2890, _arrow2891))

        return list_1(to_list(delay(_arrow2892)))
...
def encoder(obj: LDObject) -> IEncodable:
    ...
    def _arrow2905(__unit: None=None, obj: Any=obj) -> IEnumerable_1[tuple[str, IEncodable]]:
        def _arrow2895(__unit: None=None) -> IEncodable:
            value: str = obj.Id
        ...
        def _arrow2904(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
            def _arrow2899(__unit: None=None) -> IEncodable:
            ...
            def _arrow2903(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                def _arrow2902(__unit: None=None) -> IEncodable:
                ...
                return singleton(("additionalType", _arrow2902())) if (obj.AdditionalType is not None) else empty()

            return append(singleton(("@type", _arrow2899())), delay(_arrow2903))

        return append(singleton(("@id", _arrow2895())), delay(_arrow2904))

    values = append(to_list(delay(_arrow2905)), source_2)
    class ObjectExpr2910(IEncodable):
        def Encode(self, helpers_3: IEncoderHelpers_1[Any], obj: Any=obj) -> Any:
...
def get_decoder(expect_object: bool) -> Decoder_1[Any]:
    def decode(expect_object_1: bool, expect_object: Any=expect_object) -> Decoder_1[Any]:
        class ObjectExpr2926(Decoder_1[LDObject]):
            def Decode(self, helpers: IDecoderHelpers_1[Any], value: Any, expect_object_1: Any=expect_object_1) -> FSharpResult_2[LDObject, tuple[str, ErrorReason_1[__A_]]]:
                if helpers.is_object(value):
                    ...
                    def _arrow2917(__unit: None=None) -> str:
                        object_arg_1: IRequiredGetter = get.Required
                        return object_arg_1.Field("@id", string)

                    o: LDObject = LDObject(_arrow2917(), t)
        ...
        decode_object: Decoder_1[LDObject] = ObjectExpr2926()
        class ObjectExpr2934(Decoder_1[Array[Any]]):
                    ...
                    def folder(acc: FSharpResult_2[Array[Any], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[Array[Any], tuple[str, ErrorReason_1[__A_]]]:
                        ...
                        if acc.tag == 0:
                            ...
                            if match_value_1.tag == 0:
                                ...
                                def _arrow2931(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                ...
                                return FSharpResult_2(1, _arrow2931())
        ...
        resize_array: Decoder_1[Array[Any]] = ObjectExpr2934()
        if expect_object_1:
            def _arrow2936(value_4: LDObject, expect_object_1: Any=expect_object_1) -> Any:
                return value_4

            return map_1(_arrow2936, decode_object)

        else: 
            def _arrow2938(value_5: LDObject, expect_object_1: Any=expect_object_1) -> Any:
                return value_5

            def _arrow2939(value_6: Array[Any], expect_object_1: Any=expect_object_1) -> Any:
                return value_6

            def _arrow2940(value_7: str, expect_object_1: Any=expect_object_1) -> Any:
                return value_7

            def _arrow2941(value_8: int, expect_object_1: Any=expect_object_1) -> Any:
                return value_8

            def _arrow2942(value_9: Decimal, expect_object_1: Any=expect_object_1) -> Any:
                return value_9

            return one_of(of_array([map_1(_arrow2938, decode_object), map_1(_arrow2939, resize_array), map_1(_arrow2940, string), map_1(_arrow2941, int_1), map_1(_arrow2942, decimal)]))


    return decode(expect_object)


def _arrow2944(value: Any=None) -> LDObject:
    return value


decoder: Decoder_1[LDObject] = map_1(_arrow2944, get_decoder(True))
