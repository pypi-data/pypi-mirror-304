...
def encoder(isa: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2852(value: str, isa: Any=isa) -> IEncodable:
    ...
    def _arrow2854(value_2: str, isa: Any=isa) -> IEncodable:
    ...
    def _arrow2855(oa: ArcInvestigation, isa: Any=isa) -> IEncodable:
        return ROCrate_encoder(oa)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@type", _arrow2852, "CreativeWork"), try_include("@id", _arrow2854, "ro-crate-metadata.json"), try_include("about", _arrow2855, isa), ("conformsTo", conforms_to_jsonvalue), ("@context", context_jsonvalue)]))
...
def _arrow2857(get: IGetters) -> ArcInvestigation | None:
    object_arg: IOptionalGetter = get.Optional
    return object_arg.Field("about", ROCrate_decoder)


decoder: Decoder_1[ArcInvestigation | None] = object(_arrow2857)
