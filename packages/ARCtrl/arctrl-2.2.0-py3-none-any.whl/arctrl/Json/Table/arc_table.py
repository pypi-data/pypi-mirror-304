...
def encoder(table: ArcTable) -> IEncodable:
    def _arrow2508(__unit: None=None, table: Any=table) -> IEnumerable_1[tuple[str, IEncodable]]:
        def _arrow2493(__unit: None=None) -> IEncodable:
        ...
        def _arrow2507(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
            def _arrow2494(__unit: None=None) -> IEnumerable_1[IEncodable]:
            ...
            def _arrow2506(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                def key_encoder(tupled_arg: tuple[int, int]) -> IEncodable:
                    def _arrow2497(value: int, tupled_arg: Any=tupled_arg) -> IEncodable:
                    ...
                    return tuple2(_arrow2497, _arrow2501, tupled_arg[0], tupled_arg[1])
                ...
                class ObjectExpr2505:
                    @property
                    def Compare(self) -> Callable[[tuple[int, int], tuple[int, int]], int]:
                        return compare_arrays

                return singleton(("values", map_1(key_encoder, encoder_2, of_seq(to_list(delay(_arrow2503)), ObjectExpr2505())))) if (len(table.Values) != 0) else empty()

            return append(singleton(("header", list_1(to_list(delay(_arrow2494))))) if (len(table.Headers) != 0) else empty(), delay(_arrow2506))

        return append(singleton(("name", _arrow2493())), delay(_arrow2507))

    values: IEnumerable_1[tuple[str, IEncodable]] = to_list(delay(_arrow2508))
...
def _arrow2521(get: IGetters) -> ArcTable:
    def _arrow2512(__unit: None=None) -> FSharpList[CompositeHeader] | None:
        arg_1: Decoder_1[FSharpList[CompositeHeader]] = list_1_1(decoder_1)
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("header", arg_1)

    decoded_header: Array[CompositeHeader] = list(default_arg(_arrow2512(), empty_1()))
    ...
    def _arrow2520(__unit: None=None) -> str:
        object_arg_2: IRequiredGetter = get.Required
        return object_arg_2.Field("name", string)

    return ArcTable.create(_arrow2520(), decoded_header, decoded_values)


decoder: Decoder_1[ArcTable] = object(_arrow2521)
...
def encoder_compressed_column(column_index: int, row_count: int, cell_table: Any, table: ArcTable) -> IEncodable:
    if True if table.Headers[column_index].IsIOType else (row_count < 100):
        def _arrow2525(__unit: None=None, column_index: Any=column_index, row_count: Any=row_count, cell_table: Any=cell_table, table: Any=table) -> IEnumerable_1[IEncodable]:
            def _arrow2524(r: int) -> IEncodable:
                return encode_cell(cell_table, get_item_from_dict(table.Values, (column_index, r)))

            return map(_arrow2524, range_big_int(0, 1, row_count - 1))

        values: Array[IEncodable] = to_array(delay(_arrow2525))
        ...
        from_: int = 0
        def _arrow2543(__unit: None=None, column_index: Any=column_index, row_count: Any=row_count, cell_table: Any=cell_table, table: Any=table) -> IEnumerable_1[IEncodable]:
            def _arrow2535(i: int) -> IEnumerable_1[IEncodable]:
                next_1: CompositeCell = get_item_from_dict(table.Values, (column_index, i))
                def _arrow2533(__unit: None=None) -> IEncodable:
                ...
                def _arrow2534(__unit: None=None) -> IEnumerable_1[IEncodable]:
                    nonlocal current, from_
                    current = next_1
                    from_ = i or 0
                    return empty()

                return append(singleton(_arrow2533()), delay(_arrow2534)) if (not equals(next_1, current)) else empty()

            def _arrow2542(__unit: None=None) -> IEnumerable_1[IEncodable]:
                def _arrow2541(__unit: None=None) -> IEncodable:
                    ...
                    def _arrow2539(__unit: None=None) -> IEncodable:
                    ...
                    values_2: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("f", _arrow2537()), ("t", _arrow2539()), ("v", encode_cell(cell_table, current))])
                ...
                return singleton(_arrow2541())

            return append(collect(_arrow2535, range_big_int(1, 1, row_count - 1)), delay(_arrow2542))

        values_3: Array[IEncodable] = to_array(delay(_arrow2543))
...
def decoder_compressed_column(cell_table: Array[CompositeCell], table: ArcTable, column_index: int) -> Decoder_1[None]:
    class ObjectExpr2546(Decoder_1[None]):
        def Decode(self, helper: IDecoderHelpers_1[Any], column: Any, cell_table: Any=cell_table, table: Any=table, column_index: Any=column_index) -> FSharpResult_2[None, tuple[str, ErrorReason_1[__A_]]]:
            ...
            if match_value.tag == 1:
                def _arrow2545(get: IGetters) -> None:
                    from_: int
                ...
                range_decoder: Decoder_1[None] = object(_arrow2545)
...
def arrayi(decoderi: Callable[[int], Decoder_1[_VALUE]]) -> Decoder_1[Array[Any]]:
    class ObjectExpr2548(Decoder_1[Array[_VALUE_]]):
                ...
                def folder(acc: FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]], value_1: __A_) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
                    ...
                    if acc.tag == 0:
                        ...
                        if match_value.tag == 0:
                            ...
                            def _arrow2547(__unit: None=None, acc: Any=acc, value_1: Any=value_1) -> tuple[str, ErrorReason_1[__A_]]:
                            ...
                            return FSharpResult_2(1, _arrow2547())
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, table: ArcTable) -> IEncodable:
    def _arrow2555(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, table: Any=table) -> IEnumerable_1[tuple[str, IEncodable]]:
        def _arrow2554(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
            ...
            def _arrow2553(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                if len(table.Values) != 0:
                    ...
                    def _arrow2551(__unit: None=None) -> IEnumerable_1[IEncodable]:
                        def _arrow2550(c: int) -> IEncodable:
                            return encoder_compressed_column(c, row_count, cell_table, table)

                        return map(_arrow2550, range_big_int(0, 1, table.ColumnCount - 1))

                    columns: Array[IEncodable] = to_array(delay(_arrow2551))
                    ...
                    return singleton(("c", ObjectExpr2552()))

                else: 
                    return empty()


            return append(singleton(("h", list_1(to_list(delay(_arrow2549))))) if (len(table.Headers) != 0) else empty(), delay(_arrow2553))

        return append(singleton(("n", encode_string(string_table, table.Name))), delay(_arrow2554))

    values_1: IEnumerable_1[tuple[str, IEncodable]] = to_list(delay(_arrow2555))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcTable]:
    def _arrow2563(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcTable:
        def _arrow2557(__unit: None=None) -> FSharpList[CompositeHeader] | None:
            arg_1: Decoder_1[FSharpList[CompositeHeader]] = list_1_1(decoder_1)
            object_arg: IOptionalGetter = get.Optional
            return object_arg.Field("h", arg_1)

        decoded_header: Array[CompositeHeader] = list(default_arg(_arrow2557(), empty_1()))
        def _arrow2558(__unit: None=None) -> str:
            arg_3: Decoder_1[str] = decode_string(string_table)
            object_arg_1: IRequiredGetter = get.Required
            return object_arg_1.Field("n", arg_3)

        class ObjectExpr2559:
            @property
            def Equals(self) -> Callable[[tuple[int, int], tuple[int, int]], bool]:
                return equal_arrays
        ...
        table: ArcTable = ArcTable.create(_arrow2558(), decoded_header, Dictionary([], ObjectExpr2559()))
        def _arrow2561(__unit: None=None) -> Array[None] | None:
            def _arrow2560(column_index: int) -> Decoder_1[None]:
                return decoder_compressed_column(cell_table, table, column_index)

            arg_5: Decoder_1[Array[None]] = arrayi(_arrow2560)
