...
class ARC:
    ...
    def RemoveAssay(self, assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow3220(__unit: None=None) -> bool:
                ...
                return contains(assay_identifier, i.AssayIdentifiers, ObjectExpr3219())
        ...
        def _arrow3223(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3222(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow3221(__unit: None=None) -> IEnumerable_1[Contract]:
                    return map_1(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract, studies)

                return append(singleton(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(isa)), delay(_arrow3221))

            return append(singleton(ARCtrl_ArcAssay__ArcAssay_ToDeleteContract(assay)), delay(_arrow3222))

        return list(to_list(delay(_arrow3223)))
    ...
    def RenameAssay(self, old_assay_identifier: str, new_assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow3226(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr3225:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow3224(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(old_assay_identifier, i.AssayIdentifiers, ObjectExpr3225())
        ...
        def _arrow3228(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3227(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton(Contract.create_rename(old_assay_folder_path, new_assay_folder_path)), delay(_arrow3227))

        return list(to_list(delay(_arrow3228)))
    ...
    def RenameStudy(self, old_study_identifier: str, new_study_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow3231(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr3230:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow3229(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(old_study_identifier, i.StudyIdentifiers, ObjectExpr3230())
        ...
        renamed_paths: Array[str] = map(mapping, paths, None)
        this.SetFilePaths(renamed_paths)
        def _arrow3233(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3232(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton(Contract.create_rename(old_study_folder_path, new_study_folder_path)), delay(_arrow3232))

        return list(to_list(delay(_arrow3233)))
                        ...
                        def _arrow3239(__unit: None=None) -> IEnumerable_1[Contract]:
                            ...
                            if match_value_1 is not None:
                                if DataMap__get_StaticHash(match_value_1) == 0:
                                    ...
                                    def _arrow3238(__unit: None=None) -> bool:
                            ...
                            if pattern_matching_result == 0:
                                ...
                                return append(singleton(ARCtrl_DataMap__DataMap_ToCreateContractForStudy_Z721C83C5(dm_2, s.Identifier)), delay(_arrow3236))

                            elif pattern_matching_result == 1:
                                def _arrow3237(__unit: None=None) -> IEnumerable_1[Contract]:
                                    DataMap__set_StaticHash_Z524259A4(dm_3, safe_hash(dm_3))
                                    return empty()

                                return append(singleton(ARCtrl_DataMap__DataMap_ToUpdateContractForStudy_Z721C83C5(dm_3, s.Identifier)), delay(_arrow3237))

                            elif pattern_matching_result == 2:
                                return empty()


                        return append(ARCtrl_ArcStudy__ArcStudy_ToCreateContract_6FCE9E49(s, True) if (s.StaticHash == 0) else (singleton(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract(s)) if (s.StaticHash != hash_2) else empty()), delay(_arrow3239))

                    def _arrow3246(__unit: None=None) -> IEnumerable_1[Contract]:
                        def _arrow3245(a: ArcAssay) -> IEnumerable_1[Contract]:
                            ...
                            def _arrow3244(__unit: None=None) -> IEnumerable_1[Contract]:
                                ...
                                if match_value_2 is not None:
                                    if DataMap__get_StaticHash(match_value_2) == 0:
                                        ...
                                        def _arrow3243(__unit: None=None) -> bool:
                                ...
                                if pattern_matching_result_1 == 0:
                                    def _arrow3241(__unit: None=None) -> IEnumerable_1[Contract]:
                                        DataMap__set_StaticHash_Z524259A4(dm_6, safe_hash(dm_6))
                                        return empty()

                                    return append(singleton(ARCtrl_DataMap__DataMap_ToCreateContractForAssay_Z721C83C5(dm_6, a.Identifier)), delay(_arrow3241))
                                    ...
                                    return append(singleton(ARCtrl_DataMap__DataMap_ToUpdateContractForAssay_Z721C83C5(dm_7, a.Identifier)), delay(_arrow3242))

                                elif pattern_matching_result_1 == 2:
                                    return empty()


                            return append(ARCtrl_ArcAssay__ArcAssay_ToCreateContract_6FCE9E49(a, True) if (a.StaticHash == 0) else (singleton(ARCtrl_ArcAssay__ArcAssay_ToUpdateContract(a)) if (a.StaticHash != hash_3) else empty()), delay(_arrow3244))

                        return collect(_arrow3245, inv_2.Assays)

                    return append(collect(_arrow3240, inv_2.Studies), delay(_arrow3246))

                return append(singleton(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(inv_2)) if (inv_2.StaticHash != hash_1) else empty(), delay(_arrow3247))

            return to_array(delay(_arrow3248))

        return (_arrow3235() if _arrow3234() else _arrow3249()) if (match_value is not None) else this.GetWriteContracts()
    ...
    def GetGitInitContracts(self, branch: str | None=None, repository_address: str | None=None, default_gitignore: bool | None=None) -> Array[Contract]:
        ...
        def _arrow3253(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3252(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow3251(__unit: None=None) -> IEnumerable_1[Contract]:
                    ...
                    return append(singleton(gitignore_contract) if default_gitignore_1 else empty(), delay(_arrow3250))

                return append(singleton(gitattributes_contract), delay(_arrow3251))

            return append(singleton(Init_createInitContract_6DFDD678(branch)), delay(_arrow3252))

        return to_array(delay(_arrow3253))
    ...
    def GetRegisteredPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        ...
        def mapping_3(s_1: ArcStudy) -> Any:
            ...
            def _arrow3261(__unit: None=None, s_1: Any=s_1) -> IEnumerable_1[str]:
                def _arrow3260(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3259(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3258(table: ArcTable) -> IEnumerable_1[str]:
                            def _arrow3257(kv: Any) -> IEnumerable_1[str]:
                                text_value: str = kv[1].ToFreeTextCell().AsFreeText
                                def _arrow3256(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow3255(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton(((((("" + study_foldername) + "/") + "protocols") + "/") + text_value) + "")

                                    return append(singleton(((((("" + study_foldername) + "/") + "resources") + "/") + text_value) + ""), delay(_arrow3255))

                                return append(singleton(text_value), delay(_arrow3256))

                            return collect(_arrow3257, table.Values)

                        return collect(_arrow3258, s_1.Tables)

                    return append(singleton(((("" + study_foldername) + "/") + "README.md") + ""), delay(_arrow3259))

                return append(singleton(((("" + study_foldername) + "/") + "isa.study.xlsx") + ""), delay(_arrow3260))
            ...
            return of_seq(to_list(delay(_arrow3261)), ObjectExpr3262())

        class ObjectExpr3263:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives
        ...
        def mapping_4(a: ArcAssay) -> Any:
            ...
            def _arrow3270(__unit: None=None, a: Any=a) -> IEnumerable_1[str]:
                def _arrow3269(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3268(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3267(table_1: ArcTable) -> IEnumerable_1[str]:
                            def _arrow3266(kv_1: Any) -> IEnumerable_1[str]:
                                text_value_1: str = kv_1[1].ToFreeTextCell().AsFreeText
                                def _arrow3265(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow3264(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton(((((("" + assay_foldername) + "/") + "protocols") + "/") + text_value_1) + "")

                                    return append(singleton(((((("" + assay_foldername) + "/") + "dataset") + "/") + text_value_1) + ""), delay(_arrow3264))

                                return append(singleton(text_value_1), delay(_arrow3265))

                            return collect(_arrow3266, table_1.Values)

                        return collect(_arrow3267, a.Tables)

                    return append(singleton(((("" + assay_foldername) + "/") + "README.md") + ""), delay(_arrow3268))

                return append(singleton(((("" + assay_foldername) + "/") + "isa.assay.xlsx") + ""), delay(_arrow3269))

            class ObjectExpr3271:
                @property
                def Compare(self) -> Callable[[str, str], int]:
                    return compare_primitives

            return of_seq(to_list(delay(_arrow3270)), ObjectExpr3271())

        class ObjectExpr3272:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        class ObjectExpr3273:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        include_files: Any = union_many(to_enumerable([of_seq(to_enumerable(["isa.investigation.xlsx", "README.md"]), ObjectExpr3254()), union_many(map(mapping_3, registered_studies, None), ObjectExpr3263()), union_many(map(mapping_4, registered_assays, None), ObjectExpr3272())]), ObjectExpr3273())
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        fs_copy: FileSystem = this._fs.Copy()
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow3274(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not (n_1.find(".") == 0)

                return FileSystemTree.filter_folders(_arrow3274)(tree_1)

            else: 
                return tree_1


        def _arrow3276(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            def _arrow3275(n: str) -> bool:
                return not (n.find(".") == 0)

            return FileSystemTree.filter_files(_arrow3275)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow3276()), FileSystemTree.from_file_paths([]))

    def GetAdditionalPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        this: ARC = self
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        class ObjectExpr3277:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        registered_payload: Any = of_seq(FileSystemTree.to_file_paths()(this.GetRegisteredPayload()), ObjectExpr3277())
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow3278(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not (n_1.find(".") == 0)

                return FileSystemTree.filter_folders(_arrow3278)(tree_1)

            else: 
                return tree_1


        def _arrow3280(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            tree = FileSystemTree.from_file_paths(paths)
            def _arrow3279(n: str) -> bool:
                return not (n.find(".") == 0)

            return FileSystemTree.filter_files(_arrow3279)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow3280()), FileSystemTree.from_file_paths([]))

    @staticmethod
    def DefaultContracts() -> Any:
        class ObjectExpr3281:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        return of_seq_1(to_enumerable([(".gitignore", gitignore_contract), (".gitattributes", gitattributes_contract)]), ObjectExpr3281())

    @staticmethod
    def from_rocrate_json_string(s: str) -> ARC:
        def _arrow3282(__unit: None=None) -> ArcInvestigation | None:
    ...
    def GetValidationPackagesConfigWriteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        ...
        class ObjectExpr3285:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3284(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains_1(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr3285()):
    ...
    def GetValidationPackagesConfigDeleteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        ...
        if contains_1(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr3287()):
            def predicate(p: str) -> bool:
