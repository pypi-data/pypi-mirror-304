...
from ..fable_modules.fable_library.string_ import (to_text, printf, to_fail, ends_with, replace)
...
def _arrow515(value_1: YAMLElement) -> OutputBinding:
    def getter(get: IGetters) -> OutputBinding:
        def _arrow514(__unit: None=None, get: Any=get) -> str | None:
            object_arg: IOptionalGetter = get.Optional
            return object_arg.Field("glob", string)

        return OutputBinding(_arrow514())

    return object(getter, value_1)


Decode_outputBindingGlobDecoder: Callable[[YAMLElement], OutputBinding] = _arrow515

def _arrow516(value: YAMLElement) -> OutputBinding | None:
...
Decode_outputBindingDecoder: Callable[[YAMLElement], OutputBinding | None] = _arrow516

def _arrow520(value_1: YAMLElement) -> CWLType:
    def getter(get: IGetters) -> CWLType:
        def _arrow517(__unit: None=None, get: Any=get) -> str:
        ...
        def _arrow519(__unit: None=None, get: Any=get) -> bool | None:
            object_arg_2: IOptionalGetter = get.Optional
            return object_arg_2.Field("writable", bool_1)

        return CWLType(2, DirentInstance(_arrow517(), _arrow518(), _arrow519()))

    return object(getter, value_1)


Decode_direntDecoder: Callable[[YAMLElement], CWLType] = _arrow520

def _arrow522(value_1: YAMLElement) -> CWLType:
    def getter(get: IGetters) -> CWLType:
        items: str
        object_arg: IRequiredGetter = get.Required
        ...
        if items == "File":
            ...
            def _arrow521(__unit: None=None, get: Any=get) -> CWLType:
                object_arg_1: IRequiredGetter = get.Required
                return object_arg_1.Field("listing", Decode_direntDecoder)

            return CWLType(11, _arrow521())
...
def _arrow528(value_1: YAMLElement) -> tuple[CWLType, bool]:
    def getter(get: IGetters) -> tuple[CWLType, bool]:
        ...
        if cwl_type is None:
            def _arrow527(__unit: None=None, get: Any=get) -> CWLType:
                object_arg_1: IRequiredGetter = get.Required
                return object_arg_1.Field("type", Decode_cwlArrayTypeDecoder)

            return (_arrow527(), False)
...
Decode_cwlTypeDecoder: Callable[[YAMLElement], tuple[CWLType, bool]] = _arrow528

def _arrow535(value_2: YAMLElement) -> Array[CWLOutput]:
    def getter(get: IGetters) -> Array[CWLOutput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow534(__unit: None=None, get: Any=get) -> IEnumerable_1[CWLOutput]:
            def _arrow533(key: str) -> IEnumerable_1[CWLOutput]:
                ...
                def _arrow532(__unit: None=None) -> IEnumerable_1[CWLOutput]:
                    def _expr530():
                        set_optional_property("outputSource", output_source, output)
                        return empty_1()

                    def _arrow531(__unit: None=None) -> IEnumerable_1[CWLOutput]:
                        return singleton(output)

                    return append(_expr530() if (output_source is not None) else empty_1(), delay(_arrow531))

                return append(_expr529() if (output_binding is not None) else empty_1(), delay(_arrow532))

            return collect(_arrow533, dict_1.keys())

        return list(to_array(delay(_arrow534)))

    return object(getter, value_2)


Decode_outputArrayDecoder: Callable[[YAMLElement], Array[CWLOutput]] = _arrow535

def _arrow536(value: YAMLElement) -> Array[CWLOutput]:
    def getter(get: IGetters) -> Array[CWLOutput]:
        object_arg: IRequiredGetter = get.Required
...
Decode_outputsDecoder: Callable[[YAMLElement], Array[CWLOutput]] = _arrow536

def Decode_dockerRequirementDecoder(get: IGetters) -> DockerRequirement:
    def _arrow537(__unit: None=None, get: Any=get) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("dockerPull", string)

    def _arrow539(__unit: None=None, get: Any=get) -> Any | None:
        object_arg_1: IOptionalGetter = get.Optional
        def arg_3(value_1: YAMLElement) -> Any:
            def key_decoder(x: str, value_1: Any=value_1) -> str:
                return x

            def _arrow538(value_2: YAMLElement, value_1: Any=value_1) -> str:
                return string(value_2)

            return map_1(key_decoder, _arrow538, value_1)
    ...
    return DockerRequirement(_arrow537(), _arrow539(), _arrow540())
    ...
    def arg_1(value_6: YAMLElement, get: Any=get) -> Array[SoftwarePackage]:
        def decoder(value_5: YAMLElement, value_6: Any=value_6) -> SoftwarePackage:
            def getter(get2: IGetters, value_5: Any=value_5) -> SoftwarePackage:
                def _arrow543(__unit: None=None, get2: Any=get2) -> str:
                    object_arg_1: IRequiredGetter = get2.Required
                    return object_arg_1.Field("package", string)

                def _arrow545(__unit: None=None, get2: Any=get2) -> Array[str] | None:
                    ...
                    def arg_5(value_1: YAMLElement) -> Array[str]:
                        ...
                        return resizearray(_arrow544, value_1)

                    return object_arg_2.Field("version", arg_5)

                def _arrow547(__unit: None=None, get2: Any=get2) -> Array[str] | None:
                    object_arg_3: IOptionalGetter = get2.Optional
                    def arg_7(value_3: YAMLElement) -> Array[str]:
                        def _arrow546(value_4: YAMLElement, value_3: Any=value_3) -> str:
                            return string(value_4)

                        return resizearray(_arrow546, value_3)

                    return object_arg_3.Field("specs", arg_7)

                return SoftwarePackage(_arrow543(), _arrow545(), _arrow547())
...
def Decode_resourceRequirementDecoder(get: IGetters) -> ResourceRequirementInstance:
    def _arrow550(__unit: None=None, get: Any=get) -> YAMLElement | None:
        object_arg: IOptionalGetter = get.Optional
    ...
    def _arrow551(__unit: None=None, get: Any=get) -> YAMLElement | None:
        object_arg_1: IOptionalGetter = get.Optional
    ...
    def _arrow552(__unit: None=None, get: Any=get) -> YAMLElement | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    return ResourceRequirementInstance__ctor_D76FC00(some(_arrow550()), some(_arrow551()), some(_arrow552()), some(_arrow553()), some(_arrow554()), some(_arrow555()), some(_arrow556()), some(_arrow557()))
...
def Decode_schemaDefRequirementDecoder(get: IGetters) -> Array[SchemaDefRequirementType]:
    ...
    def _arrow559(__unit: None=None, get: Any=get) -> Array[Any]:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value_2: YAMLElement) -> Array[Any]:
            def decoder(value: YAMLElement, value_2: Any=value_2) -> Any:
                ...
                def _arrow558(value_1: YAMLElement, value: Any=value) -> str:
                    return string(value_1)

                return map_1(key_decoder, _arrow558, value)

            return resizearray(decoder, value_2)

        return object_arg.Field("types", arg_1)

    return ResizeArray_map(f, _arrow559())
...
def _arrow560(value_2: YAMLElement) -> Array[Requirement]:
...
Decode_requirementArrayDecoder: Callable[[YAMLElement], Array[Requirement]] = _arrow560

def _arrow561(value: YAMLElement) -> Array[Requirement] | None:
...
Decode_requirementsDecoder: Callable[[YAMLElement], Array[Requirement] | None] = _arrow561

def _arrow562(value: YAMLElement) -> Array[Requirement] | None:
    def getter(get: IGetters) -> Array[Requirement] | None:
        object_arg: IOptionalGetter = get.Optional
...
Decode_hintsDecoder: Callable[[YAMLElement], Array[Requirement] | None] = _arrow562

def _arrow567(value_5: YAMLElement) -> InputBinding | None:
...
Decode_inputBindingDecoder: Callable[[YAMLElement], InputBinding | None] = _arrow567

def _arrow574(value_1: YAMLElement) -> Array[CWLInput]:
    def getter(get: IGetters) -> Array[CWLInput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow573(__unit: None=None, get: Any=get) -> IEnumerable_1[CWLInput]:
            def _arrow572(key: str) -> IEnumerable_1[CWLInput]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                ...
                def _arrow571(__unit: None=None) -> IEnumerable_1[CWLInput]:
                    def _expr569():
                        set_optional_property("optional", True, input)
                        return empty_1()

                    def _arrow570(__unit: None=None) -> IEnumerable_1[CWLInput]:
                        return singleton(input)

                    return append(_expr569() if pattern_input[1] else empty_1(), delay(_arrow570))

                return append(_expr568() if (input_binding is not None) else empty_1(), delay(_arrow571))

            return collect(_arrow572, dict_1.keys())

        return list(to_array(delay(_arrow573)))

    return object(getter, value_1)


Decode_inputArrayDecoder: Callable[[YAMLElement], Array[CWLInput]] = _arrow574

def _arrow575(value: YAMLElement) -> Array[CWLInput] | None:
...
Decode_inputsDecoder: Callable[[YAMLElement], Array[CWLInput] | None] = _arrow575

def _arrow577(value_2: YAMLElement) -> Array[str] | None:
    def getter(get: IGetters) -> Array[str] | None:
        ...
        def arg_1(value: YAMLElement, get: Any=get) -> Array[str]:
            ...
            return resizearray(_arrow576, value)
...
Decode_baseCommandDecoder: Callable[[YAMLElement], Array[str] | None] = _arrow577

def _arrow578(value_1: YAMLElement) -> str:
...
Decode_versionDecoder: Callable[[YAMLElement], str] = _arrow578

def _arrow579(value_1: YAMLElement) -> str:
    def getter(get: IGetters) -> str:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value: YAMLElement, get: Any=get) -> str:
            return string(value)
...
Decode_classDecoder: Callable[[YAMLElement], str] = _arrow579

def Decode_stringOptionFieldDecoder(field: str) -> Callable[[YAMLElement], str | None]:
    def _arrow580(value_1: YAMLElement, field: Any=field) -> str | None:
...
def Decode_stringFieldDecoder(field: str) -> Callable[[YAMLElement], str]:
    def _arrow581(value_1: YAMLElement, field: Any=field) -> str:
        def getter(get: IGetters) -> str:
            object_arg: IRequiredGetter = get.Required
            def arg_1(value: YAMLElement, get: Any=get) -> str:
                return string(value)
...
def _arrow585(value_1: YAMLElement) -> Array[StepInput]:
    def getter(get: IGetters) -> Array[StepInput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow584(__unit: None=None, get: Any=get) -> IEnumerable_1[StepInput]:
            def _arrow583(key: str) -> IEnumerable_1[StepInput]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                def _arrow582(__unit: None=None) -> str | None:
                ...
                return singleton(StepInput(key, _arrow582(), Decode_stringOptionFieldDecoder("default")(value), Decode_stringOptionFieldDecoder("valueFrom")(value)))

            return collect(_arrow583, dict_1.keys())

        return list(to_array(delay(_arrow584)))

    return object(getter, value_1)


Decode_inputStepDecoder: Callable[[YAMLElement], Array[StepInput]] = _arrow585

def _arrow587(value_2: YAMLElement) -> Array[str]:
    def getter(get: IGetters) -> Array[str]:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value: YAMLElement, get: Any=get) -> Array[str]:
            def _arrow586(value_1: YAMLElement, value: Any=value) -> str:
                return string(value_1)

            return resizearray(_arrow586, value)
...
Decode_outputStepsDecoder: Callable[[YAMLElement], Array[str]] = _arrow587

def _arrow595(value_1: YAMLElement) -> Array[WorkflowStep]:
    def getter(get: IGetters) -> Array[WorkflowStep]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow594(__unit: None=None, get: Any=get) -> IEnumerable_1[WorkflowStep]:
            def _arrow593(key: str) -> IEnumerable_1[WorkflowStep]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                run: str = Decode_stringFieldDecoder("run")(value)
                def _arrow588(get_1: IGetters) -> Array[StepInput]:
                    object_arg: IRequiredGetter = get_1.Required
                    return object_arg.Field("in", Decode_inputStepDecoder)

                inputs: Array[StepInput] = object(_arrow588, value)
                ...
                def _arrow592(__unit: None=None) -> IEnumerable_1[WorkflowStep]:
                    def _expr590():
                        wf_step.Hints = hints
                        return empty_1()

                    def _arrow591(__unit: None=None) -> IEnumerable_1[WorkflowStep]:
                        return singleton(wf_step)

                    return append(_expr590() if (hints is not None) else empty_1(), delay(_arrow591))

                return append(_expr589() if (requirements is not None) else empty_1(), delay(_arrow592))

            return collect(_arrow593, dict_1.keys())

        return list(to_array(delay(_arrow594)))

    return object(getter, value_1)


Decode_stepArrayDecoder: Callable[[YAMLElement], Array[WorkflowStep]] = _arrow595

def _arrow596(value: YAMLElement) -> Array[WorkflowStep]:
    def getter(get: IGetters) -> Array[WorkflowStep]:
        object_arg: IRequiredGetter = get.Required
...
Decode_stepsDecoder: Callable[[YAMLElement], Array[WorkflowStep]] = _arrow596
