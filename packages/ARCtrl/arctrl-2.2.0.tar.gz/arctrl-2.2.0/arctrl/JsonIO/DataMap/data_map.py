...
def _arrow3174(get: IGetters) -> DataMap:
    def _arrow3173(__unit: None=None) -> Array[DataContext]:
        arg_1: Decoder_1[Array[DataContext]] = resize_array(decoder_1)
        object_arg: IRequiredGetter = get.Required
        return object_arg.Field("dataContexts", arg_1)

    return DataMap__ctor_4E3220A7(_arrow3173())


decoder: Decoder_1[DataMap] = object(_arrow3174)
