...
def encoder(isa: ArcInvestigation) -> IEncodable:
    ...
    def _arrow3191(value: str, isa: Any=isa) -> IEncodable:
        class ObjectExpr3190(IEncodable):
            def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                return helpers.encode_string(value)

        return ObjectExpr3190()

    def _arrow3193(value_2: str, isa: Any=isa) -> IEncodable:
        class ObjectExpr3192(IEncodable):
            def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                return helpers_1.encode_string(value_2)

        return ObjectExpr3192()

    def _arrow3194(oa: ArcInvestigation, isa: Any=isa) -> IEncodable:
        return ROCrate_encoder(oa)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@type", _arrow3191, "CreativeWork"), try_include("@id", _arrow3193, "ro-crate-metadata.json"), try_include("about", _arrow3194, isa), ("conformsTo", conforms_to_jsonvalue), ("@context", context_jsonvalue)]))
...
def _arrow3196(get: IGetters) -> ArcInvestigation | None:
    object_arg: IOptionalGetter = get.Optional
    return object_arg.Field("about", ROCrate_decoder)


decoder: Decoder_1[ArcInvestigation | None] = object(_arrow3196)
