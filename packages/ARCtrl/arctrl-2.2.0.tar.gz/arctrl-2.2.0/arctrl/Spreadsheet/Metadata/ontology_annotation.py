...
def to_sparse_table(label: str, label_tsr: str, label_tan: str, designs: FSharpList[OntologyAnnotation]) -> SparseTable:
    ...
    class ObjectExpr1095:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow1094(x: str, y: str) -> bool:
                return x == y
    ...
    return SparseTable(matrix.Matrix, matrix.Keys, reverse(List_distinct(comment_keys, ObjectExpr1095())), matrix.ColumnCount)
