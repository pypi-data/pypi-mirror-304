...
def decode_cols(col_number: int | None=None) -> Decoder_1[FsCell]:
    def _arrow281(builder: IGetters, col_number: Any=col_number) -> FsCell:
        def _arrow279(__unit: None=None) -> tuple[Any, DataType] | None:
            object_arg: IOptionalGetter = builder.Optional
            return object_arg.Field("value", decode)

        pattern_input: tuple[Any, DataType] = default_arg(_arrow279(), ("", DataType(4)))
        def _arrow280(__unit: None=None) -> int | None:
            object_arg_1: IOptionalGetter = builder.Optional
            return object_arg_1.Field("row", int_1)

        return FsCell(pattern_input[0], pattern_input[1], FsAddress__ctor_Z37302880(default_arg(_arrow280(), 0), default_arg(col_number, 0)))

    return object(_arrow281)
