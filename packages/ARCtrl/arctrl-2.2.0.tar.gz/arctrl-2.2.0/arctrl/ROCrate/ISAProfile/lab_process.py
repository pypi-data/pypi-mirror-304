...
class LabProcess(LDObject):
    ...
    def get_name() -> Callable[[LabProcess], str]:
        def _arrow1383(lp: LabProcess) -> str:
            return lp.GetName()
    ...
    def get_agent() -> Callable[[LabProcess], str]:
        def _arrow1384(lp: LabProcess) -> str:
            return lp.GetAgent()
    ...
    def get_object() -> Callable[[LabProcess], str]:
        def _arrow1385(lp: LabProcess) -> str:
            return lp.GetObject()
    ...
    def get_result() -> Callable[[LabProcess], str]:
        def _arrow1386(lp: LabProcess) -> str:
            return lp.GetResult()

        return _arrow1386


LabProcess_reflection = _expr1388
