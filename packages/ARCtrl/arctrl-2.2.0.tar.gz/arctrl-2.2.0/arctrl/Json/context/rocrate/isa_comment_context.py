...
def _arrow1437(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1432()), ("Comment", ObjectExpr1433()), ("name", ObjectExpr1434()), ("value", ObjectExpr1435())])
    ...
    return ObjectExpr1436()


context_jsonvalue: IEncodable = _arrow1437()
