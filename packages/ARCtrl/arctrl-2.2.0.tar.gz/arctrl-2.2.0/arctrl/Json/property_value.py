...
def encoder(pv: IPropertyValue) -> IEncodable:
    ...
    if match_value_1 is None:
        ...
        if v.tag == 1:
            ...
            pattern_input_1 = (ObjectExpr1805(), None)
            ...
            def _arrow1808(value_3: str, pv: Any=pv) -> IEncodable:
            ...
            def _arrow1810(value_5: str, pv: Any=pv) -> IEncodable:
            ...
            pattern_input_1 = (map(_arrow1808, oa_1.Name), map(_arrow1810, oa_1.TermAccessionNumber))
    ...
    def _arrow1815(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1820(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1823(value_11: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1825(value_13: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1827(value_15: str, pv: Any=pv) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1815()), ("@type", ObjectExpr1816()), ("additionalType", _arrow1820()), try_include("alternateName", _arrow1823, pv.AlternateName()), try_include("measurementMethod", _arrow1825, pv.MeasurementMethod()), try_include("description", _arrow1827, pv.Description()), try_include("category", _arrow1830, pattern_input[0]), try_include("categoryCode", _arrow1832, pattern_input[1]), try_include("value", _arrow1833, pattern_input_1[0]), try_include("valueCode", _arrow1834, pattern_input_1[1]), try_include("unit", _arrow1836, pattern_input_2[0]), try_include("unitCode", _arrow1838, pattern_input_2[1]), ("@context", context_jsonvalue)]))
