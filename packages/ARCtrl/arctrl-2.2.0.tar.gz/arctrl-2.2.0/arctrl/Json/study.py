...
def encoder(study: ArcStudy) -> IEncodable:
    ...
    def _arrow2707(__unit: None=None, study: Any=study) -> IEncodable:
    ...
    def _arrow2709(value_1: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2711(value_3: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2713(value_5: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2715(value_7: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2716(oa: Publication, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow2717(person: Person, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow2718(oa_1: OntologyAnnotation, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2719(table: ArcTable, study: Any=study) -> IEncodable:
        return encoder_7(table)

    def _arrow2720(dm: DataMap, study: Any=study) -> IEncodable:
        return encoder_8(dm)

    def _arrow2722(value_9: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2723(comment: Comment, study: Any=study) -> IEncodable:
        return encoder_9(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2707()), try_include("Title", _arrow2709, study.Title), try_include("Description", _arrow2711, study.Description), try_include("SubmissionDate", _arrow2713, study.SubmissionDate), try_include("PublicReleaseDate", _arrow2715, study.PublicReleaseDate), try_include_seq("Publications", _arrow2716, study.Publications), try_include_seq("Contacts", _arrow2717, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow2718, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow2719, study.Tables), try_include("DataMap", _arrow2720, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow2722, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow2723, study.Comments)]))
...
def _arrow2737(get: IGetters) -> ArcStudy:
    def _arrow2725(__unit: None=None) -> str:
        object_arg: IRequiredGetter = get.Required
        return object_arg.Field("Identifier", string)

    def _arrow2726(__unit: None=None) -> str | None:
    ...
    return ArcStudy(_arrow2725(), _arrow2726(), _arrow2727(), _arrow2728(), _arrow2729(), _arrow2730(), _arrow2731(), _arrow2732(), _arrow2733(), _arrow2734(), _arrow2735(), _arrow2736())


decoder: Decoder_1[ArcStudy] = object(_arrow2737)
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, study: ArcStudy) -> IEncodable:
    ...
    def _arrow2741(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        value: str = study.Identifier
    ...
    def _arrow2743(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2745(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2747(value_5: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2749(value_7: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2750(oa: Publication, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow2751(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow2752(oa_1: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2753(table: ArcTable, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, table)

    def _arrow2754(dm: DataMap, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, dm)

    def _arrow2756(value_9: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2757(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_9(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2741()), try_include("Title", _arrow2743, study.Title), try_include("Description", _arrow2745, study.Description), try_include("SubmissionDate", _arrow2747, study.SubmissionDate), try_include("PublicReleaseDate", _arrow2749, study.PublicReleaseDate), try_include_seq("Publications", _arrow2750, study.Publications), try_include_seq("Contacts", _arrow2751, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow2752, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow2753, study.Tables), try_include("DataMap", _arrow2754, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow2756, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow2757, study.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcStudy]:
    def _arrow2771(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcStudy:
        def _arrow2759(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("Identifier", string)

        def _arrow2760(__unit: None=None) -> str | None:
            object_arg_1: IOptionalGetter = get.Optional
            return object_arg_1.Field("Title", string)

        def _arrow2761(__unit: None=None) -> str | None:
            object_arg_2: IOptionalGetter = get.Optional
            return object_arg_2.Field("Description", string)

        def _arrow2762(__unit: None=None) -> str | None:
            object_arg_3: IOptionalGetter = get.Optional
            return object_arg_3.Field("SubmissionDate", string)

        def _arrow2763(__unit: None=None) -> str | None:
            object_arg_4: IOptionalGetter = get.Optional
            return object_arg_4.Field("PublicReleaseDate", string)

        def _arrow2764(__unit: None=None) -> Array[Publication] | None:
            arg_11: Decoder_1[Array[Publication]] = resize_array(decoder_2)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("Publications", arg_11)

        def _arrow2765(__unit: None=None) -> Array[Person] | None:
            arg_13: Decoder_1[Array[Person]] = resize_array(decoder_3)
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("Contacts", arg_13)

        def _arrow2766(__unit: None=None) -> Array[OntologyAnnotation] | None:
            arg_15: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_decoder)
            object_arg_7: IOptionalGetter = get.Optional
            return object_arg_7.Field("StudyDesignDescriptors", arg_15)

        def _arrow2767(__unit: None=None) -> Array[ArcTable] | None:
            arg_17: Decoder_1[Array[ArcTable]] = resize_array(decoder_compressed_1(string_table, oa_table, cell_table))
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("Tables", arg_17)

        def _arrow2768(__unit: None=None) -> DataMap | None:
            arg_19: Decoder_1[DataMap] = decoder_compressed_2(string_table, oa_table, cell_table)
            object_arg_9: IOptionalGetter = get.Optional
            return object_arg_9.Field("DataMap", arg_19)

        def _arrow2769(__unit: None=None) -> Array[str] | None:
            arg_21: Decoder_1[Array[str]] = resize_array(string)
            object_arg_10: IOptionalGetter = get.Optional
            return object_arg_10.Field("RegisteredAssayIdentifiers", arg_21)

        def _arrow2770(__unit: None=None) -> Array[Comment] | None:
            arg_23: Decoder_1[Array[Comment]] = resize_array(decoder_6)
            object_arg_11: IOptionalGetter = get.Optional
            return object_arg_11.Field("Comments", arg_23)

        return ArcStudy(_arrow2759(), _arrow2760(), _arrow2761(), _arrow2762(), _arrow2763(), _arrow2764(), _arrow2765(), _arrow2766(), _arrow2767(), _arrow2768(), _arrow2769(), _arrow2770())

    return object(_arrow2771)
...
def ROCrate_encoder(assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    ...
    def _arrow2775(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2779(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2781(value_4: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2783(value_6: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2785(value_8: str, assays: Any=assays, s: Any=s) -> IEncodable:
        class ObjectExpr2784(IEncodable):
            def Encode(self, helpers_6: IEncoderHelpers_1[Any]) -> Any:
                return helpers_6.encode_string(value_8)

        return ObjectExpr2784()

    def _arrow2786(oa: OntologyAnnotation, assays: Any=assays, s: Any=s) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa)

    def _arrow2788(value_10: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2790(value_12: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2791(oa_1: Publication, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_1(oa_1)

    def _arrow2792(oa_2: Person, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_2(oa_2)

    def _arrow2794(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[Process], IEncodable]:
        study_name: str | None = s.Identifier
        def _arrow2793(oa_3: Process) -> IEncodable:
            return ROCrate_encoder_3(study_name, None, oa_3)

        return _arrow2793

    def _arrow2796(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[ArcAssay], IEncodable]:
        study_name_1: str | None = s.Identifier
        def _arrow2795(a_1: ArcAssay) -> IEncodable:
            return ROCrate_encoder_4(study_name_1, a_1)

        return _arrow2795

    def _arrow2797(comment: Comment, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_5(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2775()), ("@type", list_1_1(singleton(ObjectExpr2776()))), ("additionalType", ObjectExpr2777()), ("identifier", _arrow2779()), try_include("filename", _arrow2781, file_name), try_include("title", _arrow2783, s.Title), try_include("description", _arrow2785, s.Description), try_include_seq("studyDesignDescriptors", _arrow2786, s.StudyDesignDescriptors), try_include("submissionDate", _arrow2788, s.SubmissionDate), try_include("publicReleaseDate", _arrow2790, s.PublicReleaseDate), try_include_seq("publications", _arrow2791, s.Publications), try_include_seq("people", _arrow2792, s.Contacts), try_include_list("processSequence", _arrow2794(), processes), try_include_seq("assays", _arrow2796(), assays_1), try_include_seq("comments", _arrow2797, s.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2809(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    def _arrow2799(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("filename", string)

    identifier: str = default_arg(bind(Study_tryIdentifierFromFileName, _arrow2799()), create_missing_identifier())
    ...
    def _arrow2808(__unit: None=None) -> Array[Comment] | None:
        arg_22: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_5)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_22)

    return (ArcStudy(identifier, _arrow2801(), _arrow2802(), _arrow2803(), _arrow2804(), _arrow2805(), _arrow2806(), _arrow2807(), tables, None, assay_identifiers, _arrow2808()), default_arg(assays, empty()))


ROCrate_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = object(_arrow2809)
...
def ISAJson_encoder(id_map: Any | None, assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    def f(s_1: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> IEncodable:
        ...
        def _arrow2810(ps: FSharpList[Process], s_1: Any=s_1) -> IEncodable:
            return encoder_12(id_map, ps)

        encoded_materials: tuple[str, IEncodable | None] = try_include("materials", _arrow2810, Option_fromValueWithDefault(empty(), processes))
        encoded_protocols: tuple[str, IEncodable | None]
        value_5: FSharpList[Protocol] = get_protocols(processes)
        def _arrow2812(__unit: None=None, s_1: Any=s_1) -> Callable[[Protocol], IEncodable]:
            study_name: str | None = s_1.Identifier
            def _arrow2811(oa_1: Protocol) -> IEncodable:
                return ISAJson_encoder_1(study_name, None, None, id_map, oa_1)

            return _arrow2811

        encoded_protocols = try_include_list("protocols", _arrow2812(), value_5)
        ...
        def _arrow2816(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2819(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2821(value_9: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2823(value_11: str, s_1: Any=s_1) -> IEncodable:
            class ObjectExpr2822(IEncodable):
                def Encode(self, helpers_4: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_4.encode_string(value_11)

            return ObjectExpr2822()

        def _arrow2825(value_13: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2827(value_15: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2828(oa_2: Publication, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_2)

        def _arrow2829(person_2: Person, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, person_2)

        def _arrow2830(oa_3: OntologyAnnotation, s_1: Any=s_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow2832(__unit: None=None, s_1: Any=s_1) -> Callable[[Process], IEncodable]:
            study_name_1: str | None = s_1.Identifier
            def _arrow2831(oa_4: Process) -> IEncodable:
                return ISAJson_encoder_4(study_name_1, None, id_map, oa_4)

            return _arrow2831

        def _arrow2834(__unit: None=None, s_1: Any=s_1) -> Callable[[ArcAssay], IEncodable]:
            study_name_2: str | None = s_1.Identifier
            def _arrow2833(a_2: ArcAssay) -> IEncodable:
                return ISAJson_encoder_5(study_name_2, id_map, a_2)

            return _arrow2833

        def _arrow2835(comment: Comment, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_6(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2816()), ("filename", ObjectExpr2817()), ("identifier", _arrow2819()), try_include("title", _arrow2821, study.Title), try_include("description", _arrow2823, study.Description), try_include("submissionDate", _arrow2825, study.SubmissionDate), try_include("publicReleaseDate", _arrow2827, study.PublicReleaseDate), try_include_seq("publications", _arrow2828, study.Publications), try_include_seq("people", _arrow2829, study.Contacts), try_include_seq("studyDesignDescriptors", _arrow2830, study.StudyDesignDescriptors), encoded_protocols, encoded_materials, try_include_list("processSequence", _arrow2832(), processes), try_include_seq("assays", _arrow2834(), assays_1), encoded_factors, encoded_characteristics, encoded_units, try_include_seq("comments", _arrow2835, study.Comments)]))
    ...
    if id_map is not None:
        def _arrow2837(s_2: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> str:
            return ROCrate_genID(s_2)

        return encode(_arrow2837, f, s, id_map)
...
def _arrow2848(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    def _arrow2838(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("identifier", string)

    def def_thunk(__unit: None=None) -> str:
        def _arrow2839(__unit: None=None) -> str | None:
            object_arg_1: IOptionalGetter = get.Optional
            return object_arg_1.Field("filename", string)

        return default_arg(bind(Study_tryIdentifierFromFileName, _arrow2839()), create_missing_identifier())

    identifier: str = default_arg_with(_arrow2838(), def_thunk)
    ...
    def _arrow2841(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
    ...
    def _arrow2847(__unit: None=None) -> Array[Comment] | None:
        arg_25: Decoder_1[Array[Comment]] = resize_array(ISAJson_decoder_5)
        object_arg_11: IOptionalGetter = get.Optional
        return object_arg_11.Field("comments", arg_25)

    return (ArcStudy(identifier, _arrow2841(), _arrow2842(), _arrow2843(), _arrow2844(), _arrow2845(), None if (len(persons) == 0) else persons, _arrow2846(), tables, None, assay_identifiers, _arrow2847()), default_arg(assays, empty()))


ISAJson_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2848)
