...
def _arrow2343(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2344(Item_1: Sample) -> ProcessInput:
...
def _arrow2347(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ROCrate_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2343, ROCrate_decoder_1), map(_arrow2344, ROCrate_decoder_2), map(_arrow2345, ROCrate_decoder_3), map(_arrow2347, ROCrate_decoder_4)]))
...
def _arrow2352(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2354(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2355(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2356(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2352, ISAJson_decoder_1), map(_arrow2354, ISAJson_decoder_2), map(_arrow2355, ISAJson_decoder_3), map(_arrow2356, ISAJson_decoder_4)]))
