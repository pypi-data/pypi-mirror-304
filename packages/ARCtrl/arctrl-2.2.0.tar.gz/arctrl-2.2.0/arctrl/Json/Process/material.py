...
def ROCrate_encoder(oa: Material) -> IEncodable:
    ...
    def _arrow2276(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2279(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2280(value_4: MaterialType, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(value_4)

    def _arrow2281(oa_1: Material, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2276()), ("@type", list_1_1(singleton(ObjectExpr2277()))), try_include("name", _arrow2279, oa.Name), try_include("type", _arrow2280, oa.MaterialType), try_include_list_opt("characteristics", ROCrate_encoder_2, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2281, oa.DerivesFrom), ("@context", context_jsonvalue)]))
...
def _arrow2289(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2288(get: IGetters) -> Material:
            def _arrow2283(__unit: None=None) -> str | None:
                object_arg: IOptionalGetter = get.Optional
                return object_arg.Field("@id", Decode_uri)

            def _arrow2284(__unit: None=None) -> str | None:
                object_arg_1: IOptionalGetter = get.Optional
                return object_arg_1.Field("name", string)

            def _arrow2285(__unit: None=None) -> MaterialType | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("type", ROCrate_decoder_1)

            def _arrow2286(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2287(__unit: None=None) -> FSharpList[Material] | None:
                arg_9: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("derivesFrom", arg_9)

            return Material(_arrow2283(), _arrow2284(), _arrow2285(), _arrow2286(), _arrow2287())

        return object(_arrow2288)

    return decode(None)


ROCrate_decoder: Decoder_1[Material] = _arrow2289()
...
def ISAJson_encoder(id_map: Any | None, c: Material) -> IEncodable:
    def f(oa: Material, id_map: Any=id_map, c: Any=c) -> IEncodable:
        ...
        def _arrow2293(value: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2295(value_2: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2296(oa_1: MaterialAttributeValue, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_1)

        def _arrow2297(c_1: Material, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder(id_map, c_1)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2293, ROCrate_genID(oa)), try_include("name", _arrow2295, oa.Name), try_include("type", ISAJson_encoder_1, oa.MaterialType), try_include_list_opt("characteristics", _arrow2296, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2297, oa.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2299(m_1: Material, id_map: Any=id_map, c: Any=c) -> str:
            return ROCrate_genID(m_1)

        return encode(_arrow2299, f, c, id_map)
...
def _arrow2306(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2305(get: IGetters) -> Material:
            ...
            def _arrow2302(__unit: None=None) -> MaterialType | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("type", ISAJson_decoder_1)

            def _arrow2303(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
                arg_7: Decoder_1[FSharpList[MaterialAttributeValue]] = list_1_2(ISAJson_decoder_2)
                object_arg_3: IOptionalGetter = get.Optional
                return object_arg_3.Field("characteristics", arg_7)

            def _arrow2304(__unit: None=None) -> FSharpList[Material] | None:
                arg_9: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("derivesFrom", arg_9)

            return Material(_arrow2300(), _arrow2301(), _arrow2302(), _arrow2303(), _arrow2304())

        return Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2305)

    return decode(None)


ISAJson_decoder: Decoder_1[Material] = _arrow2306()
