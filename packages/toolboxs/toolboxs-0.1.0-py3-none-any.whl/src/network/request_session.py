...
class Request(Logger):
    ...
    def __init__(self,
        ...
        # 关闭 InsecureRequestWarning: Unverified HTTPS request 警告提醒
    ...
    '''
        ...
        @params: part_headers 局部请求头，如果为空则使用默认请求头
        @params: proxies 代理
    ...
    def send(self,
        ...
        # 合并请求头；局部请求头 > 全局请求头 > 默认请求头
        headers = {**Utils.get_headers('PC-Mac'),**self.global_headers,**part_headers,}
        ...
        if module == RequestModule.GET:
            self.response:requests_models.Response = self.session.get(
                url,
                verify=False,
                params=params,
                headers=headers,
