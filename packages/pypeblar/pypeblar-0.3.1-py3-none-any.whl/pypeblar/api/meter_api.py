...
class MeterApi:
    ...
    @validate_arguments
    async def meter_get(self, **kwargs) -> MeterGet200Response:  # noqa: E501
        """Get meter information  # noqa: E501
        ...
        :rtype: MeterGet200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the meter_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.meter_get_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    async def meter_get_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Get meter information  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(MeterGet200Response, status_code(int), headers(HTTPHeaderDict))
        """
