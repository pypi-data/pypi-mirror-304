...
class SystemApi:
    ...
    @validate_arguments
    async def system_get(self, **kwargs) -> SystemGet200Response:  # noqa: E501
        """Generic system information  # noqa: E501
        ...
        :rtype: SystemGet200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the system_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.system_get_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    async def system_get_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Generic system information  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SystemGet200Response, status_code(int), headers(HTTPHeaderDict))
        """
