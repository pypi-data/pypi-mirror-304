...
class HealthGet200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HealthGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HealthGet200Response:
        """Create an instance of HealthGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HealthGet200Response.parse_obj(obj)

        _obj = HealthGet200Response.parse_obj({
