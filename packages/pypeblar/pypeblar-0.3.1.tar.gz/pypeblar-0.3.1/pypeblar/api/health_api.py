...
class HealthApi:
    ...
    @validate_arguments
    async def health_get(self, **kwargs) -> HealthGet200Response:  # noqa: E501
        """Generic API information  # noqa: E501

        This endpoint can be accessed without authorization token and contains basic API information.  # noqa: E501
        ...
        return await self.health_get_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    async def health_get_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Generic API information  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(HealthGet200Response, status_code(int), headers(HTTPHeaderDict))
        """
