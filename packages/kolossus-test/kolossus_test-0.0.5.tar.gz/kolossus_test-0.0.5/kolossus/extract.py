...
from .utils.seq_to_embedding import extract_junk
from .utils.seq_to_embedding import extract_junk_from_fasta
...
def main():
    ...
    extract_junk_from_fasta(fasta_file, output_file, device, model_name)
