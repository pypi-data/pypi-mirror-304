...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = MailboxApi()
        api_instance.create_mailbox  # this is an instance of the class Endpoint
        api_instance.create_mailbox()  # this invokes api_instance.create_mailbox.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_mailbox.callable or self.callable in this class
