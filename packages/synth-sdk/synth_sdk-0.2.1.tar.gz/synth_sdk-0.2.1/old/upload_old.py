...
# f#rom ..tracing.abstractions import TrajectoryTrace, Dataset
...
#             print("Found this many spans:", len(spans))
#             print("First span:", spans[0])
#             print(f"Upload successful - sent {len(trajectory_traces_list)} traces across {len(trajectory_traces)} agents.")
#     return response
