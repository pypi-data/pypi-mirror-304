...
class UploadProductDocumentRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_slug, content_type, slug, description, filename, type, entity_type, product_version_id, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            product_version_id (float): Id of the product version, and is optional. If not provided, the document will be attached        to the latest version of the product.
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_slug, content_type, slug, description, filename, type, entity_type, product_version_id, *args, **kwargs):  # noqa: E501
        """UploadProductDocumentRequestDto - a model defined in OpenAPI
