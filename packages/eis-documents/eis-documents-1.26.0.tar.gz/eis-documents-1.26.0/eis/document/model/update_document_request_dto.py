...
class UpdateDocumentRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, policy_code, account_code, lead_code, entity_id, code, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, policy_code, account_code, lead_code, entity_id, code, *args, **kwargs):  # noqa: E501
        """UpdateDocumentRequestDto - a model defined in OpenAPI
