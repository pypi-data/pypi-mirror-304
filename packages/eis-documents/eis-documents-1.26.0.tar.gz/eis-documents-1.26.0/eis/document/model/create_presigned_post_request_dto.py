...
class CreatePresignedPostRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, template_slug, entity_type, entity_id, description, policy_code, account_code, lead_code, requester, content_type, iso_content_type, filename, product_slug, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, template_slug, entity_type, entity_id, description, policy_code, account_code, lead_code, requester, content_type, iso_content_type, filename, product_slug, *args, **kwargs):  # noqa: E501
        """CreatePresignedPostRequestDto - a model defined in OpenAPI
