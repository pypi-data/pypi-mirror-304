...
def run_script():
    ...
    try:
        ...
        if IS_MAC:
            command = ['mjpython', '-m', 'dart_physics.runs.teleop', '--task', task, '--robot', robot_file_name, '--avp', '--th', extra, '--headless'] 
        else:
    ...
    try:
        ...
        for proc in psutil.process_iter(['pid', 'name', 'cmdline']):
            try:
                ...
                if cmdline and cmdline[0] == 'python' and 'teleop' in cmdline:
