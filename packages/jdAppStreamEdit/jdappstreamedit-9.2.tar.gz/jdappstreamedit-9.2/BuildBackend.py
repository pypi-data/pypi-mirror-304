...
def build_wheel(wheel_directory: str, config_settings: Any = None, metadata_directory: Optional[str] = None) -> None:
...
def get_requires_for_build_wheel(self, config_settings: Any = None) -> list[str]:
    if get_lrelease_command() is None:
