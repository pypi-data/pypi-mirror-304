...
class TextToAudioParameters(BaseModel):
    generate: Optional[GenerationParameters] = Field(
        None, description="Parametrization of the text generation process"
    )


class TextToAudioInput(BaseModel):
    inputs: str = Field(..., description="The input text data")
    parameters: Optional[TextToAudioParameters] = Field(None, description="Additional inference parameters")
