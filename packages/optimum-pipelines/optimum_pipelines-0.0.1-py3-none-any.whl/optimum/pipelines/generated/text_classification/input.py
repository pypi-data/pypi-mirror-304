...
class ClassificationOutputTransform(Enum):
    sigmoid = "sigmoid"
    softmax = "softmax"
    none = "none"
...
class GenerationParameters(BaseModel):
    temperature: Optional[float] = Field(None, description="The value used to modulate the next token probabilities.")
    ...
    early_stopping: Optional[EarlyStopping] = Field(
        None, description="Controls the stopping condition for beam-based methods."
    )
    num_beams: Optional[int] = Field(None, description="Number of beams to use for beam search.")
...
class TextClassificationParameters(BaseModel):
    function_to_apply: Optional[ClassificationOutputTransform] = Field(None, title="TextClassificationOutputTransform")
    top_k: Optional[int] = Field(
        None,
...
class TextClassificationInput(BaseModel):
    inputs: str = Field(..., description="The text to classify")
    parameters: Optional[TextClassificationParameters] = Field(None, description="Additional inference parameters")
