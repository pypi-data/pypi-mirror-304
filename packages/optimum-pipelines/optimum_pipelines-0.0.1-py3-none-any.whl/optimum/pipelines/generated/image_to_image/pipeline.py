...
from optimum.pipelines.generated.image_to_image.input import ImageToImageParameters
...
class ImageToImagePipeline:
    def __call__(
        ...
        normalized_parameters = ImageToImageParameters(
    ...
    def forward(self, inputs: str, parameters: ImageToImageParameters):
