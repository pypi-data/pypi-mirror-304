...
from optimum.pipelines.generated.summarization.input import SummarizationParameters
...
class SummarizationPipeline:
    def __call__(
        ...
        normalized_parameters = SummarizationParameters(
    ...
    def forward(self, inputs: str, parameters: SummarizationParameters):
