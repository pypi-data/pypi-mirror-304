...
#   filename:  input.json
#   timestamp: 2024-10-25T08:14:21+00:00
...
class ImageClassificationParameters(BaseModel):
    function_to_apply: Optional[ClassificationOutputTransform] = Field(
        None, title="ImageClassificationOutputTransform"
    )
    top_k: Optional[int] = Field(
        None,
...
class ImageClassificationInput(BaseModel):
    ...
    parameters: Optional[ImageClassificationParameters] = Field(None, description="Additional inference parameters")
