...
#   filename:  input.json
#   timestamp: 2024-10-25T08:14:18+00:00
...
class AudioClassificationParameters(BaseModel):
    function_to_apply: Optional[ClassificationOutputTransform] = Field(
        None, title="AudioClassificationOutputTransform"
    )
    top_k: Optional[int] = Field(
        None,
...
class AudioClassificationInput(BaseModel):
    ...
    parameters: Optional[AudioClassificationParameters] = Field(None, description="Additional inference parameters")
