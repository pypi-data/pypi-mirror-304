...
class PromptManager:
    ...
    def create_prompt(self,
        ...
        self.prompt =self.create_prompt_guide(request=self.request_data[chunk_token_distribution_number].replace('*n*','\n'),
        ...
        max_tokens = self.model_mgr.selected_max_tokens -num_tokens_from_string(str({"model": self.model_mgr.selected_model_name, "messages": [{"role": self.role or "user", "content":self.prompt.replace('*n*','\n') }]}))
