### rjj (read-joint-jet) [![Static Badge](https://img.shields.io/badge/ver-0.8.1-black?logo=github)](https://github.com/calcuis/rjj/releases)
...
#### report
generate pdf report(s); beta test with columns: id, name, group, min
```
rjj report
```
#### home
