    ...
    async def get_coding_request(self, file, techStack):
        ...
        try:
            ...
            if lines and lines[-1] == ">>>>>>> REPLACE":
                ...
                if continuation_lines and continuation_lines[-1] == ">>>>>>> REPLACE":
                    ...
                    if continuation_lines and continuation_lines[-1] == ">>>>>>> REPLACE":
                        ...
                        continuation_lines = [line.strip() for line in continuation_content2continuation_content2.splitlines() if line.strip()]
