...
class CodingAgent:
    ...
    async def get_coding_request(self, file, techStack):
        ...
        try:
            response = await self.ai.coding_prompt_v2(self.conversation_history, self.max_tokens, 0.2, 0.1)
            ...
            if content.endswith(">>>>>>> REPLACE"):
                ...
                continuation_response = await self.ai.coding_prompt_v2(self.conversation_history, self.max_tokens, 0.2, 0.1)
