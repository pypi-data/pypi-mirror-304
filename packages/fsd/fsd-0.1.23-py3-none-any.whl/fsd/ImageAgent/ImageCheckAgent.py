        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "2. Return '1' if there's any hint of new image creation needed, including vague or implicit requests.\n"
                    "3. Return '0' only if the prompt clearly does not involve any new image creation.\n\n"
