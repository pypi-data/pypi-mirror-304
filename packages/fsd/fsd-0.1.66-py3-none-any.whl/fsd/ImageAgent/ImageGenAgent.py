...
class ImageGenAgent:
    ...
    async def generate_image(self, prompt: str, dalle_dimension: str, actual_dimension: str, image_format: str, file_path: str, style: str, tier: str):
        """
        ...
        for attempt in range(max_retries):
            try:
                ...
                response = await asyncio.to_thread(self.ai.generate_image, prompt=prompt, size=supported_size, style=style, tier=tier)
