        ...
        messages = [
            {
                "role": "system",
                "content": (
                    "You are an image request analyzer. Determine if the development plan requires generating ANY new images in png, jpg, jpeg, or ico format.\n\n"
                    "Rules:\n"
                    "1. Ignore tasks about modifying or moving existing images.\n"
                    "2. Return '1' if there's any hint of new image creation needed.\n"
                    "3. Return '0' only if absolutely no new images are required.\n\n"
            ...
            {
                "role": "user",
                "content": f"Analyze this request for new image in (png, jpg, jpeg, or ico) creation needs: {user_prompt}"
            }
        ]
