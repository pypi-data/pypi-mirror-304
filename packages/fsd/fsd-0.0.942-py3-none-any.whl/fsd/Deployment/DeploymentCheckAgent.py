        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    '    "result": "0" or "1",\n'
                    '    "project_type": "0" or "1",\n'
                    '    "full_project_path": "full/path/to/project_folder/index.html" or "full/path/to/project_folder/package.json" or null\n'
                    "}\n"
                    "Where 'result' is '1' if eligible, '0' if not. "
                    "'project_type' is '0' for purely static HTML/CSS, '1' for React-based project. "
                    "For HTML/CSS, 'full_project_path' must be the full path to index.html, e.g., '/home/user/projects/mysite/index.html'. "
                    "For React-based projects, 'full_project_path' must be the full path to package.json, e.g., '/home/user/projects/myapp/package.json'. "
