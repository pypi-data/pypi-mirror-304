...
class add_host_req(_message.Message):
    __slots__ = ["dhchap_ctrlr_key", "dhchap_key", "host_nqn", "psk", "subsystem_nqn"]
    DHCHAP_CTRLR_KEY_FIELD_NUMBER: _ClassVar[int]
    ...
    psk: str
    subsystem_nqn: str
    def __init__(self, subsystem_nqn: _Optional[str] = ..., host_nqn: _Optional[str] = ..., psk: _Optional[str] = ..., dhchap_key: _Optional[str] = ..., dhchap_ctrlr_key: _Optional[str] = ...) -> None: ...
...
class create_subsystem_req(_message.Message):
    __slots__ = ["enable_ha", "max_namespaces", "no_group_append", "serial_number", "subsystem_nqn"]
    ...
    serial_number: str
    subsystem_nqn: str
    def __init__(self, subsystem_nqn: _Optional[str] = ..., serial_number: _Optional[str] = ..., max_namespaces: _Optional[int] = ..., enable_ha: bool = ..., no_group_append: bool = ...) -> None: ...
