...
class Contact:
    ...
    BankAccount: Optional[str] = field(default=None)
    Swift: Optional[str] = field(default=None)
    RegistrationNumber: Optional[str] = field(default=None)
    VatNumber: Optional[str] = field(default=None)
    Industry: Optional[str] = field(default=None)
    Region: Optional[str] = field(default=None)
    Employees: Optional[int] = field(default=None)
    YearlyRevenue: Optional[int] = field(default=None)
    EUVatNumber: Optional[str] = field(default=None)
    FoundingYear: Optional[int] = field(default=None)
    Capital: Optional[int] = field(default=None)
    MainActivity: Optional[str] = field(default=None)
    BisnodeTrafficLight: Optional[str] = field(default=None)
    GroupIdentificationNumber: Optional[str] = field(default=None)
    NonGovernmentalOrganization: Optional[str] = field(default=None)
    MegjegyzesACimmelKapcsolatban: Optional[str] = field(default=None)
    Tags: Optional[List[str]] = field(default=None)
    Position: Optional[str] = field(default=None)
    DataManagement_Consent: Optional[str] = field(default=None)
    MegjegyzesACimmelKapcsolatban2: Optional[str] = field(default=None)
    SzamlazasiNev: Optional[str] = field(default=None)
    BusinessId: Optional[int] = field(default=None)
