...
from fastmodels.types.easyllm.response_params import CreateTranscriptionResponse, ChatCompletionResponse, \
...
class Threads:
    ...
    def create_and_run(self, agent_id: str, messages: List[Dict[str, Any]], stream: bool = True) -> Union[
        Generator[AgentCompletionChunk, None, None], ChatCompletionResponse]:
        """
        向服务器发送请求，创建一个新的聊天完成实例，并可选择是否以流的形式接收响应。
        ...
        参数:
            ...
            stream (bool, optional): 是否以流的形式接收响应，默认为True。
