...
=== "Before"
    ...
    ```py
    from fastapi_users_with_username.authentication import JWTAuthentication
...
=== "Before"
    ...
    ```py
    from fastapi_users_with_username.authentication import CookieAuthentication
...
=== "After"
    ...
    ```py
    from fastapi_users_with_username.authentication import AuthenticationBackend, CookieTransport, JWTStrategy
...
=== "Before"
    ...
    ```py
    app.include_router(
        fastapi_users_with_username.get_oauth_router(google_oauth_client, "SECRET"),
        prefix="/auth/google",
        tags=["auth"],
    )
    ```
