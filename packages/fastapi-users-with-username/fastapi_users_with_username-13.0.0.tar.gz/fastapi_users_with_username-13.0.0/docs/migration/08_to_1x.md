...
app.include_router(fastapi_users_with_username.router, prefix="/users", tags=["users"])


@fastapi_users_with_username.on_after_register()
def on_after_register(user: User, request: Request):
    print(f"User {user.id} has registered.")


@fastapi_users_with_username.on_after_forgot_password()
...
app.include_router(
    fastapi_users_with_username.get_auth_router(jwt_authentication), prefix="/auth/jwt", tags=["auth"]
)
app.include_router(
    fastapi_users_with_username.get_register_router(on_after_register), prefix="/auth", tags=["auth"]
)
app.include_router(
