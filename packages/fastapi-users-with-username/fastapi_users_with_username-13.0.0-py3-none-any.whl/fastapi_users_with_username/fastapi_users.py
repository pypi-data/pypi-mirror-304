...
from fastapi_users_with_username.manager import UserManagerDependency
from fastapi_users_with_username.router import (
    get_auth_router,
    get_register_router,
...
try:
    ...
    from fastapi_users_with_username.router import get_oauth_router
    from fastapi_users_with_username.router.oauth import get_oauth_associate_router
