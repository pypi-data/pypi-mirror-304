...
class WelcomeController(Controller):
    def play_with_session(self, request: Request, view: View, response: Response):
    ...
    def show(self, request: Request, view: View, response: Response):
        request.app.make("session").flash("test", "value")
        if request.input("name"):
            return response.redirect("/").with_errors([{"name": "Name is required"}])
        return view.render("welcome")
