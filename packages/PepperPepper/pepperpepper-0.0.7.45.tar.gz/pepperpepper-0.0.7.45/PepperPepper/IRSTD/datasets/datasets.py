...
def load_datasets(mode = 'train', img_size = 256, data_dir = r'/mnt/e/datasets/IRSTD-1k', batch_size = 8,shuffle = True, transform = None):
    return torch.utils.data.DataLoader(Dataset(mode = 'train', img_size = 256, data_dir = r'/mnt/e/datasets/IRSTD-1k', transform = transform), batch_size = batch_size, shuffle = shuffle)
...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, i):
        ...
        label_path = os.path.join(self.data_dir, 'masks', name)
...
class IRSTD1kDataset(torch.utils.data.Dataset):
    '''
    Return: Single channel
    '''
