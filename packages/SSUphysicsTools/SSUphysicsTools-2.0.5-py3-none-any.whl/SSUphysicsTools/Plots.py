...
class DataPlots(get_all_csv_paths_in_data):
    def __init__(self,plot_name:tuple[str], flatten:Optional[bool]=False):
        '''
    ...
    # plots
    def data_plots(self, is_save:Optional[bool]=False,dpi:Optional[int]=300):
        '''
