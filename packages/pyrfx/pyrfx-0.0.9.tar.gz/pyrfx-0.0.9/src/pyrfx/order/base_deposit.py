...
class Deposit(ABC):
    ...
    def __init__(
        ...
        self._exchange_router_contract: Contract | None = get_exchange_router_contract(config)
    ...
    def create_and_execute(self) -> None:
        ...
        try:
            ...
            multicall_args: list[HexBytes] = [self._send_wnt(int(total_wnt_amount + execution_fee))]
