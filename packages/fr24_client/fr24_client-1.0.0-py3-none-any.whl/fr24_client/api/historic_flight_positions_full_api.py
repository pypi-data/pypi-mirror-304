...
from fr24_client.api_client import ApiClient, RequestSerialized
from fr24_client.api_response import ApiResponse
from fr24_client.rest import RESTResponseType
...
class HistoricFlightPositionsFullApi:
    ...
    def get_historic_flight_positions_full(
        ...
        timestamp: Annotated[StrictInt, Field(description="Unix timestamp to fetch data from, up to a maximum of 3 years in the past, depending on subscription plan availability. Only a single value is accepted.")],
        ...
        Returns comprehensive real-time information on aircraft flight movements, including flight and aircraft details such as origin, destination, and equipment type. At least one query parameter and a history snapshot timestamp are required to retrieve data.
        ...
        :param timestamp: Unix timestamp to fetch data from, up to a maximum of 3 years in the past, depending on subscription plan availability. Only a single value is accepted. (required)
        :type timestamp: int
