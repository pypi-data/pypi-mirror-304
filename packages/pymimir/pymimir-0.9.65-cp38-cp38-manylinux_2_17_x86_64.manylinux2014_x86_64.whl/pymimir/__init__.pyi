...
class Certificate2FWL:
    ...
    def __str__(self) -> str:
        ...
    def get_canonical_coloring(self) -> set[int]:
        ...
...
class VariableList:
    ...
    def remove(self, x: Variable) -> None:
        ...
        Remove the first item from the list whose value is x. It is an error if there is no such item.
        """
def compute_certificate_2fwl(static_vertex_colored_digraph: StaticVertexColoredDigraph) -> Certificate2FWL:
    ...
def compute_certificate_3fwl(static_vertex_colored_digraph: StaticVertexColoredDigraph) -> Certificate3FWL:
    ...
def compute_certificate_4fwl(static_vertex_colored_digraph: StaticVertexColoredDigraph) -> Certificate4FWL:
    ...
