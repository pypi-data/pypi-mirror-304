...
class FileAtom(WriterAtom):
  ...
  def __init__(self,title,selector,value,wait_time=5,parent_selector=None,timeout=10):
    '''
    ...
    '''
    super().__init__(self._kind,title,selector,value,parent_selector,timeout)
