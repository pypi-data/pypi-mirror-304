...
from Adlib.api import putRequestFunction, IntegracaoStatus
...
def importarArquivos(virtaus, idBanco: int, codigoBanco: int, nomeBanco: str, substring: str, formatoArquivo: str, usuarioWindows: str):
    ...
    try:
        putRequestFunction(IntegracaoStatus.IMPORTANDO, ENUM_PROCESSO, idBanco)
        ...
        if qntArquivos == 0:
            putRequestFunction(IntegracaoStatus.SEM_ARQUIVOS, ENUM_PROCESSO, idBanco)
        ...
        for i, arquivo in enumerate(arquivosFiltrados, start=1):
            ...
            try:
                ...
                putRequestFunction(IntegracaoStatus.LIGADO, ENUM_PROCESSO, idBanco)
        ...
        print(erro)
        print('Não deu certo')
        putRequestFunction(IntegracaoStatus.ERRO, ENUM_PROCESSO, idBanco)
