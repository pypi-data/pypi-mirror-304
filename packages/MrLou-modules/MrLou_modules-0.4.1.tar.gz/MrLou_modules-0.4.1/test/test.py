from MrLou_modules.Certificate_Utils.cert_utils import extract_cn_from_pfx, convert_pkcs12_to_x509_with_root_chain
...
extract_cn_from_pfx(p12_path, p12_password)
