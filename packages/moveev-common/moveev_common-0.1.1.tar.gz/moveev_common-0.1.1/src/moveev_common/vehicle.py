from sqlalchemy import Column, Integer, DateTime, String, BigInteger, ForeignKey
...
class Vehicle(Base):
    ...
    vehicle_vin = Column(String, unique=True, nullable=False)
    telematics_device_vehicle_id = Column(BigInteger)
