...
p.request_constructor("GET","/index/ajax/lang?lang=..//..//application/database",output="body")
...
r=driver.scan(["https://www.xiangjiuye.com:443","https://back.tjyunsen.com:443"],output=True)
js=[
