...
from ...oauth import (OAuthClient, OAuthToken, OpenIDAuthorizationCodeGrant as AuthCodeGrant,TokenValidator, TokenGenerator, JwtTokenGenerator, JwtTokenValidator)
...
def config_oidc_oauth(app, query_client=None, save_token=None, token_generators=[]):
    ...
    require_oidc_oauth.register_token_validator(JwtTokenValidator())
