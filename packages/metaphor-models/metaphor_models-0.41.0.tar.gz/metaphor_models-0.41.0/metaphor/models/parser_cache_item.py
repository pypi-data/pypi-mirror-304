...
class Species18124___ToStringTag8530(Enum):
    SHARED_ARRAY_BUFFER = "SharedArrayBuffer"


@dataclass
class SharedArrayBuffer:
    species_18124: Optional['SharedArrayBuffer'] = None
    to_string_tag_8530: Optional[Species18124___ToStringTag8530] = None
    byte_length: Optional[float] = None

    @staticmethod
    def from_dict(obj: Any) -> 'SharedArrayBuffer':
        assert isinstance(obj, dict)
        species_18124 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@18124"))
        to_string_tag_8530 = from_union([Species18124___ToStringTag8530, from_none], obj.get("__@toStringTag@8530"))
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        return SharedArrayBuffer(species_18124, to_string_tag_8530, byte_length)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.species_18124 is not None:
            result["__@species@18124"] = from_union([lambda x: to_class(SharedArrayBuffer, x), from_none], self.species_18124)
        if self.to_string_tag_8530 is not None:
            result["__@toStringTag@8530"] = from_union([lambda x: to_enum(Species18124___ToStringTag8530, x), from_none], self.to_string_tag_8530)
...
class ArrayBufferLike:
    ...
    def from_dict(obj: Any) -> 'ArrayBufferLike':
        ...
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        species_18124 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@18124"))
        return ArrayBufferLike(to_string_tag_8530, byte_length, species_18124)
