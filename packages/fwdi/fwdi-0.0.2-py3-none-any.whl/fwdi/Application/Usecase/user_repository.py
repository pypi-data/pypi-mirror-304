...
from ...Persistence.Abstractions.base_manager_context import BaseManagerContext
...
class UserRepository(BaseUserRepository):
    ...
    def get_user_scopes(self, email:str, manager_db_context: BaseManagerContext) -> list[str]:
