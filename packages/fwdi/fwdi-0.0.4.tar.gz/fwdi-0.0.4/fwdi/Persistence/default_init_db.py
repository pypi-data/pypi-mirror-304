    ...
    def __default_data():
        ...
        if len(User.select()) == 0:
            user = User(username='admin', 
                        ...
                        disabled=False, scopes=permission_admin)
            ...
            user = User(username='user', 
                        full_name='user', 
                        email='user@user.ru', 
                        hashed_password=JwtTools.get_password_hash('user'), 
                        disabled=False, 
                        scopes=permission_user)
            ...
            user = User(username='guest', 
                        ...
                        hashed_password=JwtTools.get_password_hash('guest'), 
                        disabled=False, 
                        scopes=permission_guest)
