...
class SynthesisConfig:
    ...
    Attributes:
        ...
        tuft_number_file: Path to the file containing the distribution of number of tufts
            per pathway.
    ...
    tuft_number_file: FileType | None = field(default=None, converter=converters.optional(Path))
    ...
    *,
    ...
    try:
        ...
        for axon_id, axon_terminals in morph_terminals.groupby("axon_id"):
            ...
            axon_custom_logger.critical("AFTER GRAPH CREATION")
            ...
            axon_custom_logger.critical("AFTER COMPUTE SOLUTION")
            ...
            axon_custom_logger.critical("AFTER BUILD AND GRAFT TRUNK")
            ...
            axon_custom_logger.critical("AFTER PICK BARCODES")
            ...
            axon_custom_logger.critical("AFTER POST-PROCESS")
            ...
            axon_custom_logger.critical("AFTER BUILD AND GRAFT TUFTS")
