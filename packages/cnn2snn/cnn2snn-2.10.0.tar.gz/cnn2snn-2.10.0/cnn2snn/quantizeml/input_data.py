...
def _create_input_data(layer, input_16bits=False):
    ...
    if get_akida_version() == AkidaVersion.v1:
        ...
        input_bits = 16 if input_16bits else 8
...
def convert_input(model_ak, model_k):
    ...
    stateful_layers = get_layer_by_type(model_k.layers, StatefulRecurrent)
    input_data = _create_input_data(layer_k, stateful_layers is not None)
