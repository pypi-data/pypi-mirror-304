...
class AddressLookup:
    def __init__(self, canadian_postal_codes_path, us_zip_codes_path, llama_model, failed_path='failed.txt', can_key='CITY', usa_key='City' debug=False, remote=False, remote_api_base=None, remote_api_key=None):
        # Load data
        ...
        try:
            ...
            if data:
                ...
                with open(self.failed_path, 'a') as f:
                    f.write(f"{data['city']}, {data['state_or_province']}\n")
                return None
