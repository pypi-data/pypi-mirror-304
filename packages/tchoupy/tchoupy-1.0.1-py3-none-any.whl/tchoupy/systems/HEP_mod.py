...
- Conversions of other units to powers of electronvolt are based on:
    ...
    - q_p = 1 (Planck charge. The Planck charge is defined as 
               ...
               There is a big caveat: while values of hbar and c are exact in the
...
HEP = ConversionSystem('HEP',
                ...
                [
                 ...
                 ('C', np.sqrt(const.alpha) / const.e),  # q_P = 1
                ],
                ...
                s = (1. / const.hbar, 'J_1'),  # hbar = 1
                m = (1. / const.c, 's'),  # c = 1
                g = ((1./const.kilo) * const.c**2, 'J'),  # c = 1
                K = (const.k, 'J'),  # k_B = 1
                
                # Or: const.value['Planck mass energy equivalent in eV']
                MPl = (np.sqrt(const.c * const.hbar / const.G), 'kg'),                
                ...
                tPl = (np.sqrt(const.hbar * const.G / const.c**5), 's'),
                lPl = 'tPl', #or : lPl = (const.c, 'tPl1m1s_1'),
                min = (const.minute, 's'),
                hr = (const.hour, 's'),
