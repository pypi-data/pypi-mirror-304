...
class File:
    ...
    def nchroms(self, arg: bool, /) -> int:
        """Get the total number of chromosomes."""

    def attributes(self) -> dict:
        """Get file attributes as a dictionary."""

    def fetch(self, range1: str = '', range2: str = '', normalization: str = 'NONE', count_type: str = 'int', join: bool = False, query_type: str = 'UCSC') -> PixelSelector:
    ...
    def weights(self, name: str, divisive: bool = True) -> list[float]:
...
class PixelSelector:
    ...
    def coord1(self) -> tuple[str, int, int, str, int, int]:
        """Get query coordinates for the first dimension."""

    def coord2(self) -> tuple[str, int, int, str, int, int]:
