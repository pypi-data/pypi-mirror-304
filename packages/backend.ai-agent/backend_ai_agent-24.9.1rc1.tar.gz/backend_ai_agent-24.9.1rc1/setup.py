...
setup(**{
    ...
    'install_requires': (
        ...
        'async_timeout~=4.0',
        'attrs>=24.2',
        """backend.ai-cli==24.09.1rc1
""",
        """backend.ai-common==24.09.1rc1
""",
        """backend.ai-kernel-binary==24.09.1rc1
""",
        """backend.ai-kernel-helper==24.09.1rc1
""",
        """backend.ai-kernel==24.09.1rc1
""",
        'backend.ai-krunner-static-gnu==4.3.0',
        """backend.ai-logging==24.09.1rc1
""",
        """backend.ai-plugin==24.09.1rc1
""",
        'cachetools~=5.5.0',
        'callosum~=1.0.3',
        'cattrs~=24.1.1',
