...
from czl import CzlAI, AsyncCzlAI, APIResponseValidationError
from czl._types import Omit
from czl._models import BaseModel, FinalRequestOptions
from czl._constants import RAW_RESPONSE_HEADER
from czl._exceptions import CzlAIError, APIStatusError, APITimeoutError, APIResponseValidationError
from czl._base_client import DEFAULT_TIMEOUT, HTTPX_DEFAULT_TIMEOUT, BaseClient, make_request_options
...
class TestCzlAI:
    client = CzlAI(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_client_timeout_option(self) -> None:
        client = CzlAI(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(CzlAIError):
            with update_env(**{"CZLAI_API_KEY": Omit()}):
                client2 = CzlAI(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_base_url_setter(self) -> None:
        client = CzlAI(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(CZL_AI_BASE_URL="http://localhost:5000/from/env"):
            client = CzlAI(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            CzlAI(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            CzlAI(
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            CzlAI(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = CzlAI(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = CzlAI(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("czl._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
...
class TestAsyncCzlAI:
    client = AsyncCzlAI(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(CzlAIError):
            with update_env(**{"CZLAI_API_KEY": Omit()}):
                client2 = AsyncCzlAI(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_base_url_setter(self) -> None:
        client = AsyncCzlAI(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
        assert client.base_url == "https://example.com/from_init/"
    ...
    def test_base_url_env(self) -> None:
        with update_env(CZL_AI_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncCzlAI(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncCzlAI(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncCzlAI(base_url=base_url, api_key=api_key, _strict_response_validation=False)
