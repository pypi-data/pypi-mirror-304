...
class TestUser:
    ...
    @parametrize
    def test_path_params_retrieve(self, client: CzlAI) -> None:
    ...
    @parametrize
    def test_path_params_update(self, client: CzlAI) -> None:
    ...
    @parametrize
    def test_path_params_delete(self, client: CzlAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `username` but received ''"):
    ...
    @parametrize
    def test_method_create_with_list(self, client: CzlAI) -> None:
    ...
    @parametrize
    def test_raw_response_create_with_list(self, client: CzlAI) -> None:
    ...
    @parametrize
    def test_streaming_response_create_with_list(self, client: CzlAI) -> None:
    ...
    @parametrize
    def test_method_login(self, client: CzlAI) -> None:
        user = client.user.login()
        assert_matches_type(str, user, path=["response"])

    @parametrize
    def test_method_login_with_all_params(self, client: CzlAI) -> None:
        user = client.user.login(
            password="password",
            username="username",
        )
    ...
    @parametrize
    def test_raw_response_login(self, client: CzlAI) -> None:
    ...
    @parametrize
    def test_streaming_response_login(self, client: CzlAI) -> None:
...
class TestAsyncUser:
    ...
    @parametrize
    async def test_path_params_retrieve(self, async_client: AsyncCzlAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `username` but received ''"):
    ...
    @parametrize
    async def test_path_params_update(self, async_client: AsyncCzlAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `existing_username` but received ''"):
    ...
    @parametrize
    async def test_path_params_delete(self, async_client: AsyncCzlAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `username` but received ''"):
    ...
    @parametrize
    async def test_method_create_with_list(self, async_client: AsyncCzlAI) -> None:
    ...
    @parametrize
    async def test_raw_response_create_with_list(self, async_client: AsyncCzlAI) -> None:
    ...
    @parametrize
    async def test_streaming_response_create_with_list(self, async_client: AsyncCzlAI) -> None:
    ...
    @parametrize
    async def test_method_login(self, async_client: AsyncCzlAI) -> None:
        user = await async_client.user.login()
        assert_matches_type(str, user, path=["response"])

    @parametrize
    async def test_method_login_with_all_params(self, async_client: AsyncCzlAI) -> None:
        user = await async_client.user.login(
            password="password",
            username="username",
        )
    ...
    @parametrize
    async def test_raw_response_login(self, async_client: AsyncCzlAI) -> None:
    ...
    @parametrize
    async def test_streaming_response_login(self, async_client: AsyncCzlAI) -> None:
