...
class SupplyChainClient(BaseClient):
    ...
    def create_data_integration_flow(
        ...
        the data transformation query provided with the
        API.
    ...
    def create_instance(
        ...
        without using the Amazon Web Services
        console.
    ...
    def delete_instance(
        ...
        API without using the Amazon Web Services
        console.
    ...
    def get_data_integration_flow(
        ...
        Amazon Web Services Supply Chain instance and DataIntegrationFlow
        name.
    ...
    def untag_resource(
        ...
        instance, data flow, or dataset in AWS Supply
        Chain.
    ...
    def update_data_integration_flow(
        ...
        along with the data transformation query provided with the
        A...
    ...
    def update_instance(
        ...
        ID, instance ID and so on without using the AWS
        console.
