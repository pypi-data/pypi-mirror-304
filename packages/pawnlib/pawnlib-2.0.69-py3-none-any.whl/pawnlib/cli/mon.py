...
def setup_app_logger(log_type: str = 'console', verbose: int = 0, app_name: str = ""):
    ...
    # return logger
    return setup_logger(logger, "Monitoring CLI", verbose)
...
def main():
    ...
    pawn.console.log(f"Logger = {logger}")
    ...
    # send_slack(
    #     title=f"Start {args.command.title()} {local_ip_list}",
    #     msg_text={"IPs": local_ip_list},
    #     status="info",
    #     msg_level="info",
