...
class DockerComposeBuilder:
    ...
    # def get_volumes(self, default_volume=None):
    #     """
    #     Get volume mappings from the user and validate the format.
    #
    #     :param default_volume: A list of default volume mappings. If None, it will default to ["./data:/data"].
    #     """
    ...
    #
    #     for default in default_volume:
    #         pawn.console.print(f"[bold green]Default volume added: {default}[/bold green]")
    #
    #     while True:
    #         volume = self.get_valid_input("Enter the volume mount", default=None)
    #         if self.is_valid_volume_mapping(volume):
    #             volumes.append(volume)
    #         else:
    #             pawn.console.print(f"[bold red]Invalid volume format. Please use the format ./data:/app/data.[/bold red]")
