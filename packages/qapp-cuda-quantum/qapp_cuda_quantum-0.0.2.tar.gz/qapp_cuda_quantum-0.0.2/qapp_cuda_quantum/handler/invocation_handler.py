"""
    QApp platform Project invocation_handler.py 
...
from ..component.backend.cuda_quantum_invocation import CudaQuantumInvocation
...
class InvocationHandler(Handler):
    ...
    def handle(self):
        ...
        backend = CudaQuantumInvocation(invocation_request)
