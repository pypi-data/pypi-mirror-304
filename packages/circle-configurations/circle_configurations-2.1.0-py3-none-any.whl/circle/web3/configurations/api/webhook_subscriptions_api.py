...
class WebhookSubscriptionsApi(object):
    ...
    @validate_arguments
    def get_notification_signature_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier (UUID v4) of the resource.")], x_request_id : Annotated[Optional[StrictStr], Field(description="Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get a notification signature public key  # noqa: E501
