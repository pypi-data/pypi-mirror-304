...
class ViewUpdateApi(object):
    ...
    @auto_fill
    @validate_arguments
    def get_contract(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier (UUID v4) of the resource.")], **kwargs) -> ContractResponse:  # noqa: E501
    ...
    @auto_fill
    @validate_arguments
    def get_contract_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier (UUID v4) of the resource.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a contract  # noqa: E501
    ...
    @auto_fill
    @validate_arguments
    def update_contract(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier (UUID v4) of the resource.")], patch_contract_request : Annotated[PatchContractRequest, Field(..., description="Update contract properties request")], **kwargs) -> ContractResponse:  # noqa: E501
    ...
    @auto_fill
    @validate_arguments
    def update_contract_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier (UUID v4) of the resource.")], patch_contract_request : Annotated[PatchContractRequest, Field(..., description="Update contract properties request")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update a contract  # noqa: E501
