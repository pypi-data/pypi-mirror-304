...
def dashboard() -> None:
  ...
  #   daemon = next(
  #     filter(
  #       lambda container: match(r"acqua-(mainnet|signet|testnet)", container.name),
  ...
  # )
  # container_names: List[None | str] = list(map(lambda container: container.name, acqua_containers))
