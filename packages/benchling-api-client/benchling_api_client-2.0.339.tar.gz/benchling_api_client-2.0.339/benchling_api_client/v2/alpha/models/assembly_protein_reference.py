...
class AssemblyProteinReference:
    ...
    _polymer_type: Union[Unset, AssemblyProteinReferencePolymerType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_polymer_type() -> Union[Unset, AssemblyProteinReferencePolymerType]:
            polymer_type = UNSET
        ...
        try:
            ...
            if strict:
                raise
            polymer_type = cast(Union[Unset, AssemblyProteinReferencePolymerType], UNSET)
