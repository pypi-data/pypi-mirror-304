...
class AssemblyHomologyMethodParameters:
    ...
    _ambiguous_construct_preference: Union[
        Unset, AssemblyHomologyMethodParametersAmbiguousConstructPreference
    ] = UNSET
    _fragment_production_method: Union[
        Unset, AssemblyHomologyMethodParametersFragmentProductionMethod
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        try:
            ...
            ambiguous_construct_preference = cast(
                Union[Unset, AssemblyHomologyMethodParametersAmbiguousConstructPreference], UNSET
            )
        ...
        try:
            ...
            fragment_production_method = cast(
                Union[Unset, AssemblyHomologyMethodParametersFragmentProductionMethod], UNSET
            )
