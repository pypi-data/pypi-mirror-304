...
class AssemblySequenceReference:
    ...
    _polymer_type: Union[Unset, AssemblySequenceReferencePolymerType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_polymer_type() -> Union[Unset, AssemblySequenceReferencePolymerType]:
            polymer_type = UNSET
        ...
        try:
            ...
            if strict:
                raise
            polymer_type = cast(Union[Unset, AssemblySequenceReferencePolymerType], UNSET)
