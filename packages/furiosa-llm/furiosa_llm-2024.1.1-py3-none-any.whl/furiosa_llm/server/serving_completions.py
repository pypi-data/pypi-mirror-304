...
class OpenAIServingCompletion(OpenAIServing):
    ...
    async def create_completion(
        ...
        try:
            sampling_params = request.to_sampling_params(self.max_model_len)
    ...
    async def completion_stream_generator(
        ...
        try:
            ...
            result_generator: List[AsyncGenerator[str, None]] = [
                self.llm.stream_generate(prompt, request.to_sampling_params(self.max_model_len), tokenizer_kwargs={"add_special_tokens": True})  # type: ignore
