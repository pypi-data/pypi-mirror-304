...
from furiosa_llm.parallelize.model_rewriter.utils import set_device_id
...
class CCCalculator:
        ...
        if len(idxes) == len(mesh.size()):
            ...
            if cur_placement.is_replicate():
                ...
                self._insert_new_op(
                    ...
                    subroots,
                    (root,),
                    Reduce(partial.reduce_op, root, comm_group, self.device_id_to_device),
                )
            else:
    ...
    def _same_mesh_partial_to_replicate(
        ...
        self._insert_new_op(
            ...
            group,
            group,
            AllReduce(current.reduce_op, comm_group, self.device_id_to_device),
        )
