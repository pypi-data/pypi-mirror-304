...
class TestWebRecruitmentSDK:
    ...
    def test_base_url_env(self) -> None:
        with update_env(WEB_RECRUITMENT_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = WebRecruitmentSDK(api_key=api_key, bearer_token=bearer_token, _strict_response_validation=True)
...
class TestAsyncWebRecruitmentSDK:
    ...
    def test_base_url_env(self) -> None:
        with update_env(WEB_RECRUITMENT_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncWebRecruitmentSDK(
                api_key=api_key, bearer_token=bearer_token, _strict_response_validation=True
            )
            assert client.base_url == "http://localhost:5000/from/env/"
