...
from web_recruitment_sdk.types.admin import AccountRead, AccountListResponse
...
class TestAccounts:
    ...
    def test_method_create(self, client: WebRecruitmentSDK) -> None:
        account = client.admin.accounts.create(
            name="name",
            tenant="tenant",
            tenant_lookup_identifier="tenantLookupIdentifier",
        )
        assert_matches_type(AccountRead, account, path=["response"])
    ...
    def test_method_retrieve(self, client: WebRecruitmentSDK) -> None:
        account = client.admin.accounts.retrieve(
            0,
        )
        assert_matches_type(AccountRead, account, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: WebRecruitmentSDK) -> None:
        response = client.admin.accounts.with_raw_response.retrieve(
            0,
        )
    ...
    def test_streaming_response_retrieve(self, client: WebRecruitmentSDK) -> None:
        with client.admin.accounts.with_streaming_response.retrieve(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_list(self, client: WebRecruitmentSDK) -> None:
        account = client.admin.accounts.list()
    ...
    def test_raw_response_list(self, client: WebRecruitmentSDK) -> None:
        response = client.admin.accounts.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: WebRecruitmentSDK) -> None:
        with client.admin.accounts.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncAccounts:
    ...
    async def test_method_create(self, async_client: AsyncWebRecruitmentSDK) -> None:
        account = await async_client.admin.accounts.create(
            name="name",
            tenant="tenant",
            tenant_lookup_identifier="tenantLookupIdentifier",
        )
    ...
    async def test_raw_response_create(self, async_client: AsyncWebRecruitmentSDK) -> None:
        response = await async_client.admin.accounts.with_raw_response.create(
            name="name",
            tenant="tenant",
            tenant_lookup_identifier="tenantLookupIdentifier",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncWebRecruitmentSDK) -> None:
        async with async_client.admin.accounts.with_streaming_response.create(
            name="name",
            tenant="tenant",
            tenant_lookup_identifier="tenantLookupIdentifier",
        ) as response:
    ...
    async def test_method_retrieve(self, async_client: AsyncWebRecruitmentSDK) -> None:
        account = await async_client.admin.accounts.retrieve(
            0,
        )
        assert_matches_type(AccountRead, account, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncWebRecruitmentSDK) -> None:
        response = await async_client.admin.accounts.with_raw_response.retrieve(
            0,
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncWebRecruitmentSDK) -> None:
        async with async_client.admin.accounts.with_streaming_response.retrieve(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list(self, async_client: AsyncWebRecruitmentSDK) -> None:
        account = await async_client.admin.accounts.list()
        assert_matches_type(AccountListResponse, account, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncWebRecruitmentSDK) -> None:
        response = await async_client.admin.accounts.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncWebRecruitmentSDK) -> None:
        async with async_client.admin.accounts.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
