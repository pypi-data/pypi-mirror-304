...
def show_status_icon(iconPath: str, title: str, funcArgs: tuple[Any], customExitFunction: Callable[[Any], Any]|None = None, addMenuItems: list[MenuItem] = [], useDefault: bool = True) -> None:
    """
