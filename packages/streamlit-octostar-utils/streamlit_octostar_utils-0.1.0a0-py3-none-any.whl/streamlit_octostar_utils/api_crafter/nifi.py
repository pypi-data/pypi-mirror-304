...
class NifiContextManager(object):
    ...
    def raise_exception(self, entity, exc):
        ...
        if 'nifi_attributes' not in entity.request['config']:
            entity.request['config']['nifi_attributes'] = {}
        travel_dict(entity.request['config']['nifi_attributes'], ['invokehttp', 'response', 'body'], 'w')(entity.request['exception']['body'])
        travel_dict(entity.request['config']['nifi_attributes'], ['invokehttp', 'response', 'code'], 'w')(entity.request['exception']['code'])
