...
class ContainerContainerPullThroughDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, content_guard=None, hidden=False, pulp_href=None, no_content_change_since=None, pulp_created=None, repository=None, name=None, pulp_last_updated=None, base_path=None, prn=None, remote=None, distributions=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
