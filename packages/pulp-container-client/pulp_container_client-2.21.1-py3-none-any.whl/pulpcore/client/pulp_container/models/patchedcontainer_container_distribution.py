...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, pulp_labels=None, content_guard=None, hidden=False, repository=None, name=None, base_path=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
