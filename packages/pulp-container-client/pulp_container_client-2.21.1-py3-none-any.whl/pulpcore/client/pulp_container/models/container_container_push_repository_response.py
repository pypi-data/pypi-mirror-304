...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_labels=None, versions_href=None, manifest_signing_service=None, pulp_href=None, description=None, pulp_created=None, name=None, pulp_last_updated=None, latest_version_href=None, retain_repo_versions=None, prn=None, local_vars_configuration=None):  # noqa: E501
