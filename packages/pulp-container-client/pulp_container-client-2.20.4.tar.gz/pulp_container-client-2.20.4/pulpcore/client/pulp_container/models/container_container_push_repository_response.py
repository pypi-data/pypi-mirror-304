...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, name=None, manifest_signing_service=None, versions_href=None, pulp_last_updated=None, pulp_labels=None, retain_repo_versions=None, pulp_href=None, latest_version_href=None, description=None, local_vars_configuration=None):  # noqa: E501
