...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, hidden=False, repository=None, base_path=None, pulp_last_updated=None, pulp_labels=None, pulp_href=None, name=None, content_guard=None, repository_version=None, registry_path=None, remote=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
