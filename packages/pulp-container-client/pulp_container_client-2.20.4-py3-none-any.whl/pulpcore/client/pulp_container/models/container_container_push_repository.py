...
class ContainerContainerPushRepository(object):
    ...
    def __init__(self, name=None, manifest_signing_service=None, pulp_labels=None, retain_repo_versions=None, description=None, local_vars_configuration=None):  # noqa: E501
