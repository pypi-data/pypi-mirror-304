        ...
        class Ax25InfoData(KaitaiStruct):
            ...
            def digital4(self):
                if hasattr(self, '_m_digital4'):
                    return self._m_digital4 if hasattr(self, '_m_digital4') else None
            ...
            def counter(self):
                if hasattr(self, '_m_counter'):
                    return self._m_counter if hasattr(self, '_m_counter') else None
            ...
            def analog4(self):
                if hasattr(self, '_m_analog4'):
                    return self._m_analog4 if hasattr(self, '_m_analog4') else None
            ...
            def analog1(self):
                if hasattr(self, '_m_analog1'):
                    return self._m_analog1 if hasattr(self, '_m_analog1') else None
            ...
            def digital5(self):
                if hasattr(self, '_m_digital5'):
                    return self._m_digital5 if hasattr(self, '_m_digital5') else None
            ...
            def digital3(self):
                if hasattr(self, '_m_digital3'):
                    return self._m_digital3 if hasattr(self, '_m_digital3') else None
            ...
            def digital6(self):
                if hasattr(self, '_m_digital6'):
                    return self._m_digital6 if hasattr(self, '_m_digital6') else None
            ...
            def telemetry_beacon(self):
                if hasattr(self, '_m_telemetry_beacon'):
                    return self._m_telemetry_beacon if hasattr(self, '_m_telemetry_beacon') else None
            ...
            def digital2(self):
                if hasattr(self, '_m_digital2'):
                    return self._m_digital2 if hasattr(self, '_m_digital2') else None
            ...
            def digital1(self):
                if hasattr(self, '_m_digital1'):
                    return self._m_digital1 if hasattr(self, '_m_digital1') else None
            ...
            def analog3(self):
                if hasattr(self, '_m_analog3'):
                    return self._m_analog3 if hasattr(self, '_m_analog3') else None
            ...
            def digital8(self):
                if hasattr(self, '_m_digital8'):
                    return self._m_digital8 if hasattr(self, '_m_digital8') else None
            ...
            def analog5(self):
                if hasattr(self, '_m_analog5'):
                    return self._m_analog5 if hasattr(self, '_m_analog5') else None
            ...
            def digital7(self):
                if hasattr(self, '_m_digital7'):
                    return self._m_digital7 if hasattr(self, '_m_digital7') else None
            ...
            def analog2(self):
                if hasattr(self, '_m_analog2'):
                    return self._m_analog2 if hasattr(self, '_m_analog2') else None
