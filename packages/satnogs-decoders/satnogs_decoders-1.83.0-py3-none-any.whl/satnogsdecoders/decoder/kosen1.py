...
class Kosen1(KaitaiStruct):
    ...
    def bat_v(self):
        if hasattr(self, '_m_bat_v'):
            return self._m_bat_v if hasattr(self, '_m_bat_v') else None
    ...
    def value3_hex_right_digit(self):
        if hasattr(self, '_m_value3_hex_right_digit'):
            return self._m_value3_hex_right_digit if hasattr(self, '_m_value3_hex_right_digit') else None
    ...
    def necessary_for_lengthcheck(self):
        if hasattr(self, '_m_necessary_for_lengthcheck'):
            return self._m_necessary_for_lengthcheck if hasattr(self, '_m_necessary_for_lengthcheck') else None
    ...
    def value1_hex_left(self):
        if hasattr(self, '_m_value1_hex_left'):
            return self._m_value1_hex_left if hasattr(self, '_m_value1_hex_left') else None
    ...
    def value2_hex_right(self):
        if hasattr(self, '_m_value2_hex_right'):
            return self._m_value2_hex_right if hasattr(self, '_m_value2_hex_right') else None
    ...
    def value3_hex(self):
        if hasattr(self, '_m_value3_hex'):
            return self._m_value3_hex if hasattr(self, '_m_value3_hex') else None
    ...
    def value3_hex_right(self):
        if hasattr(self, '_m_value3_hex_right'):
            return self._m_value3_hex_right if hasattr(self, '_m_value3_hex_right') else None
    ...
    def value1_hex_right_digit(self):
        if hasattr(self, '_m_value1_hex_right_digit'):
            return self._m_value1_hex_right_digit if hasattr(self, '_m_value1_hex_right_digit') else None
    ...
    def beacon(self):
        if hasattr(self, '_m_beacon'):
            return self._m_beacon if hasattr(self, '_m_beacon') else None
    ...
    def sc_x(self):
        if hasattr(self, '_m_sc_x'):
            return self._m_sc_x if hasattr(self, '_m_sc_x') else None
    ...
    def value3_hex_left(self):
        if hasattr(self, '_m_value3_hex_left'):
            return self._m_value3_hex_left if hasattr(self, '_m_value3_hex_left') else None
    ...
    def load_i(self):
        if hasattr(self, '_m_load_i'):
            return self._m_load_i if hasattr(self, '_m_load_i') else None
    ...
    def bat_i(self):
        if hasattr(self, '_m_bat_i'):
            return self._m_bat_i if hasattr(self, '_m_bat_i') else None
    ...
    def sc_z(self):
        if hasattr(self, '_m_sc_z'):
            return self._m_sc_z if hasattr(self, '_m_sc_z') else None
    ...
    def value4_hex_left_digit(self):
        if hasattr(self, '_m_value4_hex_left_digit'):
            return self._m_value4_hex_left_digit if hasattr(self, '_m_value4_hex_left_digit') else None
    ...
    def value1_hex_right(self):
        if hasattr(self, '_m_value1_hex_right'):
            return self._m_value1_hex_right if hasattr(self, '_m_value1_hex_right') else None
    ...
    def value4_hex_right(self):
        if hasattr(self, '_m_value4_hex_right'):
            return self._m_value4_hex_right if hasattr(self, '_m_value4_hex_right') else None
    ...
    def value4_hex_right_digit(self):
        if hasattr(self, '_m_value4_hex_right_digit'):
            return self._m_value4_hex_right_digit if hasattr(self, '_m_value4_hex_right_digit') else None
    ...
    def value1_hex(self):
        if hasattr(self, '_m_value1_hex'):
            return self._m_value1_hex if hasattr(self, '_m_value1_hex') else None
    ...
    def value2_hex_right_digit(self):
        if hasattr(self, '_m_value2_hex_right_digit'):
            return self._m_value2_hex_right_digit if hasattr(self, '_m_value2_hex_right_digit') else None
    ...
    def value4_hex_left(self):
        if hasattr(self, '_m_value4_hex_left'):
            return self._m_value4_hex_left if hasattr(self, '_m_value4_hex_left') else None
    ...
    def value2_hex_left_digit(self):
        if hasattr(self, '_m_value2_hex_left_digit'):
            return self._m_value2_hex_left_digit if hasattr(self, '_m_value2_hex_left_digit') else None
    ...
    def value2_hex(self):
        if hasattr(self, '_m_value2_hex'):
            return self._m_value2_hex if hasattr(self, '_m_value2_hex') else None
    ...
    def value4_hex(self):
        if hasattr(self, '_m_value4_hex'):
            return self._m_value4_hex if hasattr(self, '_m_value4_hex') else None
    ...
    def bat_t(self):
        if hasattr(self, '_m_bat_t'):
            return self._m_bat_t if hasattr(self, '_m_bat_t') else None
    ...
    def value3_hex_left_digit(self):
        if hasattr(self, '_m_value3_hex_left_digit'):
            return self._m_value3_hex_left_digit if hasattr(self, '_m_value3_hex_left_digit') else None
    ...
    def value2_hex_left(self):
        if hasattr(self, '_m_value2_hex_left'):
            return self._m_value2_hex_left if hasattr(self, '_m_value2_hex_left') else None
    ...
    def value1_hex_left_digit(self):
        if hasattr(self, '_m_value1_hex_left_digit'):
            return self._m_value1_hex_left_digit if hasattr(self, '_m_value1_hex_left_digit') else None
    ...
    def sc_y(self):
        if hasattr(self, '_m_sc_y'):
            return self._m_sc_y if hasattr(self, '_m_sc_y') else None
