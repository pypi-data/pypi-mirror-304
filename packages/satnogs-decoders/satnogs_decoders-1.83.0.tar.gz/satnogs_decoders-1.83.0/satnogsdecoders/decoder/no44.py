    ...
    class SideA(KaitaiStruct):
        ...
        def current_minus_x(self):
            if hasattr(self, '_m_current_minus_x'):
                return self._m_current_minus_x if hasattr(self, '_m_current_minus_x') else None
        ...
        def a_batt_a_volt(self):
            if hasattr(self, '_m_a_batt_a_volt'):
                return self._m_a_batt_a_volt if hasattr(self, '_m_a_batt_a_volt') else None
        ...
        def current_plus_y(self):
            if hasattr(self, '_m_current_plus_y'):
                return self._m_current_plus_y if hasattr(self, '_m_current_plus_y') else None
        ...
        def current_plus_z(self):
            if hasattr(self, '_m_current_plus_z'):
                return self._m_current_plus_z if hasattr(self, '_m_current_plus_z') else None
        ...
        def power_out_a(self):
            if hasattr(self, '_m_power_out_a'):
                return self._m_power_out_a if hasattr(self, '_m_power_out_a') else None
        ...
        def temp_plus_z(self):
            if hasattr(self, '_m_temp_plus_z'):
                return self._m_temp_plus_z if hasattr(self, '_m_temp_plus_z') else None
        ...
        def temp_xmit_a(self):
            if hasattr(self, '_m_temp_xmit_a'):
                return self._m_temp_xmit_a if hasattr(self, '_m_temp_xmit_a') else None
        ...
        def temp_stack_a(self):
            if hasattr(self, '_m_temp_stack_a'):
                return self._m_temp_stack_a if hasattr(self, '_m_temp_stack_a') else None
        ...
        def temp_plus_y(self):
            if hasattr(self, '_m_temp_plus_y'):
                return self._m_temp_plus_y if hasattr(self, '_m_temp_plus_y') else None
        ...
        def current_batt_a(self):
            if hasattr(self, '_m_current_batt_a'):
                return self._m_current_batt_a if hasattr(self, '_m_current_batt_a') else None
        ...
        def eight_v_reg_a(self):
            if hasattr(self, '_m_eight_v_reg_a'):
                return self._m_eight_v_reg_a if hasattr(self, '_m_eight_v_reg_a') else None
        ...
        def current_minus_y(self):
            if hasattr(self, '_m_current_minus_y'):
                return self._m_current_minus_y if hasattr(self, '_m_current_minus_y') else None
        ...
        def a_batt_b_volt(self):
            if hasattr(self, '_m_a_batt_b_volt'):
                return self._m_a_batt_b_volt if hasattr(self, '_m_a_batt_b_volt') else None
        ...
        def temp_batt_a(self):
            if hasattr(self, '_m_temp_batt_a'):
                return self._m_temp_batt_a if hasattr(self, '_m_temp_batt_a') else None
        ...
        def temp_plus_x(self):
            if hasattr(self, '_m_temp_plus_x'):
                return self._m_temp_plus_x if hasattr(self, '_m_temp_plus_x') else None
        ...
        def current_plus_x(self):
            if hasattr(self, '_m_current_plus_x'):
                return self._m_current_plus_x if hasattr(self, '_m_current_plus_x') else None
    ...
    class SideB(KaitaiStruct):
        ...
        def b_batt_a_volt(self):
            if hasattr(self, '_m_b_batt_a_volt'):
                return self._m_b_batt_a_volt if hasattr(self, '_m_b_batt_a_volt') else None
        ...
        def temp_stack_b(self):
            if hasattr(self, '_m_temp_stack_b'):
                return self._m_temp_stack_b if hasattr(self, '_m_temp_stack_b') else None
        ...
        def current_minus_z(self):
            if hasattr(self, '_m_current_minus_z'):
                return self._m_current_minus_z if hasattr(self, '_m_current_minus_z') else None
        ...
        def temp_minus_x(self):
            if hasattr(self, '_m_temp_minus_x'):
                return self._m_temp_minus_x if hasattr(self, '_m_temp_minus_x') else None
        ...
        def b_batt_b_volt(self):
            if hasattr(self, '_m_b_batt_b_volt'):
                return self._m_b_batt_b_volt if hasattr(self, '_m_b_batt_b_volt') else None
        ...
        def power_out_b(self):
            if hasattr(self, '_m_power_out_b'):
                return self._m_power_out_b if hasattr(self, '_m_power_out_b') else None
        ...
        def temp_batt_b(self):
            if hasattr(self, '_m_temp_batt_b'):
                return self._m_temp_batt_b if hasattr(self, '_m_temp_batt_b') else None
        ...
        def temp_minus_z(self):
            if hasattr(self, '_m_temp_minus_z'):
                return self._m_temp_minus_z if hasattr(self, '_m_temp_minus_z') else None
        ...
        def temp_xmit_b(self):
            if hasattr(self, '_m_temp_xmit_b'):
                return self._m_temp_xmit_b if hasattr(self, '_m_temp_xmit_b') else None
        ...
        def eight_v_reg_b(self):
            if hasattr(self, '_m_eight_v_reg_b'):
                return self._m_eight_v_reg_b if hasattr(self, '_m_eight_v_reg_b') else None
        ...
        def current_batt_b(self):
            if hasattr(self, '_m_current_batt_b'):
                return self._m_current_batt_b if hasattr(self, '_m_current_batt_b') else None
        ...
        def temp_minus_y(self):
            if hasattr(self, '_m_temp_minus_y'):
                return self._m_temp_minus_y if hasattr(self, '_m_temp_minus_y') else None
