    ...
    class Ax25InfoData(KaitaiStruct):
        ...
        def ttc_power_rev_val(self):
            if hasattr(self, '_m_ttc_power_rev_val'):
                return self._m_ttc_power_rev_val if hasattr(self, '_m_ttc_power_rev_val') else None
        ...
        def ttc_power_fw_val(self):
            if hasattr(self, '_m_ttc_power_fw_val'):
                return self._m_ttc_power_fw_val if hasattr(self, '_m_ttc_power_fw_val') else None
