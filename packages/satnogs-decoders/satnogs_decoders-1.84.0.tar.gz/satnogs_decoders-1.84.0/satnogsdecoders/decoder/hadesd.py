    ...
    class PowerFrame(KaitaiStruct):
        ...
        def pwrdul1_dec(self):
            if hasattr(self, '_m_pwrdul1_dec'):
                return self._m_pwrdul1_dec if hasattr(self, '_m_pwrdul1_dec') else None
        ...
        def vbus3_vbus2_dec(self):
            if hasattr(self, '_m_vbus3_vbus2_dec'):
                return self._m_vbus3_vbus2_dec if hasattr(self, '_m_vbus3_vbus2_dec') else None
        ...
        def spc_dec(self):
            if hasattr(self, '_m_spc_dec'):
                return self._m_spc_dec if hasattr(self, '_m_spc_dec') else None
        ...
        def ibat_dec(self):
            if hasattr(self, '_m_ibat_dec'):
                return self._m_ibat_dec if hasattr(self, '_m_ibat_dec') else None
        ...
        def vbat1_dec(self):
            if hasattr(self, '_m_vbat1_dec'):
                return self._m_vbat1_dec if hasattr(self, '_m_vbat1_dec') else None
        ...
        def spa_dec(self):
            if hasattr(self, '_m_spa_dec'):
                return self._m_spa_dec if hasattr(self, '_m_spa_dec') else None
        ...
        def vbus1_dec(self):
            if hasattr(self, '_m_vbus1_dec'):
                return self._m_vbus1_dec if hasattr(self, '_m_vbus1_dec') else None
        ...
        def pwrdul4_dec(self):
            if hasattr(self, '_m_pwrdul4_dec'):
                return self._m_pwrdul4_dec if hasattr(self, '_m_pwrdul4_dec') else None
        ...
        def vbus1_vbat1_dec(self):
            if hasattr(self, '_m_vbus1_vbat1_dec'):
                return self._m_vbus1_vbat1_dec if hasattr(self, '_m_vbus1_vbat1_dec') else None
        ...
        def spb_dec(self):
            if hasattr(self, '_m_spb_dec'):
                return self._m_spb_dec if hasattr(self, '_m_spb_dec') else None
        ...
        def vcpu_dec(self):
            if hasattr(self, '_m_vcpu_dec'):
                return self._m_vcpu_dec if hasattr(self, '_m_vcpu_dec') else None
        ...
        def ipl_dec(self):
            if hasattr(self, '_m_ipl_dec'):
                return self._m_ipl_dec if hasattr(self, '_m_ipl_dec') else None
        ...
        def vbat2_dec(self):
            if hasattr(self, '_m_vbat2_dec'):
                return self._m_vbat2_dec if hasattr(self, '_m_vbat2_dec') else None
        ...
        def spd_dec(self):
            if hasattr(self, '_m_spd_dec'):
                return self._m_spd_dec if hasattr(self, '_m_spd_dec') else None
        ...
        def vbus2_dec(self):
            if hasattr(self, '_m_vbus2_dec'):
                return self._m_vbus2_dec if hasattr(self, '_m_vbus2_dec') else None
        ...
        def vbus3_dec(self):
            if hasattr(self, '_m_vbus3_dec'):
                return self._m_vbus3_dec if hasattr(self, '_m_vbus3_dec') else None
        ...
        def icpu_dec(self):
            if hasattr(self, '_m_icpu_dec'):
                return self._m_icpu_dec if hasattr(self, '_m_icpu_dec') else None
    ...
    class StatusFrame(KaitaiStruct):
        ...
        def transponder_dec(self):
            if hasattr(self, '_m_transponder_dec'):
                return self._m_transponder_dec if hasattr(self, '_m_transponder_dec') else None
        ...
        def nbusdrops_dec(self):
            if hasattr(self, '_m_nbusdrops_dec'):
                return self._m_nbusdrops_dec if hasattr(self, '_m_nbusdrops_dec') else None
        ...
        def battery_dec(self):
            if hasattr(self, '_m_battery_dec'):
                return self._m_battery_dec if hasattr(self, '_m_battery_dec') else None
        ...
        def last_reset_cause_dec(self):
            if hasattr(self, '_m_last_reset_cause_dec'):
                return self._m_last_reset_cause_dec if hasattr(self, '_m_last_reset_cause_dec') else None
        ...
        def ntrans_dec(self):
            if hasattr(self, '_m_ntrans_dec'):
                return self._m_ntrans_dec if hasattr(self, '_m_ntrans_dec') else None
    ...
    class TempstatsFrame(KaitaiStruct):
        ...
        def mintpc_dec(self):
            if hasattr(self, '_m_mintpc_dec'):
                return self._m_mintpc_dec if hasattr(self, '_m_mintpc_dec') else None
        ...
        def medtpa_dec(self):
            if hasattr(self, '_m_medtpa_dec'):
                return self._m_medtpa_dec if hasattr(self, '_m_medtpa_dec') else None
        ...
        def maxtrx_dec(self):
            if hasattr(self, '_m_maxtrx_dec'):
                return self._m_maxtrx_dec if hasattr(self, '_m_maxtrx_dec') else None
        ...
        def medtrx_dec(self):
            if hasattr(self, '_m_medtrx_dec'):
                return self._m_medtrx_dec if hasattr(self, '_m_medtrx_dec') else None
        ...
        def maxtpb_dec(self):
            if hasattr(self, '_m_maxtpb_dec'):
                return self._m_maxtpb_dec if hasattr(self, '_m_maxtpb_dec') else None
        ...
        def medtcpu_dec(self):
            if hasattr(self, '_m_medtcpu_dec'):
                return self._m_medtcpu_dec if hasattr(self, '_m_medtcpu_dec') else None
        ...
        def mintcpu_dec(self):
            if hasattr(self, '_m_mintcpu_dec'):
                return self._m_mintcpu_dec if hasattr(self, '_m_mintcpu_dec') else None
        ...
        def maxttx2_dec(self):
            if hasattr(self, '_m_maxttx2_dec'):
                return self._m_maxttx2_dec if hasattr(self, '_m_maxttx2_dec') else None
        ...
        def minteps_dec(self):
            if hasattr(self, '_m_minteps_dec'):
                return self._m_minteps_dec if hasattr(self, '_m_minteps_dec') else None
        ...
        def maxtpd_dec(self):
            if hasattr(self, '_m_maxtpd_dec'):
                return self._m_maxtpd_dec if hasattr(self, '_m_maxtpd_dec') else None
        ...
        def minttx_dec(self):
            if hasattr(self, '_m_minttx_dec'):
                return self._m_minttx_dec if hasattr(self, '_m_minttx_dec') else None
        ...
        def medttx2_dec(self):
            if hasattr(self, '_m_medttx2_dec'):
                return self._m_medttx2_dec if hasattr(self, '_m_medttx2_dec') else None
        ...
        def maxtcpu_dec(self):
            if hasattr(self, '_m_maxtcpu_dec'):
                return self._m_maxtcpu_dec if hasattr(self, '_m_maxtcpu_dec') else None
        ...
        def minttx2_dec(self):
            if hasattr(self, '_m_minttx2_dec'):
                return self._m_minttx2_dec if hasattr(self, '_m_minttx2_dec') else None
        ...
        def medttx_dec(self):
            if hasattr(self, '_m_medttx_dec'):
                return self._m_medttx_dec if hasattr(self, '_m_medttx_dec') else None
        ...
        def maxtpa_dec(self):
            if hasattr(self, '_m_maxtpa_dec'):
                return self._m_maxtpa_dec if hasattr(self, '_m_maxtpa_dec') else None
        ...
        def medtpb_dec(self):
            if hasattr(self, '_m_medtpb_dec'):
                return self._m_medtpb_dec if hasattr(self, '_m_medtpb_dec') else None
        ...
        def mintrx_dec(self):
            if hasattr(self, '_m_mintrx_dec'):
                return self._m_mintrx_dec if hasattr(self, '_m_mintrx_dec') else None
        ...
        def mintpd_dec(self):
            if hasattr(self, '_m_mintpd_dec'):
                return self._m_mintpd_dec if hasattr(self, '_m_mintpd_dec') else None
        ...
        def medteps_dec(self):
            if hasattr(self, '_m_medteps_dec'):
                return self._m_medteps_dec if hasattr(self, '_m_medteps_dec') else None
        ...
        def mintpa_dec(self):
            if hasattr(self, '_m_mintpa_dec'):
                return self._m_mintpa_dec if hasattr(self, '_m_mintpa_dec') else None
        ...
        def maxtpc_dec(self):
            if hasattr(self, '_m_maxtpc_dec'):
                return self._m_maxtpc_dec if hasattr(self, '_m_maxtpc_dec') else None
        ...
        def maxteps_dec(self):
            if hasattr(self, '_m_maxteps_dec'):
                return self._m_maxteps_dec if hasattr(self, '_m_maxteps_dec') else None
        ...
        def mintpb_dec(self):
            if hasattr(self, '_m_mintpb_dec'):
                return self._m_mintpb_dec if hasattr(self, '_m_mintpb_dec') else None
        ...
        def maxttx_dec(self):
            if hasattr(self, '_m_maxttx_dec'):
                return self._m_maxttx_dec if hasattr(self, '_m_maxttx_dec') else None
        ...
        def medtpd_dec(self):
            if hasattr(self, '_m_medtpd_dec'):
                return self._m_medtpd_dec if hasattr(self, '_m_medtpd_dec') else None
        ...
        def medtpc_dec(self):
            if hasattr(self, '_m_medtpc_dec'):
                return self._m_medtpc_dec if hasattr(self, '_m_medtpc_dec') else None
    ...
    class PowerstatsFrame(KaitaiStruct):
        ...
        def maxvbat2_dec(self):
            if hasattr(self, '_m_maxvbat2_dec'):
                return self._m_maxvbat2_dec if hasattr(self, '_m_maxvbat2_dec') else None
        ...
        def maxvcpu_dec(self):
            if hasattr(self, '_m_maxvcpu_dec'):
                return self._m_maxvcpu_dec if hasattr(self, '_m_maxvcpu_dec') else None
        ...
        def maxvbus3_dec(self):
            if hasattr(self, '_m_maxvbus3_dec'):
                return self._m_maxvbus3_dec if hasattr(self, '_m_maxvbus3_dec') else None
        ...
        def maxipl_dec(self):
            if hasattr(self, '_m_maxipl_dec'):
                return self._m_maxipl_dec if hasattr(self, '_m_maxipl_dec') else None
        ...
        def minvbus1_dec(self):
            if hasattr(self, '_m_minvbus1_dec'):
                return self._m_minvbus1_dec if hasattr(self, '_m_minvbus1_dec') else None
        ...
        def maxvbus1_dec(self):
            if hasattr(self, '_m_maxvbus1_dec'):
                return self._m_maxvbus1_dec if hasattr(self, '_m_maxvbus1_dec') else None
        ...
        def minibat_dec(self):
            if hasattr(self, '_m_minibat_dec'):
                return self._m_minibat_dec if hasattr(self, '_m_minibat_dec') else None
        ...
        def minvbat2_dec(self):
            if hasattr(self, '_m_minvbat2_dec'):
                return self._m_minvbat2_dec if hasattr(self, '_m_minvbat2_dec') else None
        ...
        def minvbus2_dec(self):
            if hasattr(self, '_m_minvbus2_dec'):
                return self._m_minvbus2_dec if hasattr(self, '_m_minvbus2_dec') else None
        ...
        def minvbat1_dec(self):
            if hasattr(self, '_m_minvbat1_dec'):
                return self._m_minvbat1_dec if hasattr(self, '_m_minvbat1_dec') else None
        ...
        def maxvbat1_dec(self):
            if hasattr(self, '_m_maxvbat1_dec'):
                return self._m_maxvbat1_dec if hasattr(self, '_m_maxvbat1_dec') else None
        ...
        def minvbus3_dec(self):
            if hasattr(self, '_m_minvbus3_dec'):
                return self._m_minvbus3_dec if hasattr(self, '_m_minvbus3_dec') else None
        ...
        def minvcpu_dec(self):
            if hasattr(self, '_m_minvcpu_dec'):
                return self._m_minvcpu_dec if hasattr(self, '_m_minvcpu_dec') else None
        ...
        def maxvbus2_dec(self):
            if hasattr(self, '_m_maxvbus2_dec'):
                return self._m_maxvbus2_dec if hasattr(self, '_m_maxvbus2_dec') else None
    ...
    class TempFrame(KaitaiStruct):
        ...
        def ttx_dec(self):
            if hasattr(self, '_m_ttx_dec'):
                return self._m_ttx_dec if hasattr(self, '_m_ttx_dec') else None
        ...
        def ttx2_dec(self):
            if hasattr(self, '_m_ttx2_dec'):
                return self._m_ttx2_dec if hasattr(self, '_m_ttx2_dec') else None
        ...
        def teps_dec(self):
            if hasattr(self, '_m_teps_dec'):
                return self._m_teps_dec if hasattr(self, '_m_teps_dec') else None
        ...
        def tpc_dec(self):
            if hasattr(self, '_m_tpc_dec'):
                return self._m_tpc_dec if hasattr(self, '_m_tpc_dec') else None
        ...
        def tpd_dec(self):
            if hasattr(self, '_m_tpd_dec'):
                return self._m_tpd_dec if hasattr(self, '_m_tpd_dec') else None
        ...
        def tpb_dec(self):
            if hasattr(self, '_m_tpb_dec'):
                return self._m_tpb_dec if hasattr(self, '_m_tpb_dec') else None
        ...
        def tcpu_dec(self):
            if hasattr(self, '_m_tcpu_dec'):
                return self._m_tcpu_dec if hasattr(self, '_m_tcpu_dec') else None
        ...
        def trx_dec(self):
            if hasattr(self, '_m_trx_dec'):
                return self._m_trx_dec if hasattr(self, '_m_trx_dec') else None
        ...
        def tpa_dec(self):
            if hasattr(self, '_m_tpa_dec'):
                return self._m_tpa_dec if hasattr(self, '_m_tpa_dec') else None
