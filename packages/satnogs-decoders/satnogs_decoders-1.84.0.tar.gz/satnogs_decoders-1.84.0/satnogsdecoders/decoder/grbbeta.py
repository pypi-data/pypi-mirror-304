        ...
        class PsuHkT(KaitaiStruct):
            ...
            def channel_2_status(self):
                if hasattr(self, '_m_channel_2_status'):
                    return self._m_channel_2_status if hasattr(self, '_m_channel_2_status') else None
            ...
            def channel_6_status(self):
                if hasattr(self, '_m_channel_6_status'):
                    return self._m_channel_6_status if hasattr(self, '_m_channel_6_status') else None
            ...
            def channel_0_status(self):
                if hasattr(self, '_m_channel_0_status'):
                    return self._m_channel_0_status if hasattr(self, '_m_channel_0_status') else None
            ...
            def mppt_ch3_state(self):
                if hasattr(self, '_m_mppt_ch3_state'):
                    return self._m_mppt_ch3_state if hasattr(self, '_m_mppt_ch3_state') else None
            ...
            def mppt_ch2_state(self):
                if hasattr(self, '_m_mppt_ch2_state'):
                    return self._m_mppt_ch2_state if hasattr(self, '_m_mppt_ch2_state') else None
            ...
            def channel_1_status(self):
                if hasattr(self, '_m_channel_1_status'):
                    return self._m_channel_1_status if hasattr(self, '_m_channel_1_status') else None
            ...
            def mppt_ch1_state(self):
                if hasattr(self, '_m_mppt_ch1_state'):
                    return self._m_mppt_ch1_state if hasattr(self, '_m_mppt_ch1_state') else None
            ...
            def channel_5_status(self):
                if hasattr(self, '_m_channel_5_status'):
                    return self._m_channel_5_status if hasattr(self, '_m_channel_5_status') else None
            ...
            def channel_3_status(self):
                if hasattr(self, '_m_channel_3_status'):
                    return self._m_channel_3_status if hasattr(self, '_m_channel_3_status') else None
            ...
            def channel_4_status(self):
                if hasattr(self, '_m_channel_4_status'):
                    return self._m_channel_4_status if hasattr(self, '_m_channel_4_status') else None
