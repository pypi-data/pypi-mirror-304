...
class V1alphaCreateDocumentResponse(BaseModel):
    """
    V1alphaCreateDocumentResponse
    """ # noqa: E501
    document: Optional[V1alphaDocument] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "document": V1alphaDocument.from_dict(obj["document"]) if obj.get("document") is not None else None
        })
        return _obj
