...
class V1alphaListModelCollectionsResponse(BaseModel):
    """
    V1alphaListModelCollectionsResponse
    """ # noqa: E501
    collections: Optional[List[V1alphaCollectionInfo]] = Field(default=None, description="The list of collections.")
