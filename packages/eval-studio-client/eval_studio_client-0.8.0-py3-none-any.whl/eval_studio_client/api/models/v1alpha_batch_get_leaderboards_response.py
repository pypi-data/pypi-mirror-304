...
class V1alphaBatchGetLeaderboardsResponse(BaseModel):
    """
    V1alphaBatchGetLeaderboardsResponse
    """ # noqa: E501
    leaderboards: Optional[List[V1alphaLeaderboard]] = Field(default=None, description="The requested Leaderboards.")
