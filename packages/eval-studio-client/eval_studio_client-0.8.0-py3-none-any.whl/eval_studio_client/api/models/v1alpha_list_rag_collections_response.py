...
class V1alphaListRAGCollectionsResponse(BaseModel):
    """
    V1alphaListRAGCollectionsResponse
    """ # noqa: E501
    collections: Optional[List[V1alphaCollectionInfo]] = Field(default=None, description="Required. List of RAG collections available for evaluation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "collections": [V1alphaCollectionInfo.from_dict(_item) for _item in obj["collections"]] if obj.get("collections") is not None else None
        })
        return _obj
