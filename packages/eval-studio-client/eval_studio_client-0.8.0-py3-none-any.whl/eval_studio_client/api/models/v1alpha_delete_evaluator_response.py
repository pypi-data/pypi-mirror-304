...
class V1alphaDeleteEvaluatorResponse(BaseModel):
    """
    V1alphaDeleteEvaluatorResponse
    """ # noqa: E501
    evaluator: Optional[V1alphaEvaluator] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "evaluator": V1alphaEvaluator.from_dict(obj["evaluator"]) if obj.get("evaluator") is not None else None
        })
        return _obj
