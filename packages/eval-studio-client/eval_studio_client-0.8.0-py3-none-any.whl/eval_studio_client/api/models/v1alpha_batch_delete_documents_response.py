...
class V1alphaBatchDeleteDocumentsResponse(BaseModel):
    """
    V1alphaBatchDeleteDocumentsResponse
    """ # noqa: E501
    documents: Optional[List[V1alphaDocument]] = Field(default=None, description="The Documents that were deleted.")
