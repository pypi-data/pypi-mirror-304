...
class TestV1alphaDeleteEvaluatorResponse(unittest.TestCase):
    """V1alphaDeleteEvaluatorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1alphaDeleteEvaluatorResponse:
        """Test V1alphaDeleteEvaluatorResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1alphaDeleteEvaluatorResponse`
        """
        model = V1alphaDeleteEvaluatorResponse()
        if include_optional:
            return V1alphaDeleteEvaluatorResponse(
...
https://github.com/h2oai/h2o-sonar/blob/0492b2f2651fb2fde08d981b72c9fda7dc6b9697/h2o_sonar/lib/api/evaluators.py#L53-L81(
    ...
    def testV1alphaDeleteEvaluatorResponse(self):
        """Test V1alphaDeleteEvaluatorResponse"""
