...
class TestV1alphaEvaluator(unittest.TestCase):
    """V1alphaEvaluator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1alphaEvaluator:
        """Test V1alphaEvaluator
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1alphaEvaluator`
        """
        model = V1alphaEvaluator()
        if include_optional:
            return V1alphaEvaluator(
                name = '',
