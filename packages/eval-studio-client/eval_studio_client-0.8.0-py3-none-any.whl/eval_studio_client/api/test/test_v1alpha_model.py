...
class TestV1alphaModel(unittest.TestCase):
    """V1alphaModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1alphaModel:
        """Test V1alphaModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1alphaModel`
        """
        model = V1alphaModel()
        if include_optional:
            return V1alphaModel(
