...
class TestV1alphaListEvaluatorsResponse(unittest.TestCase):
    """V1alphaListEvaluatorsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1alphaListEvaluatorsResponse:
        """Test V1alphaListEvaluatorsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1alphaListEvaluatorsResponse`
        """
        model = V1alphaListEvaluatorsResponse()
        if include_optional:
            return V1alphaListEvaluatorsResponse(
                evaluators = [
...
https://github.com/h2oai/h2o-sonar/blob/0492b2f2651fb2fde08d981b72c9fda7dc6b9697/h2o_sonar/lib/api/evaluators.py#L53-L81(
    ...
    def testV1alphaListEvaluatorsResponse(self):
        """Test V1alphaListEvaluatorsResponse"""
