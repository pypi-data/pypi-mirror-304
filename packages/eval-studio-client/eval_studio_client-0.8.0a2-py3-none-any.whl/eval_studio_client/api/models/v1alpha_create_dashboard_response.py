...
class V1alphaCreateDashboardResponse(BaseModel):
    """
    V1alphaCreateDashboardResponse
    """ # noqa: E501
    dashboard: Optional[V1alphaDashboard] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dashboard": V1alphaDashboard.from_dict(obj["dashboard"]) if obj.get("dashboard") is not None else None
        })
        return _obj
