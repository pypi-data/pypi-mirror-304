...
class V1alphaCreateEvaluationRequest(BaseModel):
    """
    ...
    model: Optional[V1alphaModel] = None
    evaluation_tests: Optional[List[V1alphaEvaluationTest]] = Field(default=None, description="TODO: breaks https://google.aip.dev/144 Required. Defines the evaluation configuration.", alias="evaluationTests")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "model": V1alphaModel.from_dict(obj["model"]) if obj.get("model") is not None else None,
            "evaluationTests": [V1alphaEvaluationTest.from_dict(_item) for _item in obj["evaluationTests"]] if obj.get("evaluationTests") is not None else None,
