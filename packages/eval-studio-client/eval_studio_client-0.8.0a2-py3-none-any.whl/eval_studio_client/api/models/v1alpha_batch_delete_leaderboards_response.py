...
class V1alphaBatchDeleteLeaderboardsResponse(BaseModel):
    """
    V1alphaBatchDeleteLeaderboardsResponse
    """ # noqa: E501
    leaderboards: Optional[List[V1alphaLeaderboard]] = Field(default=None, description="The deleted Leaderboards.")
