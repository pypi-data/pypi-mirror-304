...
class V1alphaListMostRecentLeaderboardsResponse(BaseModel):
    """
    V1alphaListMostRecentLeaderboardsResponse
    """ # noqa: E501
    leaderboards: Optional[List[V1alphaLeaderboard]] = Field(default=None, description="The list of Leaderboards.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leaderboards": [V1alphaLeaderboard.from_dict(_item) for _item in obj["leaderboards"]] if obj.get("leaderboards") is not None else None
        })
        return _obj
