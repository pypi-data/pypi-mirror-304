...
class V1alphaBatchDeleteTestCasesResponse(BaseModel):
    """
    V1alphaBatchDeleteTestCasesResponse
    """ # noqa: E501
    test_cases: Optional[List[V1alphaTestCase]] = Field(default=None, description="The list of deleted TestCases.", alias="testCases")
