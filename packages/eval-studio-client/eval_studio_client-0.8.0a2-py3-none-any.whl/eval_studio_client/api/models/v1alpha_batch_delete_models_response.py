...
class V1alphaBatchDeleteModelsResponse(BaseModel):
    """
    V1alphaBatchDeleteModelsResponse
    """ # noqa: E501
    models: Optional[List[V1alphaModel]] = Field(default=None, description="The Models that were deleted.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "models": [V1alphaModel.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None
        })
        return _obj
