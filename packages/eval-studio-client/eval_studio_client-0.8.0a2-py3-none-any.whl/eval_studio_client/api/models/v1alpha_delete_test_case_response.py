...
class V1alphaDeleteTestCaseResponse(BaseModel):
    """
    V1alphaDeleteTestCaseResponse
    """ # noqa: E501
    test_case: Optional[V1alphaTestCase] = Field(default=None, alias="testCase")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "testCase": V1alphaTestCase.from_dict(obj["testCase"]) if obj.get("testCase") is not None else None
        })
        return _obj
