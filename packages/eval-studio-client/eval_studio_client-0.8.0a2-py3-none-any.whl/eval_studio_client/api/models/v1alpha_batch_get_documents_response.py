...
class V1alphaBatchGetDocumentsResponse(BaseModel):
    """
    V1alphaBatchGetDocumentsResponse
    """ # noqa: E501
    documents: Optional[List[V1alphaDocument]] = Field(default=None, description="The Documents that were requested.")
