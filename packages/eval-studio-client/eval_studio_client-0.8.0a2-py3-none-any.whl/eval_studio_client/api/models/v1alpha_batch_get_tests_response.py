...
class V1alphaBatchGetTestsResponse(BaseModel):
    """
    V1alphaBatchGetTestsResponse
    """ # noqa: E501
    tests: Optional[List[V1alphaTest]] = Field(default=None, description="The Tests that were requested.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tests": [V1alphaTest.from_dict(_item) for _item in obj["tests"]] if obj.get("tests") is not None else None
        })
        return _obj
