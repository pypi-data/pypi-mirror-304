...
class V1alphaFindAllTestCasesByIDResponse(BaseModel):
    """
    V1alphaFindAllTestCasesByIDResponse
    """ # noqa: E501
    test_cases: Optional[List[V1alphaTestCase]] = Field(default=None, description="The list of TestCases.", alias="testCases")
