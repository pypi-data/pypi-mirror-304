...
class V1alphaBatchGetOperationsResponse(BaseModel):
    """
    V1alphaBatchGetOperationsResponse
    """ # noqa: E501
    operations: Optional[List[V1alphaOperation]] = Field(default=None, description="The Operations that were requested.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "operations": [V1alphaOperation.from_dict(_item) for _item in obj["operations"]] if obj.get("operations") is not None else None
        })
        return _obj
