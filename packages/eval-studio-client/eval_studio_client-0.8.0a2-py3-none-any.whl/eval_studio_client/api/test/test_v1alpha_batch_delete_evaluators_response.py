...
class TestV1alphaBatchDeleteEvaluatorsResponse(unittest.TestCase):
    """V1alphaBatchDeleteEvaluatorsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1alphaBatchDeleteEvaluatorsResponse:
        """Test V1alphaBatchDeleteEvaluatorsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1alphaBatchDeleteEvaluatorsResponse`
        """
        model = V1alphaBatchDeleteEvaluatorsResponse()
        if include_optional:
            return V1alphaBatchDeleteEvaluatorsResponse(
                evaluators = [
                    eval_studio_client.api.models.v1alpha_evaluator.v1alphaEvaluator(
                        name = '', 
...
https://github.com/h2oai/h2o-sonar/blob/0492b2f2651fb2fde08d981b72c9fda7dc6b9697/h2o_sonar/lib/api/evaluators.py#L53-L81(
    ...
    def testV1alphaBatchDeleteEvaluatorsResponse(self):
        """Test V1alphaBatchDeleteEvaluatorsResponse"""
