...
json = "{}"
# create an instance of V1alphaPerturbator from a JSON string
v1alpha_perturbator_instance = V1alphaPerturbator.from_json(json)
# print the JSON string representation of the object
print(V1alphaPerturbator.to_json())

# convert the object into a dict
v1alpha_perturbator_dict = v1alpha_perturbator_instance.to_dict()
# create an instance of V1alphaPerturbator from a dict
v1alpha_perturbator_from_dict = V1alphaPerturbator.from_dict(v1alpha_perturbator_dict)
```
