...
class TestClassServiceApi:
    ...
    def test_class_service_get_test_class(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "V1alphaGetTestClassResponse",
        }
    ...
    def test_class_service_get_test_class_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V1alphaGetTestClassResponse]:
        """test_class_service_get_test_class
    ...
    def test_class_service_list_test_classes(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "V1alphaListTestClassesResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def test_class_service_list_test_classes_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V1alphaListTestClassesResponse]:
        """test_class_service_list_test_classes
    ...
    def _test_class_service_list_test_classes_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1alpha/testClasses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
