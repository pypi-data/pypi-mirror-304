...
import { h as IconButtonWrapper, i as IconButton, Y as Edit, v as Undo, D as Download, Z as Clear, n as prepare_files } from './2-BK2b1QLK.js';
...
const css = {
  code: "button.svelte-1xyfx7i{cursor:pointer;width:var(--size-full)}.center.svelte-1xyfx7i{display:flex;justify-content:center}.flex.svelte-1xyfx7i{display:flex;flex-direction:column;justify-content:center;align-items:center}.hidden.svelte-1xyfx7i{display:none;position:absolute;flex-grow:0}.hidden.svelte-1xyfx7i svg{display:none}.disable_click.svelte-1xyfx7i{cursor:default}input.svelte-1xyfx7i{display:none}",
...
//# sourceMappingURL=ModifyUpload-BpO4YZVS.js.map
