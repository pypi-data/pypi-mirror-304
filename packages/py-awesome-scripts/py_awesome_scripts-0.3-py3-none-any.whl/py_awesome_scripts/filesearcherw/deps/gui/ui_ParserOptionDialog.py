...
class Ui_ParserOptionDialog(object):
    def setupUi(self, ParserOptionDialog):
        if not ParserOptionDialog.objectName():
            ParserOptionDialog.setObjectName("ParserOptionDialog")
    ...
    def retranslateUi(self, ParserOptionDialog):
        ParserOptionDialog.setWindowTitle(
            QCoreApplication.translate(
                "ParserOptionDialog", "\u5206\u6790\u914d\u7f6e", None
            )
        )
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tabGeneral),
            QCoreApplication.translate(
                "ParserOptionDialog", "\u901a\u7528", None
            ),
        )
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tabDisplay),
            QCoreApplication.translate(
                "ParserOptionDialog", "\u663e\u793a", None
            ),
        )
