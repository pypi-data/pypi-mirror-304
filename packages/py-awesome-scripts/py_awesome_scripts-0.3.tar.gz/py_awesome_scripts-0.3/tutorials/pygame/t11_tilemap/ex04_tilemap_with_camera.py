...
GS: GameSettings = GameSettings(
    size=(1024, 768), title="Tile Map Basic", tile_size=32, fps=120, speed=300
)
...
class Game:
    def __init__(self):
        ...
        self.dt: float = 0.0
        self.map = Map(pathlib.Path(__file__).parent / "assets" / "map2.txt")
...
class Player(pg.sprite.Sprite):
    def __init__(self, game: Game, x: int, y: int):
        ...
        self.x, self.y = x * GS.tile_size, y * GS.tile_size
