...
class TelegramBot:
    ...
    def komut_ekle(self, komut, cevap):
        """
        Komut ve cevap ekler. Cevap bir metin, fonksiyon, dosya yolu veya tuple (metin, dosya) olabilir.
        """
        if isinstance(cevap, tuple) and len(cevap) == 2:
            # Cevap hem mesaj hem de dosya içeriyor
            ...
            if cevap.endswith(".txt") or cevap.endswith(".pdf") or cevap.endswith(".png"):  # Basit bir dosya kontrolü
