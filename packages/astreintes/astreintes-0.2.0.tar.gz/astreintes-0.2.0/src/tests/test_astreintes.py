...
class TestCalendriers(unittest.TestCase):
    def test_partage_calendriers_111(self):
        ...
        d = astreintes.calculs.separation_calendriers(df_sites)[0]
    ...
    def test_partage_calendriers_123(self):
        ...
        d = astreintes.calculs.separation_calendriers(df_sites)
        assert [dd['sites'].shape[0] for dd in d] == [1, 1, 2]
    ...
    def test_partage_calendriers_124(self):
        ...
        d = astreintes.calculs.separation_calendriers(df_sites)
        assert [dd['sites'].shape[0] for dd in d] == [1, 1, 1, 1]
    ...
    def test_partage_calendriers_222(self):
        ...
        d = astreintes.calculs.separation_calendriers(df_sites)
        assert [dd['sites'].shape[0] for dd in d] == [1, 1, 1]
