...
class SimpleMCPKinematics(FingerKinematics):
    ...
    def __init__(self,
        ...
        self._abd_multiplier = \
            mcp_joint_init_dict["simple"]["abduction_multiplier"]
        self._flex_multiplier = \
            mcp_joint_init_dict["simple"]["flexion_multiplier"]
    ...
    def get_tendon_length_from_angle(
            ...
            swap_dir_on_mcp_abd: bool = False) -> np.ndarray:
        """
