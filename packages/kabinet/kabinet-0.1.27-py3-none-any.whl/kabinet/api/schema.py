from rekuest_next.scalars import NodeHash, SearchQuery, ValidatorFunction, Identifier
from kabinet.funcs import aexecute, execute
from typing import Optional, Any, List, Literal, Union, Tuple
...
class AppImageInput(BaseModel):
    ...
    "The unique identifier for the app_image"
