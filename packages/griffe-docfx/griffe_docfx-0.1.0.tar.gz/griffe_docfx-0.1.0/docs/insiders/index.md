...
*griffe-docfx* follows the **sponsorware** release strategy, which means
...
*griffe-docfx Insiders* is a private fork of *griffe-docfx*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *griffe-docfx*.
...
*griffe-docfx* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *griffe-docfx*,
...
<small>
  ...
  your profile and avatar to show your support for *griffe-docfx*.
...
to use *griffe-docfx* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *griffe-docfx*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *griffe-docfx
Insiders* precisely under the same terms as *griffe-docfx*, which are given
